...
public final class WorldPacketRewriter1_17 {
    ...
    public static void register(Protocol1_16_4To1_17 protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_16_2.LIGHT_UPDATE, WorldHeightSupport.handleUpdateLight(new PacketHandlers() {
            @Override
        ...
        protocol.registerClientbound(ClientboundPackets1_16_2.LEVEL_CHUNK, WorldHeightSupport.handleChunkData(wrapper -> {
