...
public final class Recipes1_11_2 {
   ...
   public static RecipeManager1_11_2 getRecipeManager() {
      if (RECIPE_MANAGER == null) {
         List<RecipeInfo> recipeInfos = getRecipes(ProtocolTranslator.getTargetVersion());
         List<RecipeEntry<?>> recipes = new ArrayList<>(recipeInfos.size());

         for (int i = 0; i < recipeInfos.size(); i++) {
            RegistryKey<Recipe<?>> key = RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("viafabricplus", "recipe/" + i));
   ...
   public static List<RecipeInfo> getRecipes(ProtocolVersion targetVersion) {
      ...
      if (targetVersion.newerThanOrEqualTo(ProtocolVersion.v1_8)) {
         ...
         recipes.add(
            RecipeInfo.shaped(
               4, Blocks.RED_SANDSTONE_STAIRS, "#  ", "## ", "###", '#', Blocks.RED_SANDSTONE, Blocks.CHISELED_RED_SANDSTONE, Blocks.CUT_RED_SANDSTONE
            )
         );
      ...
      if (targetVersion.newerThanOrEqualTo(LegacyProtocolVersion.r1_6_1)) {
         ...
         recipes.add(
            RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.YELLOW_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.YELLOW_DYE)
         );
         ...
         recipes.add(
            RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.PURPLE_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.PURPLE_DYE)
         );
         recipes.add(RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.PINK_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.PINK_DYE));
         recipes.add(
            RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.ORANGE_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.ORANGE_DYE)
         );
         recipes.add(
            RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.MAGENTA_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.MAGENTA_DYE)
         );
         recipes.add(RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.LIME_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.LIME_DYE));
         recipes.add(
            RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.LIGHT_GRAY_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.LIGHT_GRAY_DYE)
         );
         recipes.add(
            RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.LIGHT_BLUE_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.LIGHT_BLUE_DYE)
         );
         ...
         recipes.add(
            RecipeInfo.shaped("stained_hardened_clay", 8, Blocks.BLUE_TERRACOTTA, "###", "#X#", "###", '#', Blocks.TERRACOTTA, 'X', Items.LAPIS_LAZULI)
         );
      ...
      if (targetVersion.newerThanOrEqualTo(LegacyProtocolVersion.r1_5tor1_5_1)) {
         ...
         recipes.add(
            RecipeInfo.shaped(4, Blocks.QUARTZ_STAIRS, "#  ", "## ", "###", '#', Blocks.QUARTZ_BLOCK, Blocks.CHISELED_QUARTZ_BLOCK, Blocks.QUARTZ_PILLAR)
         );
      ...
      if (targetVersion.newerThanOrEqualTo(LegacyProtocolVersion.r1_3_1tor1_3_2)) {
         ...
         } else if (targetVersion.newerThanOrEqualTo(LegacyProtocolVersion.b1_3tob1_3_1)) {
            recipes.add(
               RecipeInfo.shaped(
                  "wooden_slab",
                  3,
      ...
      if (targetVersion.newerThanOrEqualTo(LegacyProtocolVersion.r1_2_1tor1_2_3)) {
         ...
         recipes.add(
            RecipeInfo.shapeless(
               3,
               Items.FIRE_CHARGE,
               new ItemConvertible[]{Items.GUNPOWDER},
               new ItemConvertible[]{Items.BLAZE_POWDER},
               new ItemConvertible[]{Items.COAL, Items.CHARCOAL}
            )
         );
      } else {
      ...
      if (targetVersion.newerThanOrEqualTo(LegacyProtocolVersion.b1_5tob1_5_2)) {
         recipes.add(
            RecipeInfo.shaped(6, Blocks.DETECTOR_RAIL, "X X", "X#X", "XRX", 'R', Blocks.REDSTONE_WIRE, '#', Blocks.STONE_PRESSURE_PLATE, 'X', Items.IRON_INGOT)
         );
      ...
      recipes.add(RecipeInfo.smelting(Items.GLASS, Ingredient.ofItems(new ItemConvertible[]{Items.SAND, Items.RED_SAND}), 0.1F));
      ...
      if (targetVersion.newerThanOrEqualTo(LegacyProtocolVersion.b1_2_0tob1_2_2)) {
         recipes.add(
            RecipeInfo.smelting(
               Items.CHARCOAL,
               Ingredient.ofItems(
                  new ItemConvertible[]{Items.OAK_LOG, Items.SPRUCE_LOG, Items.BIRCH_LOG, Items.JUNGLE_LOG, Items.ACACIA_LOG, Items.DARK_OAK_LOG}
               ),
               0.15F
            )
         );
   ...
   public static void setCraftingResultSlot(int syncId, ScreenHandler screenHandler, RecipeInputInventory inventory) {
      ClientPlayNetworkHandler network = MinecraftClient.getInstance().getNetworkHandler();
      ClientWorld world = MinecraftClient.getInstance().world;
      CraftingRecipeInput input = inventory.createRecipeInput();
      ItemStack result = getRecipeManager()
         .getFirstMatch(RecipeType.CRAFTING, input, world)
         .map(recipe -> ((CraftingRecipe)recipe.value()).craft(input, network.getRegistryManager()))
