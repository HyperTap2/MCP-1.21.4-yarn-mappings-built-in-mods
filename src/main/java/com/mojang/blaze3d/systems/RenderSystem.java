...
import net.minecraft.util.TimeSupplier.Nanoseconds;
...
public class RenderSystem {
   ...
   private static final int[] shaderTextures = new int[128];
   ...
   static {
      StateUpdateNotifiers.fogStartNotifier = listener -> iris$fogStartListener = listener;
      StateUpdateNotifiers.fogEndNotifier = listener -> iris$fogEndListener = listener;
   }
   ...
   public static Nanoseconds initBackendSystem() {
   ...
   public static void setShaderTexture(int texture, Identifier id) {
      ...
      if (texture >= 0 && texture < shaderTextures.length) {
         ...
         TextureTracker.INSTANCE.onSetShaderTexture(texture, glId);
