...
public class AcceleratedItemRenderingFeature {
    ...
    public static boolean shouldAccelerateInHand() {
        return FeatureConfig.CONFIG.acceleratedItemRenderingHandAcceleration.get() == FeatureStatus.ENABLED;
    }

    public static boolean shouldAccelerateInGui() {
        return FeatureConfig.CONFIG.acceleratedItemRenderingGuiAcceleration.get() == FeatureStatus.ENABLED;
    }

    public static boolean shouldBatchGuiItems() {
