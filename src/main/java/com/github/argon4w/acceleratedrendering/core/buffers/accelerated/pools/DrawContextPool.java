...
import static org.lwjgl.opengl.GL46.GL_ATOMIC_COUNTER_BUFFER;
...
public class DrawContextPool extends SimpleResetPool<DrawContextPool.IndirectDrawContext, MappedBuffer> {
    ...
    public class IndirectDrawContext {
        ...
        public static final IMemoryInterface INDIRECT_COUNT = new SimpleMemoryInterface(0L, 4);
        public static final IMemoryInterface INDIRECT_INSTANCE_COUNT = new SimpleMemoryInterface(4L, 4);
        ...
        public void drawElements(VertexFormat.DrawMode mode) {
