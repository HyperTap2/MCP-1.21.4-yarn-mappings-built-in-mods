...
import net.caffeinemc.mods.sodium.client.gui.options.OptionGroup.Builder;
...
public class SodiumExtraGameOptionPages {
   ...
   public static OptionPage particle() {
      ...
      Map<String, List<Identifier>> otherParticles = Registries.PARTICLE_TYPE.getIds().stream().collect(Collectors.groupingBy(Identifier::getNamespace));
      otherParticles.forEach(
         (namespace, identifiers) -> groups.add(
            identifiers.stream()
               .map(
                  identifier -> OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                     .setEnabled(() -> SodiumExtraClientMod.mixinConfig().getOptions().get("mixin.particle").isEnabled())
                     .setName(translatableName(identifier, "particles"))
                     .setTooltip(translatableTooltip(identifier, "particles"))
                     .setControl(TickBoxControl::new)
                     .setBinding(
                        (opts, val) -> opts.particleSettings.otherMap.put(identifier, val),
                        opts -> opts.particleSettings.otherMap.getOrDefault(identifier, true)
                     )
                     .build()
               )
               .sorted(Comparator.comparing(o -> o.getName().getString()))
               .<Builder>collect(OptionGroup::createBuilder, Builder::add, (b1, b2) -> {})
               .build()
         )
      );
         ...
         OptionGroup.createBuilder()
            ...
            .add(
               OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                  ...
                  .setName(Text.translatable("sodium-extra.option.sun"))
                  .setTooltip(Text.translatable("sodium-extra.option.sun.tooltip"))
                  .setControl(TickBoxControl::new)
            ...
            .add(
               OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                  .setEnabled(() -> SodiumExtraClientMod.mixinConfig().getOptions().get("mixin.sun_moon").isEnabled())
                  .setName(Text.translatable("sodium-extra.option.moon"))
                  .setTooltip(Text.translatable("sodium-extra.option.moon.tooltip"))
                  .setControl(TickBoxControl::new)
   ...
   public static OptionPage render() {
         ...
         OptionGroup.createBuilder()
            .add(
               OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                  ...
                  .setControl(TickBoxControl::new)
                  .setBinding(
                     (options, value) -> options.renderSettings.multiDimensionFogControl = value, options -> options.renderSettings.multiDimensionFogControl
                  )
                  .build()
            )
            .add(
               OptionImpl.createBuilder(int.class, sodiumExtraOpts)
      ...
      if (SodiumExtraClientMod.options().renderSettings.multiDimensionFogControl) {
         DimensionOptionsRegistryHolder.streamAll(Stream.empty())
         ...
         groups.add(
            SodiumExtraClientMod.options()
               .renderSettings
               .dimensionFogDistanceMap
               .keySet()
               .stream()
               .map(
                  identifier -> OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                     .setEnabled(() -> SodiumExtraClientMod.mixinConfig().getOptions().get("mixin.fog").isEnabled())
                     .setName(Text.translatable("sodium-extra.option.fog", new Object[]{translatableName(identifier, "dimensions").getString()}))
                     ...
                     .setBinding(
                        (opts, val) -> opts.renderSettings.dimensionFogDistanceMap.put(identifier, val),
   ...
   public static OptionPage extra() {
      ...
      groups.add(
         OptionGroup.createBuilder()
            .add(
               OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                  .setEnabled(
                     () -> SodiumExtraClientMod.mixinConfig().getOptions().get("mixin.reduce_resolution_on_mac").isEnabled() && MinecraftClient.IS_SYSTEM_MAC
                  )
      ...
      groups.add(
         OptionGroup.createBuilder()
            .add(
               OptionImpl.<SodiumExtraGameOptions, SodiumExtraGameOptions.OverlayCorner>createBuilder(
                     SodiumExtraGameOptions.OverlayCorner.class, sodiumExtraOpts
                  )
            ...
            .add(
               OptionImpl.<SodiumExtraGameOptions, SodiumExtraGameOptions.TextContrast>createBuilder(
                     SodiumExtraGameOptions.TextContrast.class, sodiumExtraOpts
                  )
         ...
         OptionGroup.createBuilder()
            ...
            .add(
               OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                  ...
                  .setBinding(
                     (options, value) -> options.extraSettings.steadyDebugHudRefreshInterval = value,
                     options -> options.extraSettings.steadyDebugHudRefreshInterval
                  )
                  .build()
            )
            .build()
   ...
   private static Text translatableName(Identifier identifier, String category) {
      ...
      if (!Texts.hasTranslation(translatable)) {
         translatable = Text.literal(
            Arrays.stream(key.substring(key.lastIndexOf(46) + 1).split("_"))
   ...
   private static Text translatableTooltip(Identifier identifier, String category) {
      ...
      Text translatable = Text.translatable(key);
      if (!Texts.hasTranslation(translatable)) {
         translatable = Text.translatable("sodium-extra.option.".concat(category).concat(".tooltips"), new Object[]{translatableName(identifier, category)});
      }
