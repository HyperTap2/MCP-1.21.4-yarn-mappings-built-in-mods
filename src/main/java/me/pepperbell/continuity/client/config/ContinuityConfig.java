...
public class ContinuityConfig {
	...
	public static final ContinuityConfig INSTANCE = new ContinuityConfig(
			PlatformRuntimeInformation.getInstance().getConfigDirectory().resolve("continuity.json").toFile());
	static {
		INSTANCE.load();
	}
