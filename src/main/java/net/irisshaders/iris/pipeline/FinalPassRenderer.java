...
public class FinalPassRenderer {
   ...
   public FinalPassRenderer(
      ...
      this.lastColorTextureId = MinecraftClient.getInstance().getFramebuffer().getColorAttachment();
   ...
   public void renderFinalPass() {
      ...
      int baseWidth = main.textureWidth;
      int baseHeight = main.textureHeight;
      if (((Blaze3dRenderTargetExt)main).iris$getColorBufferVersion() != this.lastColorTextureVersion || main.getColorAttachment() != this.lastColorTextureId) {
         this.lastColorTextureVersion = ((Blaze3dRenderTargetExt)main).iris$getColorBufferVersion();
         this.lastColorTextureId = main.getColorAttachment();
         this.colorHolder.addColorAttachment(0, this.lastColorTextureId);
      }
      ...
      if (this.finalPass != null) {
         ...
         IrisRenderSystem.copyTexSubImage2D(main.getColorAttachment(), 3553, 0, 0, 0, 0, 0, baseWidth, baseHeight);
      }
      ...
      for (int i = 0; i < SamplerLimits.get().getMaxTextureUnits(); i++) {
         if (GlStateManagerAccessor.getTEXTURES()[i].boundTexture != 0) {
