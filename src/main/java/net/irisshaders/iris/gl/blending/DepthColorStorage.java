...
public class DepthColorStorage {
   ...
   public static void disableDepthColor() {
      if (!depthColorLocked) {
         com.mojang.blaze3d.platform.GlStateManager.ColorMask colorMask = GlStateManagerAccessor.getCOLOR_MASK();
         DepthTestState depthState = GlStateManagerAccessor.getDEPTH();
