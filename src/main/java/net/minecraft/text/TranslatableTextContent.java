...
public class TranslatableTextContent implements TextContent {
   ...
   @Nullable
   private String languageReload$targetCache;
   ...
   private void updateTranslations() {
      ...
      String targetLanguage = language instanceof TranslationStorage storage ? storage.languageReload$getTargetLanguage() : null;
      if (language != this.languageCache || !Objects.equals(targetLanguage, this.languageReload$targetCache)) {
         this.languageCache = language;
         this.languageReload$targetCache = targetLanguage;
   ...
   private void forEachPart(String translation, Consumer<StringVisitable> partsConsumer) {
      ...
      try {
         ...
         throw new TranslationException(this, illegalArgumentException);
      }
   }
