...
public record Decoration(String translationKey, List<Decoration.Parameter> parameters, Style style) {
   ...
   public enum Parameter implements StringIdentifiable {
      ...
      private static final IntFunction<Decoration.Parameter> BY_ID = ValueLists.<Decoration.Parameter>createIdToValueFunction(
      ...
      Parameter(final int id, final String name, final Decoration.Parameter.Selector selector) {
         this.id = id;
         this.name = name;
