...
public interface SlotDisplay {
   ...
   default ItemStack getFirst(ContextParameterMap context) {
      return this.appendStacks(context, SlotDisplay.NoopDisplayedItemFactory.INSTANCE).findFirst().orElse(ItemStack.EMPTY);
   }
   ...
   record ItemSlotDisplay(RegistryEntry<Item> item) implements SlotDisplay {
      public static final MapCodec<SlotDisplay.ItemSlotDisplay> CODEC = RecordCodecBuilder.mapCodec(
         instance -> instance.group(Item.ENTRY_CODEC.fieldOf("item").forGetter(SlotDisplay.ItemSlotDisplay::item))
   ...
   record SmithingTrimSlotDisplay(SlotDisplay base, SlotDisplay material, SlotDisplay pattern) implements SlotDisplay {
   ...
   record StackSlotDisplay(ItemStack stack) implements SlotDisplay {
      ...
      public boolean equals(Object o) {
         return this == o || o instanceof SlotDisplay.StackSlotDisplay stackSlotDisplay && ItemStack.areEqual(this.stack, stackSlotDisplay.stack);
      }
