...
public final class RecipeBookOptions {
   ...
   private RecipeBookOptions.CategoryOption getOption(RecipeBookType category) {
      return this.categoryOptions.getOrDefault(category, RecipeBookOptions.CategoryOption.DEFAULT);
   }
   ...
   private void toPacket(PacketByteBuf buf) {
      for (RecipeBookType recipeBookType : RecipeBookType.values()) {
         RecipeBookOptions.CategoryOption categoryOption = this.categoryOptions.getOrDefault(recipeBookType, RecipeBookOptions.CategoryOption.DEFAULT);
   ...
   public void writeNbt(NbtCompound nbt) {
      CATEGORY_OPTION_NAMES.forEach((category, pair) -> {
         RecipeBookOptions.CategoryOption categoryOption = this.categoryOptions.getOrDefault(category, RecipeBookOptions.CategoryOption.DEFAULT);
