...
public interface WorldView extends BlockRenderView, CollisionView, RedstoneView, BiomeAccess.Storage, ChunkView {
   @Nullable
   Chunk getChunk(int chunkX, int chunkZ, ChunkStatus leastStatus, boolean create);

   @Nullable
   @Override
   default Chunk lithium$getLoadedChunk(int chunkX, int chunkZ) {
