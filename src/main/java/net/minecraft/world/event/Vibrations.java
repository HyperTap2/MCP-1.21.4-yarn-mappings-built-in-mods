...
public interface Vibrations {
            ...
            .ifPresent(
               vibration -> {
                  ...
                  world.spawnParticles(
                     new VibrationParticleEffect(callback.getPositionSource(), listenerData.getDelay()), vec3d.x, vec3d.y, vec3d.z, 1, 0.0, 0.0, 0.0, 0.0
                  );
                  callback.onListen();
   ...
   class VibrationListener implements GameEventListener {
      ...
      public boolean listen(ServerWorld world, RegistryEntry<GameEvent> event, GameEvent.Emitter emitter, Vec3d emitterPos) {
         ...
         if (isOccluded(world, emitterPos, vec3d)) {
            return false;
         }
