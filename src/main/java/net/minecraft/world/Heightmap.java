...
public class Heightmap {
   ...
   public Predicate<BlockState> lithium$getBlockPredicate() {
      return this.blockPredicate;
   }

   public void lithium$set(int x, int z, int height) {
      this.set(x, z, height);
   }
   ...
   public enum Type implements StringIdentifiable {
      ...
      Type(final String name, final Heightmap.Purpose purpose, final Predicate<BlockState> blockPredicate) {
         this.name = name;
