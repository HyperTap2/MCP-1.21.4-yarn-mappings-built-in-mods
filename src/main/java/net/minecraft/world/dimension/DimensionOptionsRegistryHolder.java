...
public record DimensionOptionsRegistryHolder(Map<RegistryKey<DimensionOptions>, DimensionOptions> dimensions) {
   ...
   public static Map<RegistryKey<DimensionOptions>, DimensionOptions> createRegistry(
      ...
      RegistryEntry<DimensionType> registryEntry = dimensionOptions2 == null
   ...
   private static boolean isOverworldVanilla(DimensionOptions dimensionOptions) {
      ...
      return !registryEntry.matchesKey(DimensionTypes.OVERWORLD) && !registryEntry.matchesKey(DimensionTypes.OVERWORLD_CAVES)
         ? false
         : !(
            dimensionOptions.chunkGenerator().getBiomeSource() instanceof MultiNoiseBiomeSource multiNoiseBiomeSource
