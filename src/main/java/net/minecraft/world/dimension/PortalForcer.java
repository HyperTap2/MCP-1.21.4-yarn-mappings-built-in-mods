...
public class PortalForcer {
   ...
   public Optional<BlockPos> getPortalPos(BlockPos pos, boolean destIsNether, WorldBorder worldBorder) {
      ...
      pointOfInterestStorage.preloadChunks(this.world, pos, radius);
      return ((PointOfInterestStorageExtended)pointOfInterestStorage)
   ...
   public Optional<BlockLocating.Rectangle> createPortal(BlockPos pos, Direction.Axis axis) {
      ...
      if (d == -1.0) {
         ...
         blockPos = new BlockPos(pos.getX() - direction.getOffsetX() * 1, MathHelper.clamp(pos.getY(), o, p), pos.getZ() - direction.getOffsetZ() * 1)
            .toImmutable();
