...
public class SpawnSettings {
   ...
   public static final MapCodec<SpawnSettings> CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(
            Codec.floatRange(0.0F, 0.9999999F)
               ...
               .forGetter(spawnSettings -> spawnSettings.creatureSpawnProbability),
            Codec.simpleMap(
                  SpawnGroup.CODEC,
   ...
   SpawnSettings(
      ...
      this.spawners = new EnumMap<>(SpawnGroup.class);
   ...
   public static class Builder {
      ...
      public SpawnSettings build() {
         return new SpawnSettings(
            ...
            this.spawners.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, entry -> Pool.of((List)entry.getValue()))),
