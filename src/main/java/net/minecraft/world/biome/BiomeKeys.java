...
public abstract class BiomeKeys {
   private static int iris$currentId;
   ...
   private static RegistryKey<Biome> keyOf(String id) {
      RegistryKey<Biome> key = RegistryKey.of(RegistryKeys.BIOME, Identifier.ofVanilla(id));
      BiomeUniforms.getBiomeMap().put(key, iris$currentId++);
      return key;
   }
}
