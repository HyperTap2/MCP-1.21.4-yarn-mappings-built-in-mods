...
public class DensityFunctions {
      ...
      RegistryEntry<DensityFunction> registryEntry3 = densityFunctionRegisterable.register(
         ...
         DensityFunctionTypes.flatCache(
            DensityFunctionTypes.shiftedNoise(
               densityFunction, densityFunction2, 0.25, registryEntryLookup.getOrThrow(NoiseParametersKeys.CONTINENTALNESS_LARGE)
            )
         )
      );
   ...
   private static DensityFunction createCavesEntrancesOverworldFunction(
      ...
      DensityFunction densityFunction5 = DensityFunctionTypes.add(DensityFunctionTypes.max(densityFunction3, densityFunction4), densityFunction2)
         .clamp(-1.0, 1.0);
   ...
   private static DensityFunction createCavePillarsOverworldFunction(RegistryEntryLookup<DoublePerlinNoiseSampler.NoiseParameters> noiseParametersLookup) {
      ...
      DensityFunction densityFunction4 = DensityFunctionTypes.add(
         DensityFunctionTypes.mul(densityFunction, DensityFunctionTypes.constant(2.0)), densityFunction2
      );
   ...
   private static DensityFunction createCavesFunction(
      ...
      DensityFunction densityFunction6 = DensityFunctionTypes.add(
         ...
         DensityFunctionTypes.add(DensityFunctionTypes.constant(1.5), DensityFunctionTypes.mul(DensityFunctionTypes.constant(-0.64), slopedCheese))
            .clamp(0.0, 0.5)
      );
