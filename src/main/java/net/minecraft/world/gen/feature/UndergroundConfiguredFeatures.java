...
public class UndergroundConfiguredFeatures {
            ...
            List.of(
               BlockColumnFeatureConfig.createLayer(
                  new WeightedListIntProvider(
                     DataPool.<IntProvider>builder().add(UniformIntProvider.create(0, 4), 2).add(ConstantIntProvider.create(0), 1).build()
                  ),
   ...
   public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
      ...
      List<Identifier> list = List.of(
         Identifier.ofVanilla("fossil/spine_1"),
         Identifier.ofVanilla("fossil/spine_2"),
         Identifier.ofVanilla("fossil/spine_3"),
         Identifier.ofVanilla("fossil/spine_4"),
         Identifier.ofVanilla("fossil/skull_1"),
         Identifier.ofVanilla("fossil/skull_2"),
         Identifier.ofVanilla("fossil/skull_3"),
         Identifier.ofVanilla("fossil/skull_4")
      );
      List<Identifier> list2 = List.of(
         Identifier.ofVanilla("fossil/spine_1_coal"),
         Identifier.ofVanilla("fossil/spine_2_coal"),
         Identifier.ofVanilla("fossil/spine_3_coal"),
         Identifier.ofVanilla("fossil/spine_4_coal"),
         Identifier.ofVanilla("fossil/skull_1_coal"),
         Identifier.ofVanilla("fossil/skull_2_coal"),
         Identifier.ofVanilla("fossil/skull_3_coal"),
         Identifier.ofVanilla("fossil/skull_4_coal")
      );
         ...
         new RootSystemFeatureConfig(
            ...
            BlockPredicate.bothOf(
               BlockPredicate.eitherOf(
                  BlockPredicate.matchingBlocks(List.of(Blocks.AIR, Blocks.CAVE_AIR, Blocks.VOID_AIR)),
      ...
      WeightedBlockStateProvider weightedBlockStateProvider = new WeightedBlockStateProvider(
         DataPool.<BlockState>builder()
            ...
            .add(Blocks.CAVE_VINES_PLANT.getDefaultState().with(CaveVines.BERRIES, true), 1)
      );
      RandomizedIntBlockStateProvider randomizedIntBlockStateProvider = new RandomizedIntBlockStateProvider(
         new WeightedBlockStateProvider(
            DataPool.<BlockState>builder()
               ...
               .add(Blocks.CAVE_VINES.getDefaultState().with(CaveVines.BERRIES, true), 1)
         ),
      ...
      ConfiguredFeatures.register(
         ...
         new BlockColumnFeatureConfig(
            List.of(
               BlockColumnFeatureConfig.createLayer(
                  new WeightedListIntProvider(
                     DataPool.<IntProvider>builder().add(UniformIntProvider.create(0, 3), 5).add(UniformIntProvider.create(1, 7), 1).build()
                  ),
                  weightedBlockStateProvider
               ),
               BlockColumnFeatureConfig.createLayer(ConstantIntProvider.create(1), randomizedIntBlockStateProvider)
      ...
      ConfiguredFeatures.register(
         ...
         Feature.SCULK_PATCH,
         new SculkPatchFeatureConfig(10, 32, 64, 0, 1, UniformIntProvider.create(1, 3), 0.5F)
      );
