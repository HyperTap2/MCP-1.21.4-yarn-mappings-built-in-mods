...
public class VegetationPlacedFeatures {
   ...
   public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
      ...
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry26 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FLOWER_PALE_GARDEN);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry27 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_PLAINS);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry28 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.DARK_FOREST_VEGETATION);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry29 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PALE_GARDEN_VEGETATION);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry30 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FOREST_FLOWERS);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry31 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PALE_FOREST_FLOWERS);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry32 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PALE_MOSS_PATCH);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry33 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_FLOWER_FOREST);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry34 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.MEADOW_TREES);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry35 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_TAIGA);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry36 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_GROVE);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry37 = registryEntryLookup.getOrThrow(TreeConfiguredFeatures.OAK);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry38 = registryEntryLookup.getOrThrow(TreeConfiguredFeatures.SPRUCE);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry39 = registryEntryLookup.getOrThrow(TreeConfiguredFeatures.CHERRY_BEES_005);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry40 = registryEntryLookup.getOrThrow(TreeConfiguredFeatures.SWAMP_OAK);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry41 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_SAVANNA);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry42 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.BIRCH_TALL);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry43 = registryEntryLookup.getOrThrow(TreeConfiguredFeatures.BIRCH_BEES_0002);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry44 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_WINDSWEPT_HILLS);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry45 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_WATER);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry46 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_BIRCH_AND_OAK);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry47 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_SPARSE_JUNGLE);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry48 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry49 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_OLD_GROWTH_PINE_TAIGA);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry50 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_JUNGLE);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry51 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.BAMBOO_VEGETATION);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry52 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.MUSHROOM_ISLAND_VEGETATION);
      RegistryEntry<ConfiguredFeature<?, ?>> registryEntry53 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.MANGROVE_VEGETATION);
      ...
      PlacedFeatures.register(featureRegisterable, TREES_FLOWER_FOREST, registryEntry33, treeModifiers(PlacedFeatures.createCountExtraModifier(6, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, TREES_MEADOW, registryEntry34, treeModifiers(RarityFilterPlacementModifier.of(100)));
      PlacedFeatures.register(
         featureRegisterable,
         TREES_CHERRY,
         registryEntry39,
      ...
      PlacedFeatures.register(featureRegisterable, TREES_TAIGA, registryEntry35, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, TREES_GROVE, registryEntry36, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1)));
      PlacedFeatures.register(
         featureRegisterable,
         TREES_BADLANDS,
         registryEntry37,
      ...
      PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_SAVANNA, registryEntry41, treeModifiers(PlacedFeatures.createCountExtraModifier(2, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, TREES_SAVANNA, registryEntry41, treeModifiers(PlacedFeatures.createCountExtraModifier(1, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, BIRCH_TALL, registryEntry42, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1)));
      PlacedFeatures.register(
         featureRegisterable,
         TREES_BIRCH,
         registryEntry43,
      ...
      PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_FOREST, registryEntry44, treeModifiers(PlacedFeatures.createCountExtraModifier(3, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_HILLS, registryEntry44, treeModifiers(PlacedFeatures.createCountExtraModifier(0, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, TREES_WATER, registryEntry45, treeModifiers(PlacedFeatures.createCountExtraModifier(0, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, TREES_BIRCH_AND_OAK, registryEntry46, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, TREES_SPARSE_JUNGLE, registryEntry47, treeModifiers(PlacedFeatures.createCountExtraModifier(2, 0.1F, 1)));
      PlacedFeatures.register(
         featureRegisterable, TREES_OLD_GROWTH_SPRUCE_TAIGA, registryEntry48, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1))
      );
      PlacedFeatures.register(
         featureRegisterable, TREES_OLD_GROWTH_PINE_TAIGA, registryEntry49, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1))
      );
      PlacedFeatures.register(featureRegisterable, TREES_JUNGLE, registryEntry50, treeModifiers(PlacedFeatures.createCountExtraModifier(50, 0.1F, 1)));
      PlacedFeatures.register(featureRegisterable, BAMBOO_VEGETATION, registryEntry51, treeModifiers(PlacedFeatures.createCountExtraModifier(30, 0.1F, 1)));
      PlacedFeatures.register(
         featureRegisterable,
