...
public class LevelProperties implements ServerWorldProperties, SaveProperties {
   ...
   public static <T> LevelProperties readProperties(
      ...
      return new LevelProperties(
         ...
         dynamic.get("DragonFight").read(EnderDragonFight.Data.CODEC).resultOrPartial(LOGGER::error).orElse(EnderDragonFight.Data.DEFAULT),
         info,
         generatorOptions,
         specialProperty,
         lifecycle
   ...
   private void updateProperties(DynamicRegistryManager registryManager, NbtCompound levelNbt, @Nullable NbtCompound playerNbt) {
      ...
      levelNbt.put("DragonFight", (NbtElement)EnderDragonFight.Data.CODEC.encodeStart(NbtOps.INSTANCE, this.dragonFight).getOrThrow());
      if (playerNbt != null) {
