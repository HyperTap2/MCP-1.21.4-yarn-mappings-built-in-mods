...
public class RaycastContext {
   ...
   public void lithium$setStart(Vec3d start) {
      this.start = start;
   }

   public RaycastContext.FluidHandling lithium$getFluidHandling() {
      return this.fluid;
   }

   public ShapeContext lithium$getShapeContext() {
   ...
   public enum ShapeType implements RaycastContext.ShapeProvider {
      ...
      ShapeType(final RaycastContext.ShapeProvider provider) {
