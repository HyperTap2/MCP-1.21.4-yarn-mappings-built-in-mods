...
public class LightingProvider implements LightingView {
   ...
   public void checkBlock(BlockPos pos) {
      if (SodiumExtraClientMod.isMixinEnabled("light_updates.MixinLevelLightEngine")
   ...
   public ChunkLightingView get(LightType lightType) {
      if (lightType == LightType.BLOCK) {
         return this.blockLightProvider == null ? ChunkLightingView.Empty.INSTANCE : this.blockLightProvider;
      } else {
         return this.skyLightProvider == null ? ChunkLightingView.Empty.INSTANCE : this.skyLightProvider;
      }
   }
