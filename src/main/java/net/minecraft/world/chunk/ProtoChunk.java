...
public class ProtoChunk extends Chunk {
   ...
   public BlockState setBlockState(BlockPos pos, BlockState state, boolean moved) {
      ...
      for (Heightmap.Type type : enumSet) {
         this.heightmaps.get(type).trackUpdate(m, j, o, state);
      }
   ...
   public NbtCompound getPackedBlockEntityNbt(BlockPos pos, RegistryWrapper.WrapperLookup registries) {
      ...
      return blockEntity != null ? blockEntity.createNbtWithIdentifyingData(registries) : this.blockEntityNbts.get(pos);
   }
   ...
   public HeightLimitView getHeightLimitView() {
      return this.hasBelowZeroRetrogen() ? BelowZeroRetrogen.BELOW_ZERO_VIEW : this;
   }
}
