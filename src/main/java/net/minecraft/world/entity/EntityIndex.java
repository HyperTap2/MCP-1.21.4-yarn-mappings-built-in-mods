...
public class EntityIndex<T extends EntityLike> {
   ...
   public void add(T entity) {
      ...
      if (this.uuidToEntity.containsKey(uUID) && ProtocolTranslator.getTargetVersion().newerThan(ProtocolVersion.v1_16_4)) {
   ...
   public int size() {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_16_4)
         ? this.idToEntity.size()
         : this.uuidToEntity.size();
   }
}
