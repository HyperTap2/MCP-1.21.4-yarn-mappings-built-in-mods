...
public class ReturnCommand {
   public static <T extends AbstractServerCommandSource<T>> void register(CommandDispatcher<T> dispatcher) {
      dispatcher.register(
         (LiteralArgumentBuilder<T>)((LiteralArgumentBuilder)LiteralArgumentBuilder.<T>literal("return")
            ...
            .then(LiteralArgumentBuilder.<T>literal("run").forward((CommandNode<T>)(CommandNode)dispatcher.getRoot(), new ReturnCommand.ReturnRunRedirector(), false))
      );
   }
