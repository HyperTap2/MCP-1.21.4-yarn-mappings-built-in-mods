...
public class BossBarCommand {
   ...
   public static final SuggestionProvider<ServerCommandSource> SUGGESTION_PROVIDER = (context, builder) -> CommandSource.suggestIdentifiers(
      ((ServerCommandSource)context.getSource()).getServer().getBossBarManager().getIds(), builder
   );
                                       ...
                                       CommandManager.argument("name", TextArgumentType.text(registryAccess))
                                          .executes(
                                             context -> addBossBar(
                                                ...
                                                TextArgumentType.getTextArgument(context, "name")
                                             )
                                          )
                                    )
                              )
                        ...
                        CommandManager.literal("remove")
                           .then(
                              CommandManager.argument("id", IdentifierArgumentType.identifier())
                                 ...
                                 .executes(context -> removeBossBar((ServerCommandSource)context.getSource(), getBossBar(context)))
                           )
                     ))
                  .then(CommandManager.literal("list").executes(context -> listBossBars((ServerCommandSource)context.getSource()))))
               .then(
                        ...
                        ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument(
                                             ...
                                             ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal(
                                                                  ...
                                                                  .then(
                                                                     CommandManager.literal("pink")
                                                                        .executes(
                                                                           context -> setColor(
                                                                              (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Color.PINK
                                                                           )
                                                                        )
                                                                  ))
                                                               .then(
                                                                  CommandManager.literal("blue")
                                                                     .executes(
                                                                        context -> setColor(
                                                                           (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Color.BLUE
                                                                        )
                                                                     )
                                                               ))
                                                            .then(
                                                               CommandManager.literal("red")
                                                                  .executes(
                                                                     context -> setColor(
                                                                        (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Color.RED
                                                                     )
                                                                  )
                                                            ))
                                                         .then(
                                                            CommandManager.literal("green")
                                                               .executes(
                                                                  context -> setColor(
                                                                     (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Color.GREEN
                                                                  )
                                                               )
                                                         ))
                                                      .then(
                                                         CommandManager.literal("yellow")
                                                            .executes(
                                                               context -> setColor(
                                                                  (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Color.YELLOW
                                                               )
                                                            )
                                                      ))
                                                   .then(
                                                      CommandManager.literal("purple")
                                                         .executes(
                                                            context -> setColor(
                                                               (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Color.PURPLE
                                                            )
                                                         )
                                                   ))
                                                .then(
                                                   CommandManager.literal("white")
                                                      .executes(
                                                         context -> setColor((ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Color.WHITE)
                                                      )
                                                )
                                          ))
                                       .then(
                                          ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal(
                                                         ...
                                                         .then(
                                                            CommandManager.literal("progress")
                                                               .executes(
                                                                  context -> setStyle(
                                                                     (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Style.PROGRESS
                                                                  )
                                                               )
                                                         ))
                                                      .then(
                                                         CommandManager.literal("notched_6")
                                                            .executes(
                                                               context -> setStyle(
                                                                  (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Style.NOTCHED_6
                                                               )
                                                            )
                                                      ))
                                                   .then(
                                                      CommandManager.literal("notched_10")
                                                         .executes(
                                                            context -> setStyle(
                                                               (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Style.NOTCHED_10
                                                            )
                                                         )
                                                   ))
                                                .then(
                                                   CommandManager.literal("notched_12")
                                                      .executes(
                                                         context -> setStyle(
                                                            (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Style.NOTCHED_12
                                                         )
                                                      )
                                                ))
                                             .then(
                                                CommandManager.literal("notched_20")
                                                   .executes(
                                                      context -> setStyle(
                                                         (ServerCommandSource)context.getSource(), getBossBar(context), BossBar.Style.NOTCHED_20
                                                      )
                                                   )
                                             )
                                       ))
                                 ...
                                 CommandManager.literal("visible")
                                    .then(
                                       CommandManager.argument("visible", BoolArgumentType.bool())
                                          .executes(
                                             context -> setVisible(
                                                (ServerCommandSource)context.getSource(), getBossBar(context), BoolArgumentType.getBool(context, "visible")
                                             )
                                          )
                                    )
                              ))
                           .then(
                              ((LiteralArgumentBuilder)CommandManager.literal("players")
                                    .executes(context -> setPlayers((ServerCommandSource)context.getSource(), getBossBar(context), Collections.emptyList())))
                                 .then(
               ...
               CommandManager.literal("get")
                  .then(
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument(
                                 ...
                                 .then(
                                    CommandManager.literal("value")
                                       .executes(context -> getValue((ServerCommandSource)context.getSource(), getBossBar(context)))
                                 ))
                              .then(
                                 CommandManager.literal("max").executes(context -> getMaxValue((ServerCommandSource)context.getSource(), getBossBar(context)))
                              ))
                           .then(
                              CommandManager.literal("visible").executes(context -> isVisible((ServerCommandSource)context.getSource(), getBossBar(context)))
                           ))
                        .then(CommandManager.literal("players").executes(context -> getPlayers((ServerCommandSource)context.getSource(), getBossBar(context))))
                  )
            )
      );
   }
