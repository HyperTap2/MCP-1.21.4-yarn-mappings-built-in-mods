                           ...
                           CommandManager.literal("daytime")
                              .executes(
                                 context -> executeQuery(
                                    (ServerCommandSource)context.getSource(), getDayTime(((ServerCommandSource)context.getSource()).getWorld())
                                 )
                              )
                        ))
                     .then(
                     ...
                     CommandManager.literal("day")
                        .executes(
                           context -> executeQuery(
                              ...
                              (int)(((ServerCommandSource)context.getSource()).getWorld().getTimeOfDay() / 24000L % 2147483647L)
                           )
                        )
                  )
            )
