...
public class TestCommand {
   ...
   private static ArgumentBuilder<ServerCommandSource, ?> testAttemptConfig(
      ...
      return builder.executes(context -> callback.apply(context).runOnce())
         .then(
            ((RequiredArgumentBuilder)CommandManager.argument("numberOfTimes", IntegerArgumentType.integer(0))
                  .executes(context -> callback.apply(context).run(new TestAttemptConfig(IntegerArgumentType.getInteger(context, "numberOfTimes"), false))))
               .then(
   ...
   public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
      ...
      dispatcher.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal(
                                                                                    "test"
                                                                                 )
                                                                                 .then(
                                                                                       ...
                                                                                       .then(
                                                                                          testAttemptAndPlacementConfig(
                                                                                             CommandManager.argument(
                                                                                                "testName", TestFunctionArgumentType.testFunction()
                                                                                             ),
                                                                                             context -> RUNNERS.functionNamed(context, "testName")
                                                                                          )
                                                                                       )
                                                                                 ))
                                                                              .then(
                                                                                 CommandManager.literal("runmultiple")
                                                                                    .then(
                                                                                       ((RequiredArgumentBuilder)CommandManager.argument(
                                                                                             ...
                                                                                             .executes(
                                                                                                context -> RUNNERS.functionNamed(context, "testName").runOnce()
                                                                                             ))
                                                                                          .then(
                                                                                             CommandManager.argument("amount", IntegerArgumentType.integer())
                                                                                                .executes(
                                                                                                   context -> RUNNERS.repeat(
                                                                                                         IntegerArgumentType.getInteger(context, "amount")
                                                                                                      )
                                                                                                      .functionNamed(context, "testName")
                                                                                                      .runOnce()
                                                                                                )
                                                                                          )
                                                                                    )
                                                                           ...
                                                                           .then(
                                                                              testAttemptAndPlacementConfig(
                                                                                 CommandManager.literal("runall").then(argumentBuilder2),
                                                                                 RUNNERS::allTestFunctions
                                                                              )
                                                                           ))
                                                               ...
                                                               .then(
                                                                  testAttemptAndPlacementConfig(
                                                                     CommandManager.literal("runfailed").then(argumentBuilder), RUNNERS::failed
                                                                  )
                                                               ))
                                                            .then(
                                                               CommandManager.literal("verify")
                                                                  .then(
                                                                     CommandManager.argument("testName", TestFunctionArgumentType.testFunction())
                                                                        .executes(context -> RUNNERS.functionNamed(context, "testName").verify())
                                                                  )
                                                            ))
                                                         .then(
                                                            CommandManager.literal("verifyclass")
                                                               .then(
                                                                  CommandManager.argument("testClassName", TestClassArgumentType.testClass())
                                                                     .executes(
                                                                        context -> RUNNERS.in(
                                                                              context, TestClassArgumentType.getTestClass(context, "testClassName")
                                                                           )
                                                                           .verify()
                                                                     )
                                                               )
                                                      ...
                                                      .then(
                                                         CommandManager.literal("locate")
                                                            .then(
                                                               CommandManager.argument("testName", TestFunctionArgumentType.testFunction())
                                                                  .executes(
                                                                     context -> RUNNERS.structureNamed(
                                                                           context,
                                                                           "minecraft:"
                                                                              + TestFunctionArgumentType.getFunction(context, "testName").templateName()
                                                                        )
                                                                        .locate()
                                                                  )
                                                            )
                                                   ...
                                                   CommandManager.argument("testName", StringArgumentType.word())
                                                      .executes(
                                                         context -> executeExport(
                                                            ...
                                                            "minecraft:" + StringArgumentType.getString(context, "testName")
                                                         )
                                                      )
                                                )
                                          ))
                        ...
                        .then(
                           ((LiteralArgumentBuilder)CommandManager.literal("clearall").executes(context -> RUNNERS.surface(context, 200).clear()))
                              .then(
                                 CommandManager.argument("radius", IntegerArgumentType.integer())
                                    .executes(
                                       context -> RUNNERS.surface(context, MathHelper.clamp(IntegerArgumentType.getInteger(context, "radius"), 0, 1024))
                                          .clear()
                                    )
                              )
                        ))
                     .then(
                        CommandManager.literal("import")
                           .then(
                              CommandManager.argument("testName", StringArgumentType.word())
                                 .executes(
                                    context -> executeImport((ServerCommandSource)context.getSource(), StringArgumentType.getString(context, "testName"))
                                 )
                           )
                     ))
                  .then(CommandManager.literal("stop").executes(context -> stop())))
               .then(
                  ((LiteralArgumentBuilder)CommandManager.literal("pos").executes(context -> executePos((ServerCommandSource)context.getSource(), "pos")))
                     .then(
                        CommandManager.argument("var", StringArgumentType.word())
                           .executes(context -> executePos((ServerCommandSource)context.getSource(), StringArgumentType.getString(context, "var")))
                     )
               ))
            .then(
               CommandManager.literal("create")
                  .then(
                     ((RequiredArgumentBuilder)CommandManager.argument("testName", StringArgumentType.word())
                           ...
                           .executes(
                              context -> executeCreate((ServerCommandSource)context.getSource(), StringArgumentType.getString(context, "testName"), 5, 5, 5)
                           ))
                        .then(
   ...
   private static int executeImport(ServerCommandSource source, String testName) {
      ...
      try {
         ...
         LOGGER.error("Failed to load structure {}", testName, exception);
         return 1;
      }
   }
   ...
   public static class Runner {
      ...
      int verify() {
         ...
         for (GameTestState gameTestState : collection) {
            for (BlockRotation blockRotation : BlockRotation.values()) {
               ...
               GameTestBatch gameTestBatch = Batches.create(collection3, gameTestState.getTestFunction().batchId(), blockRotation.ordinal());
      ...
      public int locate() {
         ...
         this.finder
            ...
            .forEach(
               pos -> {
                  StructureBlockBlockEntity structureBlockBlockEntity = (StructureBlockBlockEntity)this.finder
                     .getCommandSource()
                     .getWorld()
                     .getBlockEntity(pos);
                  if (structureBlockBlockEntity != null) {
                     ...
                     int ix = (int)direction.getOpposite().getPositiveHorizontalDegrees();
