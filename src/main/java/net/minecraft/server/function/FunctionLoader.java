...
public class FunctionLoader implements ResourceReloader {
   ...
   public CompletableFuture<Void> reload(ResourceReloader.Synchronizer synchronizer, ResourceManager manager, Executor prepareExecutor, Executor applyExecutor) {
      ...
      CompletableFuture<Map<Identifier, CompletableFuture<CommandFunction<ServerCommandSource>>>> completableFuture2 = CompletableFuture.<Map<Identifier, Resource>>supplyAsync(
