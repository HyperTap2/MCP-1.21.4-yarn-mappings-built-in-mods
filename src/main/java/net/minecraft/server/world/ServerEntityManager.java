...
public class ServerEntityManager<T extends EntityLike> implements AutoCloseable {
   ...
   public SectionedEntityCache<T> getCache() {
      return this.cache;
   }
   ...
   class Listener implements EntityChangeListener, ToggleableMovementTracker {
      ...
      Listener(final T entity, final long sectionPos, final EntityTrackingSection<T> section) {
         ...
         this.lithium$notificationMask = entity instanceof Entity realEntity ? MovementTrackerHelper.getNotificationMask(realEntity) : 0;
      ...
      public void updateEntityPosition() {
         ...
         if (l != this.sectionPos) {
            ...
            if (!this.section.remove(this.entity)) {
               ServerEntityManager.LOGGER
                  .warn("Entity {} wasn't found in section {} (moving to {})", new Object[]{this.entity, ChunkSectionPos.from(this.sectionPos), l});
            }
      ...
      public void remove(Entity.RemovalReason reason) {
         ...
         if (!this.section.remove(this.entity)) {
            ServerEntityManager.LOGGER
               .warn("Entity {} wasn't found in section {} (destroying due to {})", new Object[]{this.entity, ChunkSectionPos.from(this.sectionPos), reason});
         }
      ...
      private void lithium$notifyMovementListeners() {
         if (this.lithium$notificationMask != 0 && this.entity instanceof Entity realEntity) {
            this.section.lithium$trackEntityMovement(this.lithium$notificationMask, realEntity.getWorld().getTime());
         }
      }

      @Override
      public int lithium$setNotificationMask(int notificationMask) {
         int oldMask = this.lithium$notificationMask;
