...
public class DataComponentTypes {
   ...
   public static final ComponentType<Integer> MAX_DAMAGE = register(
   ...
   public static final ComponentType<SuspiciousStewEffectsComponent> SUSPICIOUS_STEW_EFFECTS = register(
      ...
      builder -> builder.codec(SuspiciousStewEffectsComponent.CODEC).packetCodec(SuspiciousStewEffectsComponent.PACKET_CODEC).cache()
   );
   ...
   public static final ComponentType<List<BeehiveBlockEntity.BeeData>> BEES = register(
      "bees",
      builder -> builder.codec(BeehiveBlockEntity.BeeData.LIST_CODEC)
         .packetCodec(BeehiveBlockEntity.BeeData.PACKET_CODEC.collect(PacketCodecs.toList()))
         .cache()
   );
