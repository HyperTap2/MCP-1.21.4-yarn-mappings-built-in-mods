...
public record AttributeModifiersComponent(List<AttributeModifiersComponent.Entry> modifiers, boolean showInTooltip) {
   ...
   private static final Codec<AttributeModifiersComponent> BASE_CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            ...
            Codec.BOOL.optionalFieldOf("show_in_tooltip", true).forGetter(AttributeModifiersComponent::showInTooltip)
         )
   ...
   public AttributeModifiersComponent with(RegistryEntry<EntityAttribute> attribute, EntityAttributeModifier modifier, AttributeModifierSlot slot) {
      com.google.common.collect.ImmutableList.Builder<AttributeModifiersComponent.Entry> builder = ImmutableList.builderWithExpectedSize(
   ...
   public static class Builder {
      private final com.google.common.collect.ImmutableList.Builder<AttributeModifiersComponent.Entry> entries = ImmutableList.builder();
