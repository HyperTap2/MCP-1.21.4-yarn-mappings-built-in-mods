...
public record SpawnParticlesEnchantmentEffect(
   ...
   public record PositionSource(SpawnParticlesEnchantmentEffect.PositionSourceType type, float offset, float scale) {
      public static final MapCodec<SpawnParticlesEnchantmentEffect.PositionSource> CODEC = RecordCodecBuilder.<SpawnParticlesEnchantmentEffect.PositionSource>mapCodec(
            instance -> instance.group(
                  ...
                  Codec.FLOAT.optionalFieldOf("offset", 0.0F).forGetter(SpawnParticlesEnchantmentEffect.PositionSource::offset),
      ...
      public double getPosition(double entityPosition, double boundingBoxCenter, float boundingBoxSize, Random random) {
         return this.type.getCoordinate(entityPosition, boundingBoxCenter, boundingBoxSize * this.scale, random) + this.offset;
      }
   }
   ...
   public enum PositionSourceType implements StringIdentifiable {
      ...
      BOUNDING_BOX(
         "in_bounding_box", (entityPosition, boundingBoxCenter, boundingBoxSize, random) -> boundingBoxCenter + (random.nextDouble() - 0.5) * boundingBoxSize
      );
      ...
      PositionSourceType(final String id, final SpawnParticlesEnchantmentEffect.PositionSourceType.CoordinateSource coordinateSource) {
         this.id = id;
   ...
   public record VelocitySource(float movementScale, FloatProvider base) {
      public static final MapCodec<SpawnParticlesEnchantmentEffect.VelocitySource> CODEC = RecordCodecBuilder.mapCodec(
         instance -> instance.group(
               Codec.FLOAT.optionalFieldOf("movement_scale", 0.0F).forGetter(SpawnParticlesEnchantmentEffect.VelocitySource::movementScale),
