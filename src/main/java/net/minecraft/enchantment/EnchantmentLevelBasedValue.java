...
public interface EnchantmentLevelBasedValue {
   ...
   Codec<EnchantmentLevelBasedValue> CODEC = Codec.either(EnchantmentLevelBasedValue.Constant.CODEC, BASE_CODEC)
      .xmap(
         either -> (EnchantmentLevelBasedValue)either.map(type -> type, type -> type),
   ...
   record Fraction(EnchantmentLevelBasedValue numerator, EnchantmentLevelBasedValue denominator) implements EnchantmentLevelBasedValue {
