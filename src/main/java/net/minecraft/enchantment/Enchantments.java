   ...
   public static void bootstrap(Registerable<Enchantment> registry) {
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               DamageSourcePropertiesLootCondition.builder(
                  DamageSourcePredicate.Builder.create().tag(TagPredicate.unexpected(DamageTypeTags.BYPASSES_INVULNERABILITY))
               )
            )
      );
      register(
            ...
            .addEffect(
               ...
               AllOfLootCondition.builder(
                  ...
                  InvertedLootCondition.builder(
                     EntityPropertiesLootCondition.builder(
                        LootContext.EntityTarget.THIS, EntityPredicate.Builder.create().vehicle(EntityPredicate.Builder.create())
                     )
                  )
               )
            )
      ...
      register(
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               AllOfLootCondition.builder(
                  RandomChanceLootCondition.builder(0.35F), EntityPropertiesLootCondition.builder(LootContext.EntityTarget.THIS, builder)
               )
            )
      );
      register(
      ...
      register(
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               EntityPropertiesLootCondition.builder(
                  LootContext.EntityTarget.THIS,
                  EntityPredicate.Builder.create().type(EntityTypePredicate.create(registryEntryLookup5, EntityTypeTags.SENSITIVE_TO_SMITE))
               )
            )
      );
      register(
      ...
      register(
         ...
         Enchantment.builder(
            ...
            .addNonListEffect(
               EnchantmentEffectComponentTypes.TRIDENT_SPIN_ATTACK_STRENGTH, new AddEnchantmentEffect(EnchantmentLevelBasedValue.linear(1.5F, 0.75F))
            )
            .addNonListEffect(
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               AllOfLootCondition.builder(
                  WeatherCheckLootCondition.create().thundering(true),
                  EntityPropertiesLootCondition.builder(
                     LootContext.EntityTarget.THIS, EntityPredicate.Builder.create().type(registryEntryLookup5, EntityType.TRIDENT)
                  ),
