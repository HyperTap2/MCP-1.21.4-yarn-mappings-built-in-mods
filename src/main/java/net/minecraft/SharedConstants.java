...
public class SharedConstants {
   ...
   @Deprecated
   public static final int RELEASE_TARGET_PROTOCOL_VERSION = 769;
   @Deprecated
   public static final int field_29736 = 228;
   public static final int SNBT_TOO_OLD_THRESHOLD = 4173;
   private static final int field_29708 = 30;
   public static final boolean CRASH_ON_UNCAUGHT_THREAD_EXCEPTION = false;
   @Deprecated
   public static final int RESOURCE_PACK_VERSION = 46;
   @Deprecated
   public static final int DATA_PACK_VERSION = 61;
   @Deprecated
