   ...
   public static class CorridorExit extends NetherFortressGenerator.Piece {
      ...
      public void generate(
         ...
         this.fillWithOutline(
            world, chunkBox, 5, 8, 0, 7, 8, 0, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false
         );
         BlockState blockState = Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, true).with(FenceBlock.EAST, true);
         BlockState blockState2 = Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.NORTH, true).with(FenceBlock.SOUTH, true);
         ...
         for (int i = 3; i <= 9; i += 2) {
            this.fillWithOutline(world, chunkBox, 1, 7, i, 1, 8, i, blockState2.with(FenceBlock.WEST, true), blockState2.with(FenceBlock.WEST, true), false);
            this.fillWithOutline(world, chunkBox, 11, 7, i, 11, 8, i, blockState2.with(FenceBlock.EAST, true), blockState2.with(FenceBlock.EAST, true), false);
         }
   ...
   public static class CorridorNetherWartsRoom extends NetherFortressGenerator.Piece {
      ...
      public void generate(
         ...
         for (int j = 0; j <= 6; j++) {
            ...
            if (k >= 5 && k <= 8) {
               this.fillWithOutline(
                  world, chunkBox, 5, 5, k, 7, j + 4, k, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
               );
            } else if (k >= 9 && k <= 10) {
               this.fillWithOutline(
                  world, chunkBox, 5, 8, k, 7, j + 4, k, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
               );
            }
   ...
   public static class CorridorStairs extends NetherFortressGenerator.Piece {
      ...
      public void generate(
         ...
         for (int i = 0; i <= 9; i++) {
            ...
            this.fillWithOutline(
               world, chunkBox, 0, j + 1, l, 0, k - 1, l, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
            );
            this.fillWithOutline(
               world, chunkBox, 4, j + 1, l, 4, k - 1, l, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
            );
            if ((i & 1) == 0) {
