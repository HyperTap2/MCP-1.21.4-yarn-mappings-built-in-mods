         ...
         if (!this.hasWitch) {
            ...
            if (chunkBox.contains(blockPos)) {
               ...
               if (witchEntity != null) {
                  ...
                  witchEntity.refreshPositionAndAngles(blockPos.getX() + 0.5, blockPos.getY(), blockPos.getZ() + 0.5, 0.0F, 0.0F);
      ...
      if (!this.hasCat) {
         ...
         if (box.contains(blockPos)) {
            ...
            if (catEntity != null) {
               ...
               catEntity.refreshPositionAndAngles(blockPos.getX() + 0.5, blockPos.getY(), blockPos.getZ() + 0.5, 0.0F, 0.0F);
