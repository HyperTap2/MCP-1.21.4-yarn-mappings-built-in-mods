...
public interface StructurePieceType {
   ...
   StructurePieceType NETHER_FORTRESS_BRIDGE_CROSSING = register(nbt -> new NetherFortressGenerator.BridgeCrossing(nbt), "NeBCr");
   ...
   StructurePieceType STRONGHOLD_SPIRAL_STAIRCASE = register(nbt -> new StrongholdGenerator.SpiralStaircase(nbt), "SHSD");
   ...
   StructurePieceType OCEAN_MONUMENT_CORE_ROOM = register(nbt -> new OceanMonumentGenerator.CoreRoom(nbt), "OMCR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_X_ROOM = register(nbt -> new OceanMonumentGenerator.DoubleXRoom(nbt), "OMDXR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_X_Y_ROOM = register(nbt -> new OceanMonumentGenerator.DoubleXYRoom(nbt), "OMDXYR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_Y_ROOM = register(nbt -> new OceanMonumentGenerator.DoubleYRoom(nbt), "OMDYR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_Y_Z_ROOM = register(nbt -> new OceanMonumentGenerator.DoubleYZRoom(nbt), "OMDYZR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_Z_ROOM = register(nbt -> new OceanMonumentGenerator.DoubleZRoom(nbt), "OMDZR");
   StructurePieceType OCEAN_MONUMENT_ENTRY_ROOM = register(nbt -> new OceanMonumentGenerator.Entry(nbt), "OMEntry");
   StructurePieceType OCEAN_MONUMENT_PENTHOUSE = register(nbt -> new OceanMonumentGenerator.Penthouse(nbt), "OMPenthouse");
   StructurePieceType OCEAN_MONUMENT_SIMPLE_ROOM = register(OceanMonumentGenerator.SimpleRoom::new, "OMSimple");
   StructurePieceType OCEAN_MONUMENT_SIMPLE_TOP_ROOM = register(nbt -> new OceanMonumentGenerator.SimpleRoomTop(nbt), "OMSimpleT");
   ...
   interface ManagerAware extends StructurePieceType {
   ...
   interface Simple extends StructurePieceType {
