...
public class StructurePool {
   ...
   public StructurePoolElement getRandomElement(Random random) {
      return this.elements.isEmpty() ? EmptyPoolElement.INSTANCE : (StructurePoolElement)this.elements.get(random.nextInt(this.elements.size()));
   }
   ...
   public enum Projection implements StringIdentifiable {
      ...
      Projection(final String id, final ImmutableList<StructureProcessor> processors) {
         this.id = id;
