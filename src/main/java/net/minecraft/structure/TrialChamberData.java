...
public class TrialChamberData {
   ...
   public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
      ...
      StructurePools.register(
         ...
         new StructurePool(
            registryEntry, List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/reward/ominous_vault"), 1)), StructurePool.Projection.RIGID
         )
      );
      StructurePools.register(
         poolRegisterable,
      ...
      StructurePools.register(
         ...
         new StructurePool(
            registryEntry, List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/spawner/breeze/breeze"), 1)), StructurePool.Projection.RIGID
         )
      );
      StructurePools.register(
         poolRegisterable,
