            ...
            while (true) {
               ...
               if (reader.peek() == '@') {
                  ...
                  try {
                     ...
                     if (commandSyntaxException.getType() != EntitySelectorReader.MISSING_EXCEPTION
                        && commandSyntaxException.getType() != EntitySelectorReader.UNKNOWN_SELECTOR_EXCEPTION) {
