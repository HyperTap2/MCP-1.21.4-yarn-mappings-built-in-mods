...
public interface NumberRangeArgumentType<T extends NumberRange<?>> extends ArgumentType<T> {
   ...
   class FloatRangeArgumentType implements NumberRangeArgumentType<NumberRange.DoubleRange> {
   ...
   class IntRangeArgumentType implements NumberRangeArgumentType<NumberRange.IntRange> {
