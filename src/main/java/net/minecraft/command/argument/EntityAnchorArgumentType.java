...
public class EntityAnchorArgumentType implements ArgumentType<EntityAnchorArgumentType.EntityAnchor> {
   ...
   public static EntityAnchorArgumentType.EntityAnchor getEntityAnchor(CommandContext<ServerCommandSource> context, String name) {
      return (EntityAnchorArgumentType.EntityAnchor)context.getArgument(name, EntityAnchorArgumentType.EntityAnchor.class);
   }
   ...
   public enum EntityAnchor {
      ...
      static final Map<String, EntityAnchorArgumentType.EntityAnchor> ANCHORS = Util.make(Maps.newHashMap(), map -> {
