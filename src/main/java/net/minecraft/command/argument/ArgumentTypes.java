...
public class ArgumentTypes {
   ...
   public static ArgumentSerializer<?, ?> register(Registry<ArgumentSerializer<?, ?>> registry) {
      ...
      register(
         registry, "objective", ScoreboardObjectiveArgumentType.class, ConstantArgumentSerializer.of(ScoreboardObjectiveArgumentType::scoreboardObjective)
      );
      register(
         registry,
         "objective_criteria",
         ScoreboardCriterionArgumentType.class,
         ConstantArgumentSerializer.of(ScoreboardCriterionArgumentType::scoreboardCriterion)
      );
      ...
      register(
         registry, "float_range", NumberRangeArgumentType.FloatRangeArgumentType.class, ConstantArgumentSerializer.of(NumberRangeArgumentType::floatRange)
      );
      ...
      register(registry, "time", TimeArgumentType.class, new TimeArgumentType.Serializer());
       register(registry, "resource_or_tag", RegistryEntryPredicateArgumentType.class, new RegistryEntryPredicateArgumentType.Serializer());
       register(registry, "resource_or_tag_key", RegistryPredicateArgumentType.class, new RegistryPredicateArgumentType.Serializer());
       register(registry, "resource", RegistryEntryReferenceArgumentType.class, new RegistryEntryReferenceArgumentType.Serializer());
       register(registry, "resource_key", RegistryKeyArgumentType.class, new RegistryKeyArgumentType.Serializer());
      ...
      register(
         registry, "loot_table", RegistryEntryArgumentType.LootTableArgumentType.class, ConstantArgumentSerializer.of(RegistryEntryArgumentType::lootTable)
      );
      register(
         registry,
         "loot_predicate",
      ...
      register(
         registry,
         "loot_modifier",
         RegistryEntryArgumentType.LootFunctionArgumentType.class,
         ConstantArgumentSerializer.of(RegistryEntryArgumentType::lootFunction)
      );
