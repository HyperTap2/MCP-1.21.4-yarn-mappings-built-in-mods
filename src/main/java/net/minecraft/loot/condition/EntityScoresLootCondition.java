...
public record EntityScoresLootCondition(Map<String, BoundedIntUnaryOperator> scores, LootContext.EntityTarget entity) implements LootCondition {
   ...
   public Set<ContextParameter<?>> getAllowedParameters() {
      return Stream.concat(Stream.of(this.entity.getParameter()), this.scores.values().stream().flatMap(operator -> operator.getRequiredParameters().stream()))
   ...
   public static class Builder implements LootCondition.Builder {
      private final com.google.common.collect.ImmutableMap.Builder<String, BoundedIntUnaryOperator> scores = ImmutableMap.builder();
