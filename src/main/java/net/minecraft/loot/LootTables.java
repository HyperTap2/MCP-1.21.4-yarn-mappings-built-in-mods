...
public class LootTables {
   ...
   public static final Map<DyeColor, RegistryKey<LootTable>> SHEEP_DROPS_FROM_DYE_COLOR = Util.make(
      new EnumMap<>(DyeColor.class), lootTableMap -> registerAllDyeColors((EnumMap<DyeColor, RegistryKey<LootTable>>)lootTableMap, "entities/sheep")
   );
   ...
   public static final Map<DyeColor, RegistryKey<LootTable>> SHEEP_SHEARING_FROM_DYE_COLOR = Util.make(
      new EnumMap<>(DyeColor.class), lootTableMap -> registerAllDyeColors((EnumMap<DyeColor, RegistryKey<LootTable>>)lootTableMap, "shearing/sheep")
   );
