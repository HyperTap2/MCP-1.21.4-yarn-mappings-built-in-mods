...
public class LootContextTypes {
   ...
   public static final Codec<ContextType> CODEC = Identifier.CODEC
      .comapFlatMap(
         id -> Optional.ofNullable((ContextType)MAP.get(id))
   ...
   public static final ContextType BLOCK_USE = register(
      "block_use",
      builder -> builder.require(LootContextParameters.THIS_ENTITY).require(LootContextParameters.ORIGIN).require(LootContextParameters.BLOCK_STATE)
   );
