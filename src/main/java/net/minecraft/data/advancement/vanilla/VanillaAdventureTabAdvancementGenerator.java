...
public class VanillaAdventureTabAdvancementGenerator implements AdvancementTabGenerator {
   ...
   public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
      ...
      Advancement.Builder.create()
         ...
         .criterion(
            "struck_villager", ChanneledLightningCriterion.Conditions.create(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.VILLAGER))
         )
      ...
      Advancement.Builder.create()
         ...
         .criterion(
            "summoned_golem", SummonedEntityCriterion.Conditions.create(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.IRON_GOLEM))
         )
      ...
      Advancement.Builder.create()
         ...
         .criterion(
            ...
            KilledByArrowCriterion.Conditions.createCrossbow(
               registryEntryLookup2, EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.PILLAGER)
            )
         )
      ...
      Advancement.Builder.create()
         ...
         .criterion(
            ...
            createLightningStrike(
               NumberRange.IntRange.exactly(0), Optional.of(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.VILLAGER).build())
            )
         )
      ...
      AdvancementEntry advancementEntry9 = Advancement.Builder.create()
         ...
         .criterion(
            ...
            createLookingAtEntityUsing(
               EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.PARROT),
      ...
      Advancement.Builder.create()
         ...
         .criterion(
            ...
            PlayerInteractedWithEntityCriterion.Conditions.create(
               ...
               Optional.of(
                  EntityPredicate.contextPredicateFromEntityPredicate(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.ARMADILLO))
               )
            )
         )
         ...
         .criterion(
            ...
            ItemCriterion.Conditions.createItemUsedOnBlock(
               LocationPredicate.Builder.create()
                  .block(
                     BlockPredicate.Builder.create()
                        .blocks(registryEntryLookup3, Blocks.VAULT)
                        .state(StatePredicate.Builder.create().exactMatch(VaultBlock.OMINOUS, false))
                  ),
            ...
            ItemCriterion.Conditions.createItemUsedOnBlock(
               LocationPredicate.Builder.create()
                  .block(
                     BlockPredicate.Builder.create()
                        .blocks(registryEntryLookup3, Blocks.VAULT)
                        .state(StatePredicate.Builder.create().exactMatch(VaultBlock.OMINOUS, true))
                  ),
                     ...
                     DamageSourcePredicate.Builder.create()
                        ...
                        .directEntity(
                           EntityPredicate.Builder.create()
                              ...
                              .equipment(
                                 EntityEquipmentPredicate.Builder.create().mainhand(ItemPredicate.Builder.create().items(registryEntryLookup2, Items.MACE))
                              )
                        )
                  )
            )
   ...
   private static AdvancementCriterion<ItemCriterion.Conditions> requirePlacedComparatorReadingBlock(RegistryEntryLookup<Block> blockRegistry, Block block) {
      LootCondition.Builder[] builders = ComparatorBlock.FACING
         .getValues()
         .stream()
         .map(
            facing -> {
   ...
   private static Advancement.Builder requireTrimmedArmor(Advancement.Builder builder) {
      ...
      VanillaRecipeGenerator.streamSmithingTemplates()
         ...
         .forEach(
            template -> builder.criterion("armor_trimmed_" + template.getValue(), RecipeCraftedCriterion.Conditions.create((RegistryKey<Recipe<?>>)template))
         );
      return builder;
   }
   ...
   private static Advancement.Builder requireSalvagedSherd(RegistryEntryLookup<Item> itemRegistry, Advancement.Builder builder) {
      ...
      builder.criterion(
         "has_sherd", InventoryChangedCriterion.Conditions.items(ItemPredicate.Builder.create().tag(itemRegistry, ItemTags.DECORATED_POT_SHERDS))
      );
      builder.requirements(new AdvancementRequirements(List.of(list.stream().<String>map(Pair::getFirst).toList(), List.of("has_sherd"))));
      return builder;
   }
   ...
   private static Advancement.Builder requireListedMobsKilled(
      ...
      entityTypes.forEach(
         entityType -> builder.criterion(
            Registries.ENTITY_TYPE.getId((EntityType<?>)entityType).toString(),
            OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder.create().type(entityTypeRegistry, (EntityType<?>)entityType))
         )
      );
      return builder;
   }
