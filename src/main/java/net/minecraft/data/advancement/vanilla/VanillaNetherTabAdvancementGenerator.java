   ...
   public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
         ...
         .criterion(
            ...
            OnKilledCriterion.Conditions.createPlayerKilledEntity(
               EntityPredicate.Builder.create()
                  .type(registryEntryLookup, EntityType.GHAST)
      ...
      LootContextPredicate lootContextPredicate = LootContextPredicate.create(
         EntityPropertiesLootCondition.builder(
               ...
               EntityPredicate.Builder.create()
                  .equipment(
                     EntityEquipmentPredicate.Builder.create().head(ItemPredicate.Builder.create().tag(registryEntryLookup2, ItemTags.PIGLIN_SAFE_ARMOR))
                  )
            )
            .invert()
            .build(),
         EntityPropertiesLootCondition.builder(
               ...
               EntityPredicate.Builder.create()
                  .equipment(
                     EntityEquipmentPredicate.Builder.create().chest(ItemPredicate.Builder.create().tag(registryEntryLookup2, ItemTags.PIGLIN_SAFE_ARMOR))
                  )
            )
            .invert()
            .build(),
         EntityPropertiesLootCondition.builder(
               ...
               EntityPredicate.Builder.create()
                  .equipment(
                     EntityEquipmentPredicate.Builder.create().legs(ItemPredicate.Builder.create().tag(registryEntryLookup2, ItemTags.PIGLIN_SAFE_ARMOR))
                  )
            )
            .invert()
            .build(),
         EntityPropertiesLootCondition.builder(
               ...
               EntityPredicate.Builder.create()
                  .equipment(
                     EntityEquipmentPredicate.Builder.create().feet(ItemPredicate.Builder.create().tag(registryEntryLookup2, ItemTags.PIGLIN_SAFE_ARMOR))
                  )
            )
            .invert()
            .build()
