...
public class VanillaHusbandryTabAdvancementGenerator implements AdvancementTabGenerator {
   ...
   public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
      ...
      Advancement.Builder.create()
         ...
         .criterion(
            "kill_axolotl_target", EffectsChangedCriterion.Conditions.create(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.AXOLOTL))
         )
         .display(
         ...
         .criterion(
            ...
            ItemCriterion.Conditions.createItemUsedOnBlock(
               LocationPredicate.Builder.create()
                  .block(BlockPredicate.Builder.create().blocks(registryEntryLookup3, HoneycombItem.UNWAXED_TO_WAXED_BLOCKS.get().keySet())),
      ...
      Advancement.Builder.create()
         ...
         .criterion(
            ...
            ItemCriterion.Conditions.createItemUsedOnBlock(
               LocationPredicate.Builder.create()
                  .block(BlockPredicate.Builder.create().blocks(registryEntryLookup3, HoneycombItem.WAXED_TO_UNWAXED_BLOCKS.get().keySet())),
            ...
            reference -> builder.criterion(
               ...
               PlayerInteractedWithEntityCriterion.Conditions.create(
                  ...
                  Optional.of(
                     EntityPredicate.contextPredicateFromEntityPredicate(
                        EntityPredicate.Builder.create()
                           .type(registryEntryLookup, EntityType.FROG)
                           .typeSpecific(EntitySubPredicateTypes.frogVariant(reference))
                     )
                  )
               )
            )
   ...
   private static Advancement.Builder requireListedAnimalsBred(
      ...
      breedableAnimals.forEach(
         entityType -> advancementBuilder.criterion(
            EntityType.getId((EntityType<?>)entityType).toString(),
            BredAnimalsCriterion.Conditions.create(EntityPredicate.Builder.create().type(registryEntryLookup, (EntityType<?>)entityType))
         )
      );
      stream.forEach(
         entityType -> advancementBuilder.criterion(
            ...
            BredAnimalsCriterion.Conditions.create(
               Optional.of(EntityPredicate.Builder.create().type(registryEntryLookup, (EntityType<?>)entityType).build()),
               Optional.of(EntityPredicate.Builder.create().type(registryEntryLookup, (EntityType<?>)entityType).build()),
               Optional.empty()
            )
         )
   ...
   private static Advancement.Builder requireAllWolvesTamed(Advancement.Builder builder, RegistryWrapper.WrapperLookup registries) {
      ...
      impl.streamKeys()
         ...
         .forEach(
            key -> {
               RegistryEntry<WolfVariant> registryEntry = impl.getOrThrow((RegistryKey<WolfVariant>)key);
               builder.criterion(
