...
public class VanillaEndTabAdvancementGenerator implements AdvancementTabGenerator {
   ...
   public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
      ...
      AdvancementEntry advancementEntry2 = Advancement.Builder.create()
         ...
         .criterion(
            "killed_dragon",
            OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.ENDER_DRAGON))
         )
      ...
      Advancement.Builder.create()
         ...
         .criterion(
            "summoned_dragon", SummonedEntityCriterion.Conditions.create(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.ENDER_DRAGON))
         )
      ...
      AdvancementEntry advancementEntry4 = Advancement.Builder.create()
         ...
         .criterion(
            ...
            TickCriterion.Conditions.createLocation(
               LocationPredicate.Builder.createStructure(registries.getOrThrow(RegistryKeys.STRUCTURE).getOrThrow(StructureKeys.END_CITY))
            )
         )
