...
public abstract class RecipeGenerator {
   ...
   private static final Map<BlockFamily.Variant, RecipeGenerator.BlockFamilyRecipeFactory> VARIANT_FACTORIES = ImmutableMap.<BlockFamily.Variant, RecipeGenerator.BlockFamilyRecipeFactory>builder()
      .put(
         ...
         (RecipeGenerator.BlockFamilyRecipeFactory)(generator, output, input) -> generator.createButtonRecipe(output, Ingredient.ofItem(input))
      )
      .put(
      ...
      .put(
         ...
         (RecipeGenerator.BlockFamilyRecipeFactory)(generator, output, input) -> generator.createDoorRecipe(output, Ingredient.ofItem(input))
      )
      .put(
         BlockFamily.Variant.CUSTOM_FENCE,
         (RecipeGenerator.BlockFamilyRecipeFactory)(generator, output, input) -> generator.createFenceRecipe(output, Ingredient.ofItem(input))
      )
      .put(
      ...
      .put(
         ...
         (RecipeGenerator.BlockFamilyRecipeFactory)(generator, output, input) -> generator.createFenceGateRecipe(output, Ingredient.ofItem(input))
      )
      .put(
      ...
      .put(
         ...
         (RecipeGenerator.BlockFamilyRecipeFactory)(generator, output, input) -> generator.createSignRecipe(output, Ingredient.ofItem(input))
      )
      .put(
      ...
      .put(
         ...
         (RecipeGenerator.BlockFamilyRecipeFactory)(generator, output, input) -> generator.createStairsRecipe(output, Ingredient.ofItem(input))
      )
      .put(
      ...
      .put(
         ...
         (RecipeGenerator.BlockFamilyRecipeFactory)(generator, output, input) -> generator.createTrapdoorRecipe(output, Ingredient.ofItem(input))
      )
      .put(
   ...
   public void offerSmithingTrimRecipe(Item input, RegistryKey<Recipe<?>> registryKey) {
   ...
   public void offerReversibleCompactingRecipesWithReverseRecipeGroup(
      ...
      this.offerReversibleCompactingRecipes(
         reverseCategory, baseItem, compactingCategory, compactItem, getRecipeName(compactItem), null, reverseId, reverseGroup
      );
   }
            ...
            (variant, block) -> {
               if (block.getRequiredFeatures().isSubsetOf(enabledFeatures)) {
                  ...
                  if (blockFamilyRecipeFactory != null) {
                     ...
                     family.getGroup()
                        .ifPresent(group -> craftingRecipeJsonBuilder.group(group + (variant == BlockFamily.Variant.CUT ? "" : "_" + variant.getName())));
                     ...
                     private void addRecipeAdvancement(AdvancementEntry advancementEntry) {
                        list.add(
                           DataProvider.writeCodecToPath(
                              writer, registries, Advancement.CODEC, advancementEntry.value(), pathResolver2.resolveJson(advancementEntry.id())
                           )
                        );
                     }
                  };
