...
public class VanillaRecipeGenerator extends RecipeGenerator {
   ...
   public void generate() {
      ...
      CookingRecipeJsonBuilder.createSmelting(
            this.ingredientFromTag(ItemTags.SMELTS_TO_GLASS), RecipeCategory.BUILDING_BLOCKS, Blocks.GLASS.asItem(), 0.1F, 200
         )
   ...
   public record SmithingTemplate(Item template, RegistryKey<Recipe<?>> id) {
   }
}
