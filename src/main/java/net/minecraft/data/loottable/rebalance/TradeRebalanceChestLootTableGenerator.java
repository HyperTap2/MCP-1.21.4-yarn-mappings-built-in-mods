         ...
         LootTable.builder()
            ...
            .pool(
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(Items.BOOK).weight(1).apply(new EnchantRandomlyLootFunction.Builder().option(impl.getOrThrow(Enchantments.EFFICIENCY)))
                  )
            )
      );
      ...
      return LootTable.builder()
         ...
         .pool(
            LootPool.builder()
               ...
               .with(
                  ItemEntry.builder(Items.BOOK).weight(2).apply(new EnchantRandomlyLootFunction.Builder().option(impl.getOrThrow(Enchantments.QUICK_CHARGE)))
               )
         );
   }
