         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .conditionally(
                     EntityPropertiesLootCondition.builder(
                        LootContext.EntityTarget.THIS, EntityPredicate.Builder.create().typeSpecific(RaiderPredicate.CAPTAIN_WITHOUT_RAID)
                     )
                  )
            )
      );
      ...
      LootTableData.WOOL_FROM_DYE_COLOR
         .forEach(
            (color, wool) -> this.register(
               EntityType.SHEEP, LootTables.SHEEP_DROPS_FROM_DYE_COLOR.get(color), LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(wool)))
            )
         );
      this.register(
         EntityType.SHULKER,
