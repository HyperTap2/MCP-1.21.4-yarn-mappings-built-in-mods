         ...
         LootTable.builder()
            ...
            .pool(
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(Items.PRISMARINE_CRYSTALS).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 5.0F)))
                  )
            )
            .pool(
               LootPool.builder()
               ...
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(Items.CROSSBOW)
                        .weight(2)
                        .apply(EnchantWithLevelsLootFunction.builder(this.registries, UniformLootNumberProvider.create(5.0F, 20.0F)))
                  )
                  .with(
                     ItemEntry.builder(Items.IRON_AXE)
                        .weight(2)
      ...
      lootTableBiConsumer.accept(
         ...
         LootTable.builder()
            ...
            .pool(
               LootPool.builder()
                  .rolls(UniformLootNumberProvider.create(1.0F, 3.0F))
                  .with(LootTableEntry.builder(LootTables.TRIAL_CHAMBERS_REWARD_COMMON_CHEST))
            )
            .pool(
               LootPool.builder()
                  .rolls(ConstantLootNumberProvider.create(1.0F))
               ...
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(Items.BOOK)
                        ...
                        .apply(
                           new EnchantRandomlyLootFunction.Builder()
                              .options(RegistryEntryList.of(impl.getOrThrow(Enchantments.BREACH), impl.getOrThrow(Enchantments.DENSITY)))
                        )
                  )
                  .with(
                     ItemEntry.builder(Items.BOOK)
                        ...
                        .apply(
                           new SetEnchantmentsLootFunction.Builder()
                              .enchantment(impl.getOrThrow(Enchantments.WIND_BURST), ConstantLootNumberProvider.create(1.0F))
                        )
                  )
      ...
      lootTableBiConsumer.accept(
         ...
         LootTable.builder()
            ...
            .pool(
               LootPool.builder()
                  .rolls(UniformLootNumberProvider.create(1.0F, 3.0F))
                  .with(LootTableEntry.builder(LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_COMMON_CHEST))
            )
            .pool(
               LootPool.builder()
                  .rolls(ConstantLootNumberProvider.create(1.0F))
      ...
      return LootTable.builder()
         .pool(
            LootPool.builder()
               ...
               .with(
                  ItemEntry.builder(Items.ENCHANTED_GOLDEN_APPLE).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F)))
               )
      ...
      return LootTable.builder()
         ...
         .pool(
            LootPool.builder()
               ...
               .with(
                  ItemEntry.builder(Items.WILD_ARMOR_TRIM_SMITHING_TEMPLATE)
                     .weight(1)
                     .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)))
               )
         );
      ...
      return LootTable.builder()
         ...
         .pool(
            LootPool.builder()
               ...
               .with(
                  ItemEntry.builder(Items.SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE)
                     .weight(1)
                     .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)))
               )
         );
      ...
      return LootTable.builder()
         ...
         .pool(
            LootPool.builder()
               ...
               .with(
                  ItemEntry.builder(Items.DUNE_ARMOR_TRIM_SMITHING_TEMPLATE)
                     .weight(1)
                     .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)))
               )
         );
