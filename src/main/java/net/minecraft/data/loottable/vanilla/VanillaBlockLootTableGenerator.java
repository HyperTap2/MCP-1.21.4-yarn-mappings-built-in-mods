                  ...
                  LootPool.builder()
                     ...
                     .with(
                        ItemEntry.builder(Blocks.TNT)
                           .conditionally(
                              BlockStatePropertyLootCondition.builder(Blocks.TNT)
                        ...
                        ItemEntry.builder(Items.COCOA_BEANS)
                           .apply(
                              SetCountLootFunction.builder(ConstantLootNumberProvider.create(3.0F))
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(CocoaBlock.AGE, 2))
                                 )
                           )
                     )
                  )
         ...
         this.applyExplosionDecay(
            ...
            LootTable.builder()
               ...
               .pool(
                  LootPool.builder()
                     .conditionally(builder5)
                     .with(ItemEntry.builder(Items.POISONOUS_POTATO).conditionally(RandomChanceLootCondition.builder(0.02F)))
               )
         )
      );
      this.addDrop(
                     ...
                     AlternativeEntry.builder(
                        AlternativeEntry.builder(
                              ...
                              integer -> ItemEntry.builder(Items.SNOWBALL)
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(block)
                                       .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, integer.intValue()))
                                 )
            ...
            LootPool.builder()
               ...
               .with(
                  DynamicEntry.builder(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID)
                     .conditionally(
                        BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(DecoratedPotBlock.CRACKED, true))
                     )
                     .alternatively(
                        ItemEntry.builder(block)
                           .apply(
                     ...
                     AlternativeEntry.builder(
                        ...
                        age -> {
                           ...
                           BlockStatePropertyLootCondition.Builder builder2 = BlockStatePropertyLootCondition.builder(Blocks.PITCHER_CROP)
                              .properties(StatePredicate.Builder.create().exactMatch(PitcherCropBlock.AGE, age.intValue()));
                           return age == 4
                              ? ItemEntry.builder(Items.PITCHER_PLANT)
