...
public abstract class FlowableFluid extends Fluid {
   ...
   private static final ThreadLocal<Object2ByteLinkedOpenHashMap<FlowableFluid.NeighborGroup>> field_15901 = ThreadLocal.withInitial(
      () -> {
         Object2ByteLinkedOpenHashMap<FlowableFluid.NeighborGroup> object2ByteLinkedOpenHashMap = new Object2ByteLinkedOpenHashMap<FlowableFluid.NeighborGroup>(
            200
         ) {
   ...
   protected boolean isFlowBlocked(BlockView world, BlockPos pos, Direction direction) {
      ...
      if (fluidState.getFluid().matchesType(this)) {
         ...
         if (ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_11_1)) {
            ViaFabricPlusMappingDataLoader.Material material = ViaFabricPlusMappingDataLoader.MATERIALS
               .get(ViaFabricPlusMappingDataLoader.getBlockMaterial(blockState.getBlock()));
   ...
   private boolean canFlowThrough(
      BlockView world, BlockPos pos, BlockState state, Direction face, BlockPos fromPos, BlockState fromState, FluidState fluidState
   ) {
   ...
   static final class NeighborGroup {
      ...
      NeighborGroup(BlockState self, BlockState other, Direction facing) {
         ...
         this.hash = 31 * hash + facing.hashCode();
      }
