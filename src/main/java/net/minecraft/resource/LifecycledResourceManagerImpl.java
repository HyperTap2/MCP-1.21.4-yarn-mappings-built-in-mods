...
public class LifecycledResourceManagerImpl implements LifecycledResourceManager {
   ...
   private final boolean continuityUseRedirects;

   public LifecycledResourceManagerImpl(ResourceType type, List<ResourcePack> packs) {
      this.continuityUseRedirects = type == ResourceType.CLIENT_RESOURCES;
   ...
   public Optional<Resource> getResource(Identifier identifier) {
      if (this.continuityUseRedirects) {
         identifier = ResourceRedirectHandler.redirect(identifier);
      }
   ...
   public List<Resource> getAllResources(Identifier id) {
      if (this.continuityUseRedirects) {
         id = ResourceRedirectHandler.redirect(id);
      }
