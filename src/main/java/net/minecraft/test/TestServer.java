...
public class TestServer extends MinecraftServer {
   ...
   public static TestServer create(
      ...
      DataConfiguration dataConfiguration = new DataConfiguration(
         new DataPackSettings(new ArrayList<>(resourcePackManager.getIds()), List.of()), ENABLED_FEATURES
      );
   ...
   public boolean setupServer() {
      ...
      this.batches = Lists.newArrayList(Batches.createBatches(this.testFunctions, serverWorld));
