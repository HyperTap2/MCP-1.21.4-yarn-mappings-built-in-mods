...
import net.minecraft.component.type.FireworkExplosionComponent.Type;
...
public class FireworksSparkParticle {
   static class Explosion extends AnimatedParticle {
      ...
      public ParticleTextureSheet getType() {
         return Iris.IS_FOOL ? ParticleTextureSheet.TERRAIN_SHEET : ParticleTextureSheet.PARTICLE_SHEET_OPAQUE;
      }
   ...
   public static class FireworkParticle extends NoRenderParticle {
         ...
         if (this.age == 0) {
            ...
            if (this.explosions.size() >= 3) {
               ...
               for (FireworkExplosionComponent fireworkExplosionComponent : this.explosions) {
                  if (fireworkExplosionComponent.shape() == Type.LARGE_BALL) {
                     bl2 = true;
                     break;
                  }
               }
      ...
      private void addExplosionParticle(
         ...
         if (SodiumExtraClientMod.isMixinEnabled("particle.MixinFireworkParticle")
            && (!SodiumExtraClientMod.options().particleSettings.particles
               || !SodiumExtraClientMod.options().particleSettings.otherMap.getOrDefault(Identifier.ofVanilla("firework"), true))) {
            return;
         }
   ...
   public static class Flash extends SpriteBillboardParticle {
      ...
      public float getSize(float tickDelta) {
         return 7.1F * MathHelper.sin((this.age + tickDelta - 1.0F) * 0.25F * (float) Math.PI);
      }
   }
