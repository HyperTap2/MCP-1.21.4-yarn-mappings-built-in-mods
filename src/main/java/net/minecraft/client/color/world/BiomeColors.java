...
public class BiomeColors {
   ...
   public static int getGrassColor(BlockRenderView world, BlockPos pos) {
      return !SodiumExtraClientMod.isMixinEnabled("biome_colors.MixinBiomeColors")
            || SodiumExtraClientMod.options().detailSettings.biomeColors
         ? getColor(world, pos, GRASS_COLOR)
         : 9551193;
   }
   ...
   public static int getFoliageColor(BlockRenderView world, BlockPos pos) {
      return !SodiumExtraClientMod.isMixinEnabled("biome_colors.MixinBiomeColors")
            || SodiumExtraClientMod.options().detailSettings.biomeColors
         ? getColor(world, pos, FOLIAGE_COLOR)
         : 5877296;
   }
   ...
   public static int getWaterColor(BlockRenderView world, BlockPos pos) {
      return !SodiumExtraClientMod.isMixinEnabled("biome_colors.MixinBiomeColors")
            || SodiumExtraClientMod.options().detailSettings.biomeColors
         ? getColor(world, pos, WATER_COLOR)
         : 4159204;
   }
}
