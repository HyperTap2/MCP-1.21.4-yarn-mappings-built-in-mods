...
public class ToastManager {
   ...
   public void add(Toast toast) {
      if (SodiumExtraClientMod.isMixinEnabled("toasts.MixinToastManager")
         && (!SodiumExtraClientMod.options().extraSettings.toasts
   ...
   class Entry<T extends Toast> {
      ...
      public void draw(DrawContext context, int scaledWindowWidth) {
         ...
         context.getMatrices().translate(scaledWindowWidth - this.instance.getWidth() * this.visibleWidthPortion, this.topIndex * 32, 800.0F);
