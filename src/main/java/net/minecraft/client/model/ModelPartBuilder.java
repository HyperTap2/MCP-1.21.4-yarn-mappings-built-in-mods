...
public class ModelPartBuilder {
   ...
   public ModelPartBuilder cuboid(
      ...
      this.cuboidData
         .add(
            new ModelCuboidData(
               name, this.textureX, this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, extra, this.mirror, 1.0F, 1.0F, ALL_DIRECTIONS
            )
         );
      return this;
   }
   ...
   public ModelPartBuilder cuboid(String name, float offsetX, float offsetY, float offsetZ, int sizeX, int sizeY, int sizeZ, int textureX, int textureY) {
      ...
      this.cuboidData
         .add(
            new ModelCuboidData(
               name, this.textureX, this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, Dilation.NONE, this.mirror, 1.0F, 1.0F, ALL_DIRECTIONS
            )
         );
      return this;
   }
   ...
   public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ) {
      this.cuboidData
         .add(
            new ModelCuboidData(
               null, this.textureX, this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, Dilation.NONE, this.mirror, 1.0F, 1.0F, ALL_DIRECTIONS
            )
         );
      return this;
   }
   ...
   public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ, Set<Direction> directions) {
      this.cuboidData
         .add(
            new ModelCuboidData(
               null, this.textureX, this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, Dilation.NONE, this.mirror, 1.0F, 1.0F, directions
            )
         );
      return this;
   }
   ...
   public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ, boolean mirror) {
      this.cuboidData
         .add(
            new ModelCuboidData(
               null, this.textureX, this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, Dilation.NONE, mirror, 1.0F, 1.0F, ALL_DIRECTIONS
            )
         );
      return this;
   }
   ...
   public ModelPartBuilder cuboid(float offsetX, float offsetY, float offsetZ, float sizeX, float sizeY, float sizeZ, Dilation extra) {
      this.cuboidData
         .add(
            new ModelCuboidData(
               null, this.textureX, this.textureY, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, extra, this.mirror, 1.0F, 1.0F, ALL_DIRECTIONS
            )
         );
      return this;
   }
