      ...
      if (this.profileResult != null) {
         ...
         context.draw(vertexConsumers -> {
            ...
            for (ProfilerTiming profilerTimingx : list) {
               ...
               int mx = ColorHelper.mix(lx, -8355712);
               MatrixStack.Entry entry = context.getMatrices().peek();
               vertexConsumer.vertex(entry, i, p, 10.0F).color(lx);
      ...
      if (this.profileResult != null) {
         ...
         if (!list.isEmpty()) {
            ...
            if (index == 0) {
               ...
               index--;
               if (index < list.size() && !"unspecified".equals(list.get(index).name)) {
                  if (!this.currentPath.isEmpty()) {
                     this.currentPath = this.currentPath + "\u001e";
                  }

                  this.currentPath = this.currentPath + list.get(index).name;
               }
            }
         }
      }
