      ...
      if (this.enabled) {
         ...
         if (!this.audibleEntries.isEmpty()) {
            ...
            while (iterator.hasNext()) {
               SubtitlesHud.SubtitleEntry subtitleEntry2 = iterator.next();
            ...
            for (SubtitlesHud.SubtitleEntry subtitleEntry2 : this.audibleEntries) {
               ...
               if (soundEntry != null) {
                  ...
                  context.getMatrices()
                     .translate(context.getScaledWindowWidth() - l * 1.0F - 2.0F, context.getScaledWindowHeight() - 35 - i * (m + 1) * 1.0F, 0.0F);
