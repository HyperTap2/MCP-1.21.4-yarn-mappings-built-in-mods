      ...
      if (spectatorMenuCommand != SpectatorMenu.BLANK_COMMAND) {
         ...
         if (i > 3 && spectatorMenuCommand.isEnabled()) {
            ...
            drawContext.drawTextWithShadow(
               this.client.textRenderer, text, x + 19 - 2 - this.client.textRenderer.getWidth(text), (int)y + 6 + 3, 16777215 + (i << 24)
            );
         }
      }
   }
   ...
   public void render(DrawContext context) {
      ...
      if (i > 3 && this.spectatorMenu != null) {
         ...
         if (text != null) {
            ...
            context.drawTextWithBackground(this.client.textRenderer, text, k, l, j, ColorHelper.withAlpha(i, -1));
         }
      }
   }
