...
public class BookEditScreen extends Screen {
   ...
   private final SelectionManager currentPageSelectionManager = new SelectionManager(
      ...
      this::getClipboard,
      this::setClipboard,
      string -> string.length() < (ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_13_2) ? 256 : 1024)
         && this.textRenderer.getWrappedLinesHeight(string, 114) <= 128
   );
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (this.signing) {
         ...
         OrderedText orderedText = OrderedText.concat(
            OrderedText.styledForwardsVisitedString(this.title, Style.EMPTY), bl ? BLACK_CURSOR_TEXT : GRAY_CURSOR_TEXT
         );
   ...
   private BookEditScreen.PageContent createPageContent() {
      ...
      return new BookEditScreen.PageContent(string, position, bl, is, list.toArray(new BookEditScreen.Line[0]), list2.toArray(new Rect2i[0]));
   }
