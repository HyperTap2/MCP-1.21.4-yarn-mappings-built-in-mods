...
public class ChatSelectionScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      Text text = Text.translatable("gui.chatSelection.selected", new Object[]{i, j});
   ...
   public Text getNarratedTitle() {
      return ScreenTexts.joinSentences(new Text[]{super.getNarratedTitle(), CONTEXT_TEXT});
   }
      ...
      public class MessageEntry extends ChatSelectionScreen.SelectionListWidget.Entry {
         ...
         public MessageEntry(
            ...
            if (message != stringVisitable) {
               this.truncatedContent = StringVisitable.concat(new StringVisitable[]{stringVisitable, ScreenTexts.ELLIPSIS});
         ...
         private void drawCheckmark(DrawContext context, int y, int x, int entryHeight) {
            ...
            context.drawGuiTexture(RenderLayer::getGuiTextured, ChatSelectionScreen.CHECKMARK_ICON_TEXTURE, i, j, 9, 8);
         }
         ...
         @Override
         public Text getNarration() {
            return (Text)(this.isSelected() ? Text.translatable("narrator.select", new Object[]{this.narration}) : this.narration);
         }
