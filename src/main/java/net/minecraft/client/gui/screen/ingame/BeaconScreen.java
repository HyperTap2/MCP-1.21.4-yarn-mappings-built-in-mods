   ...
   public BeaconScreen(BeaconScreenHandler handler, PlayerInventory inventory, Text title) {
      ...
      handler.addListener(new ScreenHandlerListener() {
         ...
         public void onPropertyUpdate(ScreenHandler handler, int property, int value) {
            BeaconScreen.this.primaryEffect = ((BeaconScreenHandler)handler).getPrimaryEffect();
            BeaconScreen.this.secondaryEffect = ((BeaconScreenHandler)handler).getSecondaryEffect();
         }
      });
   }
