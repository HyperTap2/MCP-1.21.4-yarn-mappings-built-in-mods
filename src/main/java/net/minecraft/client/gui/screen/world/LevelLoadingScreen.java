...
public class LevelLoadingScreen extends Screen {
   ...
   private static final Object2IntMap<ChunkStatus> STATUS_TO_COLOR = (Object2IntMap<ChunkStatus>)Util.make(new Object2IntOpenHashMap(), map -> {
   ...
   private Text getPercentage() {
      return Text.translatable("loading.progress", new Object[]{MathHelper.clamp(this.progressProvider.getProgressPercentage(), 0, 100)});
   }
