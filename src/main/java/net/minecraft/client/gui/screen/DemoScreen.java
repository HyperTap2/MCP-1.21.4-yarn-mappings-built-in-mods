...
public class DemoScreen extends Screen {
   ...
   protected void init() {
      ...
      this.movementText = MultilineText.create(
         ...
         Text.translatable("demo.help.jump", new Object[]{gameOptions.jumpKey.getBoundKeyLocalizedText()}),
         Text.translatable("demo.help.inventory", new Object[]{gameOptions.inventoryKey.getBoundKeyLocalizedText()})
      );
