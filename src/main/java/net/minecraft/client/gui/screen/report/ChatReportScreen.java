...
public class ChatReportScreen extends ReportScreen<ChatAbuseReport.Builder> {
   ...
   protected void addContent() {
      ...
      this.selectReasonButton = ButtonWidget.builder(
            SELECT_REASON_TEXT,
            button -> this.client.setScreen(new AbuseReportReasonScreen(this, this.reportBuilder.getReason(), AbuseReportType.CHAT, reason -> {
   ...
   protected void onChange() {
      ...
      if (intSet.isEmpty()) {
         ...
         this.selectChatButton.setMessage(Text.translatable("gui.chatReport.selected_chat", new Object[]{intSet.size()}));
      }
