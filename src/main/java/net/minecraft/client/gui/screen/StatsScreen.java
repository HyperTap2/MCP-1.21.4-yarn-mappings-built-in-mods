...
public class StatsScreen extends Screen {
   ...
   class EntityStatsListWidget extends AlwaysSelectedEntryListWidget<StatsScreen.EntityStatsListWidget.Entry> {
      ...
      class Entry extends AlwaysSelectedEntryListWidget.Entry<StatsScreen.EntityStatsListWidget.Entry> {
         ...
         public void render(
            ...
            context.drawTextWithShadow(StatsScreen.this.textRenderer, this.entityTypeName, x + 2, y + 1, -1);
            context.drawTextWithShadow(StatsScreen.this.textRenderer, this.killedText, x + 2 + 10, y + 1 + 9, this.killedAny ? -4539718 : -8355712);
            context.drawTextWithShadow(StatsScreen.this.textRenderer, this.killedByText, x + 2 + 10, y + 1 + 9 * 2, this.killedByAny ? -4539718 : -8355712);
         }
      ...
      class Entry extends AlwaysSelectedEntryListWidget.Entry<StatsScreen.GeneralStatsListWidget.Entry> {
         ...
         public Text getNarration() {
            return Text.translatable(
               "narrator.select", new Object[]{Text.empty().append(this.displayName).append(ScreenTexts.SPACE).append(this.getFormatted())}
            );
         }
      }
   }
   ...
   class ItemStatsListWidget extends AlwaysSelectedEntryListWidget<StatsScreen.ItemStatsListWidget.Entry> {
      ...
      public boolean mouseClicked(double mouseX, double mouseY, int button) {
         ...
         return !bl
               && this.select(
                  (int)(mouseX - (this.getX() + this.width / 2.0 - this.getRowWidth() / 2.0)), (int)(mouseY - this.getY()) + (int)this.getScrollY() - 4
               )
            ? true
            : bl;
      }
      ...
      protected void renderDecorations(DrawContext context, int mouseX, int mouseY) {
         if (mouseY >= this.getY() && mouseY <= this.getBottom()) {
            ...
            if (entry != null) {
               ...
               context.drawTooltip(
                  StatsScreen.this.textRenderer, item.getName(), mouseX, mouseY, (Identifier)item.getComponents().get(DataComponentTypes.TOOLTIP_STYLE)
               );
            } else {
               Text text = null;
               int j = mouseX - i;
         ...
         public void render(
            ...
            if (StatsScreen.this.itemStats != null) {
               ...
               for (int i = 0; i < StatsScreen.this.itemStats.itemStatTypes.size(); i++) {
                  this.render(
                     context,
                     StatsScreen.this.itemStats.itemStatTypes.get(i).getOrCreateStat(this.item),
