...
public class ControlsListWidget extends ElementListWidget<ControlsListWidget.Entry> {
   ...
   public class CategoryEntry extends ControlsListWidget.Entry {
      ...
      public void render(
         ...
         context.drawTextWithShadow(
            ControlsListWidget.this.client.textRenderer, this.text, ControlsListWidget.this.width / 2 - this.textWidth / 2, y + entryHeight - 9 - 1, -1
         );
      }
   ...
   public class KeyBindingEntry extends ControlsListWidget.Entry {
      ...
      public void render(
         ...
         context.drawTextWithShadow(ControlsListWidget.this.client.textRenderer, this.bindingName, x, y + entryHeight / 2 - 9 / 2, -1);
         if (this.duplicate) {
            int l = 3;
