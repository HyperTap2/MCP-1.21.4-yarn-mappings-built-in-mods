...
public class SocialInteractionsScreen extends Screen {
   ...
   public Text getNarratedTitle() {
      return (Text)(this.serverLabel != null ? ScreenTexts.joinSentences(new Text[]{super.getNarratedTitle(), this.serverLabel}) : super.getNarratedTitle());
   }
   ...
   private void updateServerLabel(MinecraftClient client) {
      ...
      if (this.playerCount != i) {
         ...
         if (i > 1) {
            this.serverLabel = Text.translatable("gui.socialInteractions.server_label.multiple", new Object[]{string, i});
         } else {
            this.serverLabel = Text.translatable("gui.socialInteractions.server_label.single", new Object[]{string, i});
         }
