...
public abstract class HandledScreen<T extends ScreenHandler> extends Screen implements ScreenHandlerProvider<T> {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      boolean acceleratedGuiBatch = AcceleratedRendering.isAvailable()
         ...
         && AcceleratedItemRenderingFeature.shouldBatchGuiItems();
      if (acceleratedGuiBatch && !AcceleratedItemRenderingFeature.shouldMergeGuiItemBatches()) {
         context.draw();
      }
