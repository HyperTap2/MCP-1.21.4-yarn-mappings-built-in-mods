...
import mcp.client.gui.screen.BuiltinModsScreen;
...
public class OptionsScreen extends Screen {
   ...
   protected void init() {
      ...
      adder.add(this.createButton(VIDEO_TEXT, () -> SodiumOptionsGUI.createScreen(this)));
               ...
               button -> this.client
                  .setScreen(
                     new ConfirmScreen(
                        ...
                        Text.translatable(
                           "difficulty.lock.question", new Object[]{this.client.world.getLevelProperties().getDifficulty().getTranslatableName()}
                        )
                     )
                  )
            );
