...
public class SmithingScreen extends ForgingScreen<SmithingScreenHandler> {
   ...
   public void handledScreenTick() {
      ...
      this.baseSlotIcon.updateTexture(optional.<List<Identifier>>map(SmithingTemplateItem::getEmptyBaseSlotTextures).orElse(List.of()));
      this.additionsSlotIcon.updateTexture(optional.<List<Identifier>>map(SmithingTemplateItem::getEmptyAdditionsSlotTextures).orElse(List.of()));
   }
