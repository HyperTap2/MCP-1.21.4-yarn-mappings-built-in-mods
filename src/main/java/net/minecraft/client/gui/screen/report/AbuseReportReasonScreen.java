...
public class AbuseReportReasonScreen extends Screen {
   ...
   protected void init() {
      ...
      AbuseReportReasonScreen.ReasonListWidget.ReasonEntry reasonEntry = (AbuseReportReasonScreen.ReasonListWidget.ReasonEntry)Nullables.map(
         this.reason, this.reasonList::getEntry
      );
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawBorder(this.getLeft(), this.getTop(), this.getWidth(), this.getHeight(), -1);
   ...
   public class ReasonListWidget extends AlwaysSelectedEntryListWidget<AbuseReportReasonScreen.ReasonListWidget.ReasonEntry> {
      ...
      public class ReasonEntry extends AlwaysSelectedEntryListWidget.Entry<AbuseReportReasonScreen.ReasonListWidget.ReasonEntry> {
         ...
         public Text getNarration() {
            return Text.translatable("gui.abuseReport.reason.narration", new Object[]{this.reason.getText(), this.reason.getDescription()});
         }
