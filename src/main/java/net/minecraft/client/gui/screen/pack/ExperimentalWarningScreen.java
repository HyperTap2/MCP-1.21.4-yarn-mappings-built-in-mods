   ...
   class DetailsScreen extends Screen {
         ...
         public PackListWidget(final MinecraftClient client, final Collection<ResourcePackProfile> enabledProfiles) {
            ...
            for (ResourcePackProfile resourcePackProfile : enabledProfiles) {
               ...
               if (!string.isEmpty()) {
                  ...
                  Text text2 = Text.translatable("selectWorld.experimental.details.entry", new Object[]{string});
                  this.addEntry(
                     DetailsScreen.this.new PackListWidgetEntry(text, text2, MultilineText.create(DetailsScreen.this.textRenderer, text2, this.getRowWidth()))
                  );
               }
            }
         }
      ...
      class PackListWidgetEntry extends AlwaysSelectedEntryListWidget.Entry<ExperimentalWarningScreen.DetailsScreen.PackListWidgetEntry> {
         ...
         public void render(
            ...
            context.drawTextWithShadow(DetailsScreen.this.client.textRenderer, this.displayName, x, y, -1);
            this.multilineDetails.drawWithShadow(context, x, y + 12, 9, -1);
         }

         @Override
         public Text getNarration() {
            return Text.translatable("narrator.select", new Object[]{ScreenTexts.joinSentences(new Text[]{this.displayName, this.details})});
         }
      }
   }
}
