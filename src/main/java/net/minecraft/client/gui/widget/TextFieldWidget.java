...
public class TextFieldWidget extends ClickableWidget implements FocusableWidgetAccessor, ITextFieldWidget {
   ...
   private boolean forbiddenCharactersUnlocked;
   ...
   public void write(String text) {
      ...
      if (k > 0) {
         String string = this.forbiddenCharactersUnlocked ? text : StringHelper.stripInvalidChars(text);
         int l = string.length();
         if (k < l) {
   ...
   public boolean charTyped(char chr, int modifiers) {
      ...
      if (this.forbiddenCharactersUnlocked || StringHelper.isValidChar(chr)) {
         if (this.editable) {
   ...
   public void viaFabricPlus$unlockForbiddenCharacters() {
      this.forbiddenCharactersUnlocked = true;
   }
}
