...
public interface RealmsError {
   ...
   record DetailedHttpError(int httpCode, int code, @Nullable String reason, @Nullable String message) implements RealmsError {
      @Override
      public int getErrorCode() {
         return this.code;
      }
   ...
   record RawHttpPayloadError(int httpCode, String payload) implements RealmsError {
      @Override
      public int getErrorCode() {
   ...
   record SimpleHttpError(int httpCode, @Nullable Text payload) implements RealmsError {
      ...
      public static RealmsError.SimpleHttpError unknownCompatibility(String response) {
         return new RealmsError.SimpleHttpError(500, Text.translatable("mco.errorMessage.realmsService.unknownCompatibility", new Object[]{response}));
      }

      public static RealmsError.SimpleHttpError connectivity(RealmsHttpException exception) {
         return new RealmsError.SimpleHttpError(500, Text.translatable("mco.errorMessage.realmsService.connectivity", new Object[]{exception.getMessage()}));
      }
