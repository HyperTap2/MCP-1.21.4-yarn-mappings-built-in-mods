...
public class RealmsPendingInvitesScreen extends RealmsScreen {
         ...
         )
       {
         ...
         CompletableFuture.<Boolean>supplyAsync(() -> {
            try {
               ...
               LOGGER.error("Couldn't handle invite", realmsServiceException);
               return false;
            }
   ...
   void updateButtonStates() {
      RealmsPendingInvitesScreen.PendingInvitationSelectionListEntry pendingInvitationSelectionListEntry = this.pendingInvitationSelectionList
         .getSelectedOrNull();
   ...
   class PendingInvitationSelectionListEntry extends AlwaysSelectedEntryListWidget.Entry<RealmsPendingInvitesScreen.PendingInvitationSelectionListEntry> {
      ...
      private void renderPendingInvitationItem(DrawContext context, PendingInvite invite, int x, int y, int mouseX, int mouseY) {
         context.drawTextWithShadow(RealmsPendingInvitesScreen.this.textRenderer, invite.worldName, x + 38, y + 1, -1);
