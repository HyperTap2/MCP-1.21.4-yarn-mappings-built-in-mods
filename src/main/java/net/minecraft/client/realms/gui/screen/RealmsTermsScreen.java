...
public class RealmsTermsScreen extends RealmsScreen {
   ...
   private static final Text SENTENCE_TWO_TEXT = ScreenTexts.space()
      .append(Text.translatable("mco.terms.sentence.2").fillStyle(Style.EMPTY.withUnderline(true)));
   ...
   private void agreedToTos() {
      ...
      try {
         ...
         LOGGER.error("Couldn't agree to TOS", realmsServiceException);
      }
   }
   ...
   public Text getNarratedTitle() {
      return ScreenTexts.joinSentences(new Text[]{super.getNarratedTitle(), SENTENCE_ONE_TEXT}).append(ScreenTexts.SPACE).append(SENTENCE_TWO_TEXT);
   }
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawTextWithShadow(this.textRenderer, SENTENCE_ONE_TEXT, this.width / 2 - 120, row(5), -1);
