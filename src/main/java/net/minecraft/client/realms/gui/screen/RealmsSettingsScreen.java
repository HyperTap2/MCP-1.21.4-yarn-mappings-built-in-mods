...
public class RealmsSettingsScreen extends RealmsScreen {
   ...
   public void init() {
                  ...
                  this.client
                     .setScreen(
                        RealmsPopups.createInfoPopup(
                           this, Text.translatable("mco.configure.world.close.question.line1"), popupScreen -> this.parent.closeTheWorld()
                        )
                     );
               } else {
      ...
      this.nameEdit.setText(Objects.requireNonNullElse(this.serverData.getName(), ""));
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawTextWithShadow(this.textRenderer, WORLD_NAME_TEXT, this.width / 2 - 106, row(3), -1);
      context.drawTextWithShadow(this.textRenderer, WORLD_DESCRIPTION_TEXT, this.width / 2 - 106, row(7), -1);
   }
