...
public class RealmsConfigureWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.resetWorldButton = this.addDrawableChild(
         ButtonWidget.builder(
               ...
               button -> this.client
                  .setScreen(
                     RealmsCreateWorldScreen.resetWorld(this, this.server.clone(), () -> this.client.execute(() -> this.client.setScreen(this.getNewScreen())))
                  )
            )
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (this.server == null) {
         ...
         String string = Objects.requireNonNullElse(this.server.getName(), "");
         ...
         if (this.isMinigame()) {
            ...
            if (string2 != null) {
               context.drawTextWithShadow(
                  this.textRenderer, Text.translatable("mco.configure.world.minigame", new Object[]{string2}), this.left_x + 80 + 20 + 10, row(13), -1
               );
            }
         }
      }
                  ...
                  this.client
                     .setScreen(
                        new RealmsLongRunningMcoTaskScreen(
                           this.parent,
                           new SwitchSlotTask(serverData.id, selectedSlot, () -> this.client.execute(() -> this.client.setScreen(this.getNewScreen())))
                        )
                     );
               }
            )
            ...
            this.drawServerState(
               ...
               () -> {
                  if (this.server.daysLeft <= 0) {
                     ...
                     return (Text)(this.server.daysLeft == 1
                        ? EXPIRES_IN_A_DAY_TEXT
                        : Text.translatable("mco.selectServer.expires.days", new Object[]{this.server.daysLeft}));
                  }
               }
            );
         } else {
   ...
   public void openTheWorld(boolean join) {
      ...
      this.client
         .setScreen(
            new RealmsLongRunningMcoTaskScreen(realmsConfigureWorldScreen, new OpenServerTask(this.server, realmsConfigureWorldScreen, join, this.client))
         );
   }
