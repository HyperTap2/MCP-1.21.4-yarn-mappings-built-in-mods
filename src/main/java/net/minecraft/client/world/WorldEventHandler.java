...
public class WorldEventHandler {
   ...
   public void processWorldEvent(int eventId, BlockPos pos, int data) {
      ...
      switch (eventId) {
         ...
         case 1031:
            this.world
               .playSoundAtBlockCenter(pos, SoundEvents.BLOCK_ANVIL_LAND, SoundCategory.BLOCKS, 0.3F, this.world.random.nextFloat() * 0.1F + 0.9F, false);
            break;
         case 1032:
         ...
         case 1039:
            this.world
               .playSoundAtBlockCenter(pos, SoundEvents.ENTITY_PHANTOM_BITE, SoundCategory.HOSTILE, 0.3F, this.world.random.nextFloat() * 0.1F + 0.9F, false);
            break;
         case 1040:
            this.world
               .playSoundAtBlockCenter(
         ...
         case 1042:
            this.world
               .playSoundAtBlockCenter(pos, SoundEvents.BLOCK_GRINDSTONE_USE, SoundCategory.BLOCKS, 1.0F, this.world.random.nextFloat() * 0.1F + 0.9F, false);
            break;
         case 1043:
            this.world
               .playSoundAtBlockCenter(pos, SoundEvents.ITEM_BOOK_PAGE_TURN, SoundCategory.BLOCKS, 1.0F, this.world.random.nextFloat() * 0.1F + 0.9F, false);
            break;
         case 1044:
            this.world
               .playSoundAtBlockCenter(
                  pos, SoundEvents.BLOCK_SMITHING_TABLE_USE, SoundCategory.BLOCKS, 1.0F, this.world.random.nextFloat() * 0.1F + 0.9F, false
               );
            break;
         case 1045:
            this.world
         ...
         case 1501:
            ...
            for (int m = 0; m < 8; m++) {
               this.world
                  .addParticle(ParticleTypes.LARGE_SMOKE, pos.getX() + random.nextDouble(), pos.getY() + 1.2, pos.getZ() + random.nextDouble(), 0.0, 0.0, 0.0);
            }
            break;
         case 1502:
            this.world
         ...
         case 2007:
            ...
            this.world
               .playSoundAtBlockCenter(pos, SoundEvents.ENTITY_SPLASH_POTION_BREAK, SoundCategory.NEUTRAL, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
            break;
         case 2003:
            ...
            for (double g = 0.0; g < Math.PI * 2; g += Math.PI / 20) {
               this.worldRenderer
                  .addParticle(ParticleTypes.PORTAL, d + Math.cos(g) * 5.0, e - 0.4, f + Math.sin(g) * 5.0, Math.cos(g) * -5.0, 0.0, Math.sin(g) * -5.0);
               this.worldRenderer
                  .addParticle(ParticleTypes.PORTAL, d + Math.cos(g) * 5.0, e - 0.4, f + Math.sin(g) * 5.0, Math.cos(g) * -7.0, 0.0, Math.sin(g) * -7.0);
            }
            break;
         case 2004:
         ...
         case 2006:
            ...
            if (data == 1) {
               this.world
                  .playSoundAtBlockCenter(pos, SoundEvents.ENTITY_DRAGON_FIREBALL_EXPLODE, SoundCategory.HOSTILE, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
            }
            break;
         case 2008:
            this.world.addParticle(ParticleTypes.EXPLOSION, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, 0.0, 0.0, 0.0);
            break;
         case 2009:
            for (int m = 0; m < 8; m++) {
               this.world.addParticle(ParticleTypes.CLOUD, pos.getX() + random.nextDouble(), pos.getY() + 1.2, pos.getZ() + random.nextDouble(), 0.0, 0.0, 0.0);
            }
            break;
         case 2010:
         ...
         case 2013:
            ...
            break;
         case 3000:
            this.world.addParticle(ParticleTypes.EXPLOSION_EMITTER, true, true, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, 0.0, 0.0, 0.0);
            this.world
               .playSoundAtBlockCenter(
                  pos,
         ...
         case 3001:
            this.world
               .playSoundAtBlockCenter(
                  pos, SoundEvents.ENTITY_ENDER_DRAGON_GROWL, SoundCategory.HOSTILE, 64.0F, 0.8F + this.world.random.nextFloat() * 0.3F, false
               );
            break;
         case 3002:
            if (data >= 0 && data < Axis.VALUES.length) {
               ParticleUtil.spawnParticle(Axis.VALUES[data], this.world, pos, 0.125, ParticleTypes.ELECTRIC_SPARK, UniformIntProvider.create(10, 19));
            } else {
         ...
         case 3006:
            ...
            if (s > 0) {
               if (random.nextFloat() < 0.3F + s * 0.1F) {
                  float v = 0.15F + 0.02F * s * s * random.nextFloat();
               ...
               Supplier<Vec3d> supplier = () -> new Vec3d(
                  MathHelper.nextDouble(random, -0.005F, 0.005F),
                  MathHelper.nextDouble(random, -0.005F, 0.005F),
                  MathHelper.nextDouble(random, -0.005F, 0.005F)
               );
               if (b == 0) {
                  for (Direction direction : Direction.values()) {
                     ...
                     double p = direction.getAxis() == Axis.Y ? 0.65 : 0.57;
         ...
         case 3007:
            for (int af = 0; af < 10; af++) {
               this.world.addParticle(new ShriekParticleEffect(af * 5), pos.getX() + 0.5, pos.getY() + SculkShriekerBlock.TOP, pos.getZ() + 0.5, 0.0, 0.0, 0.0);
            }
         ...
         case 3009:
            ...
            break;
         case 3011:
            TrialSpawnerLogic.addMobSpawnParticles(this.world, pos, random, Type.fromIndex(data).particle);
            break;
         case 3012:
            this.world
               .playSoundAtBlockCenter(
         ...
         case 3015:
            ...
            break;
         case 3016:
            Client.spawnDeactivateParticles(this.world, pos, data == 0 ? ParticleTypes.SMALL_FLAME : ParticleTypes.SOUL_FIRE_FLAME);
            this.world
               .playSoundAtBlockCenter(
         ...
         case 3018:
            for (int sx = 0; sx < 10; sx++) {
               ...
               this.world
                  .addParticle(
                     ParticleTypes.POOF, pos.getX() + random.nextDouble(), pos.getY() + random.nextDouble(), pos.getZ() + random.nextDouble(), t, u, v
                  );
            }
   ...
   private void playJukeboxSong(RegistryEntry<JukeboxSong> song, BlockPos jukeboxPos) {
      ...
      JukeboxSong jukeboxSong = (JukeboxSong)song.value();
