...
public record GeneratorOptionsHolder(
   ...
   public GeneratorOptionsHolder(
      ...
      this(
         ...
         selectedDimensions,
         combinedDynamicRegistries.with(ServerDynamicRegistryType.DIMENSIONS, new Immutable[0]),
         dataPackContents,
         dataConfiguration,
         initialWorldOptions
      );
   ...
   public Immutable getCombinedRegistryManager() {
   ...
   @FunctionalInterface
   public interface RegistryAwareModifier extends BiFunction<Immutable, DimensionOptionsRegistryHolder, DimensionOptionsRegistryHolder> {
   }
}
