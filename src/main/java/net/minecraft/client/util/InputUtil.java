...
public class InputUtil {
   ...
   public static final class Key {
      ...
      Key(String translationKey, InputUtil.Type type, int code) {
         ...
         this.type = type;
         this.code = code;
         this.localizedText = new Lazy(() -> type.textTranslator.apply(code, translationKey));
   ...
   public enum Type {
      ...
      MOUSE(
         ...
         (buttonCode, translationKey) -> Language.getInstance().hasTranslation(translationKey)
            ...
            : Text.translatable("key.mouse", new Object[]{buttonCode + 1})
      );
      ...
      Type(final String name, final BiFunction<Integer, String, Text> textTranslator) {
         this.name = name;
