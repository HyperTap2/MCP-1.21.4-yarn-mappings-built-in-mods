...
public class UnstitchAtlasSource implements AtlasSource {
   ...
   public static final MapCodec<UnstitchAtlasSource> CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(
            ...
            Codec.DOUBLE.optionalFieldOf("divisor_x", 1.0).forGetter(source -> source.divisorX),
            Codec.DOUBLE.optionalFieldOf("divisor_y", 1.0).forGetter(source -> source.divisorY)
         )
