...
public interface Scaling {
   ...
   record NineSlice(int width, int height, Scaling.NineSlice.Border border, boolean stretchInner) implements Scaling {
      public static final MapCodec<Scaling.NineSlice> CODEC = RecordCodecBuilder.<Scaling.NineSlice>mapCodec(
            instance -> instance.group(
                  ...
                  Codec.BOOL.optionalFieldOf("stretch_inner", false).forGetter(Scaling.NineSlice::stretchInner)
               )
