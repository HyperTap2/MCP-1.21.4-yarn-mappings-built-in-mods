...
public class Main {
   ...
   public static void main(String[] args) throws IOException {
      ...
      OptionSpec<String> optionSpec4 = optionParser.accepts("output", "Output folder").withRequiredArg().defaultsTo("generated", new String[0]);
   ...
   public static void create(DataGenerator dataGenerator, boolean includeClient) {
      Pack pack = dataGenerator.createVanillaPack(includeClient);
