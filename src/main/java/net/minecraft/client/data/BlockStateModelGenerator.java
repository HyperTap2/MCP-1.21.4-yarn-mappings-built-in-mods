...
public class BlockStateModelGenerator {
   ...
   final Map<Block, TexturedModel> texturedModels = ImmutableMap.<Block, TexturedModel>builder()
      ...
      .put(
         ...
         TexturedModel.CUBE_COLUMN
            ...
            .textures(textureMap -> textureMap.put(TextureKey.SIDE, TextureMap.getId(Blocks.CUT_RED_SANDSTONE)))
      )
      ...
      .build();
   static final Map<Variant, BiConsumer<BlockStateModelGenerator.BlockTexturePool, Block>> VARIANT_POOL_FUNCTIONS = ImmutableMap.<Variant, BiConsumer<BlockStateModelGenerator.BlockTexturePool, Block>>builder()
   ...
   public static final List<Pair<Direction, Function<Identifier, BlockStateVariant>>> CONNECTION_VARIANT_FUNCTIONS = List.of(
      Pair.of(Direction.NORTH, (Function<Identifier, BlockStateVariant>)model -> BlockStateVariant.create().put(VariantSettings.MODEL, model)),
      Pair.of(
         Direction.EAST,
         (Function<Identifier, BlockStateVariant>)model -> BlockStateVariant.create()
   ...
   public static BlockStateSupplier createStoneState(Block block, Identifier modelId, TextureMap textures, BiConsumer<Identifier, ModelSupplier> modelCollector) {
   ...
   public static BlockStateSupplier createMudBrickState(
   ...
   public static BlockStateSupplier createDeepslateState(
      Block block, Identifier modelId, TextureMap textures, BiConsumer<Identifier, ModelSupplier> modelCollector
   ) {
   ...
   public static VariantsBlockStateSupplier createBlockStateWithRandomHorizontalRotations(Block block, Identifier modelId) {
      return VariantsBlockStateSupplier.create(block, createModelVariantWithRandomHorizontalRotations(modelId));
   }

   public static BlockStateVariant[] createModelVariantWithRandomHorizontalRotations(Identifier modelId) {
   ...
   public static VariantsBlockStateSupplier createBlockStateWithTwoModelAndRandomInversion(Block block, Identifier firstModelId, Identifier secondModelId) {
   ...
   public static BlockStateVariantMap createBooleanModelMap(BooleanProperty property, Identifier trueModel, Identifier falseModel) {
      return BlockStateVariantMap.<Boolean>create(property)
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(block)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(Properties.DUSTED)
                     .register(
                        dusted -> {
                           ...
                           return BlockStateVariant.create()
                              .put(
                                 ...
                                 Models.CUBE_ALL.upload(block, string, new TextureMap().put(TextureKey.ALL, identifier), this.modelCollector)
                              );
                        }
                     )
               )
   ...
   public static BlockStateSupplier createButtonBlockState(Block buttonBlock, Identifier regularModelId, Identifier pressedModelId) {
      return VariantsBlockStateSupplier.create(buttonBlock)
         .coordinate(
            BlockStateVariantMap.<Boolean>create(Properties.POWERED)
   ...
   public static BlockStateVariantMap.QuadrupleProperty<Direction, DoubleBlockHalf, DoorHinge, Boolean> fillDoorVariantMap(
      ...
      return variantMap.register(
            Direction.EAST, targetHalf, DoorHinge.LEFT, false, BlockStateVariant.create().put(VariantSettings.MODEL, leftHingeClosedModelId)
         )
         .register(
            Direction.SOUTH,
            targetHalf,
   ...
   public static BlockStateSupplier createCustomFenceBlockState(
   ...
   public static BlockStateSupplier createFenceGateBlockState(
      ...
      return VariantsBlockStateSupplier.create(fenceGateBlock, BlockStateVariant.create().put(VariantSettings.UVLOCK, uvlock))
         ...
         .coordinate(
            BlockStateVariantMap.<Boolean, Boolean>create(Properties.IN_WALL, Properties.OPEN)
   ...
   public static BlockStateSupplier createOrientableTrapdoorBlockState(
   ...
   public static BlockStateSupplier createTrapdoorBlockState(Block trapdoorBlock, Identifier topModelId, Identifier bottomModelId, Identifier openModelId) {
      return VariantsBlockStateSupplier.create(trapdoorBlock)
         .coordinate(
            BlockStateVariantMap.create(Properties.HORIZONTAL_FACING, Properties.BLOCK_HALF, Properties.OPEN)
               .register(Direction.NORTH, BlockHalf.BOTTOM, false, BlockStateVariant.create().put(VariantSettings.MODEL, bottomModelId))
   ...
   public static BlockStateVariantMap createAxisRotatedVariantMap() {
      return BlockStateVariantMap.create(Properties.AXIS)
         ...
         .register(Axis.Z, BlockStateVariant.create().put(VariantSettings.X, VariantSettings.Rotation.R90))
         .register(Axis.X, BlockStateVariant.create().put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.Y, VariantSettings.Rotation.R90));
   }

   public static BlockStateSupplier createUvLockedColumnBlockState(Block block, TextureMap textureMap, BiConsumer<Identifier, ModelSupplier> modelCollector) {
      ...
      return VariantsBlockStateSupplier.create(block, BlockStateVariant.create().put(VariantSettings.MODEL, identifier4))
         .coordinate(
            BlockStateVariantMap.create(Properties.AXIS)
               .register(Axis.X, BlockStateVariant.create().put(VariantSettings.MODEL, identifier))
               .register(Axis.Y, BlockStateVariant.create().put(VariantSettings.MODEL, identifier2))
               .register(Axis.Z, BlockStateVariant.create().put(VariantSettings.MODEL, identifier3))
         );
   }

   public static BlockStateSupplier createAxisRotatedBlockState(Block block, Identifier modelId) {
   ...
   public final void registerAxisRotated(Block block, Identifier modelId) {
   ...
   public static BlockStateSupplier createAxisRotatedBlockState(Block block, Identifier verticalModelId, Identifier horizontalModelId) {
      return VariantsBlockStateSupplier.create(block)
         .coordinate(
            BlockStateVariantMap.create(Properties.AXIS)
               .register(Axis.Y, BlockStateVariant.create().put(VariantSettings.MODEL, verticalModelId))
               .register(Axis.Z, BlockStateVariant.create().put(VariantSettings.MODEL, horizontalModelId).put(VariantSettings.X, VariantSettings.Rotation.R90))
               .register(
                  Axis.X,
                  BlockStateVariant.create()
   ...
   public final void registerCreakingHeart(Block block) {
      Function<TexturedModel.Factory, Identifier> function = factory -> factory.andThen(
            textureMap -> textureMap.put(TextureKey.SIDE, TextureMap.getSubId(block, "_active"))
         )
         .andThen(textureMap -> textureMap.put(TextureKey.END, TextureMap.getSubId(block, "_top_active")))
         .upload(block, "_active", this.modelCollector);
      Identifier identifier = TexturedModel.END_FOR_TOP_CUBE_COLUMN.upload(block, this.modelCollector);
      Identifier identifier2 = TexturedModel.END_FOR_TOP_CUBE_COLUMN_HORIZONTAL.upload(block, this.modelCollector);
      Identifier identifier3 = function.apply(TexturedModel.END_FOR_TOP_CUBE_COLUMN);
      Identifier identifier4 = function.apply(TexturedModel.END_FOR_TOP_CUBE_COLUMN_HORIZONTAL);
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(block)
               .coordinate(
                  BlockStateVariantMap.create(Properties.AXIS, CreakingHeartBlock.ACTIVE)
                     .register(Axis.Y, false, BlockStateVariant.create().put(VariantSettings.MODEL, identifier))
                     .register(
                        Axis.Z, false, BlockStateVariant.create().put(VariantSettings.MODEL, identifier2).put(VariantSettings.X, VariantSettings.Rotation.R90)
                     )
                     .register(
                        Axis.X,
                        false,
                     ...
                     .register(Axis.Y, true, BlockStateVariant.create().put(VariantSettings.MODEL, identifier3))
                     .register(
                        Axis.Z, true, BlockStateVariant.create().put(VariantSettings.MODEL, identifier4).put(VariantSettings.X, VariantSettings.Rotation.R90)
                     )
                     .register(
                        Axis.X,
                        true,
   ...
   public final BlockStateModelGenerator.BlockTexturePool registerCubeAllModelTexturePool(Block block) {
      TexturedModel texturedModel = this.texturedModels.getOrDefault(block, TexturedModel.CUBE_ALL.get(block));
   ...
   public void registerHangingSign(Block base, Block hangingSign, Block wallHangingSign) {
      Identifier identifier = this.uploadParticleModel(hangingSign, base);
   ...
   public final BlockStateModelGenerator.LogTexturePool registerLog(Block logBlock) {
   ...
   public final void registerTintableCrossBlockStateWithStages(
      ...
      BlockStateVariantMap blockStateVariantMap = BlockStateVariantMap.<Integer>create(stageProperty).register(stage -> {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(stemBlock)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(Properties.AGE_7)
                     .register(
                        age -> BlockStateVariant.create()
                           .put(VariantSettings.MODEL, Models.STEM_GROWTH_STAGES[age].upload(stemBlock, textureMap, this.modelCollector))
                     )
               )
         );
   }
   ...
   private void registerSunflower() {
      ...
      Identifier identifier2 = this.createSubModel(
         Blocks.SUNFLOWER, "_bottom", BlockStateModelGenerator.CrossType.NOT_TINTED.getCrossModel(), TextureMap::cross
      );
   ...
   public final void registerDoubleBlock(Block block, Identifier upperHalfModelId, Identifier lowerHalfModelId) {
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(block)
               .coordinate(
         ...
         .register(
            (on, shape) -> {
               switch (shape) {
                  ...
                  case EAST_WEST:
                     return BlockStateVariant.create()
                        .put(VariantSettings.MODEL, on ? identifier4 : identifier)
                        .put(VariantSettings.Y, VariantSettings.Rotation.R90);
                  case ASCENDING_EAST:
                     return BlockStateVariant.create()
                        .put(VariantSettings.MODEL, on ? identifier5 : identifier2)
                        .put(VariantSettings.Y, VariantSettings.Rotation.R90);
                  case ASCENDING_WEST:
                     return BlockStateVariant.create()
                        .put(VariantSettings.MODEL, on ? identifier6 : identifier3)
                        .put(VariantSettings.Y, VariantSettings.Rotation.R90);
   ...
   public final Identifier uploadParticleModel(Block block, Block particleSource) {
   ...
   public final void registerCommandBlock(Block commandBlock) {
      ...
      Identifier identifier2 = this.createSubModel(
         commandBlock, "_conditional", Models.TEMPLATE_COMMAND_BLOCK, id -> textureMap.copyAndAdd(TextureKey.SIDE, id)
      );
      this.blockStateCollector
         .accept(
   ...
   public final List<BlockStateVariant> getBambooBlockStateVariants(int age) {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.BARREL)
               ...
               .coordinate(
                  BlockStateVariantMap.<Boolean>create(Properties.OPEN)
                     .register(
   ...
   public static <T extends Comparable<T>> BlockStateVariantMap createValueFencedModelMap(
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(beehive)
               .coordinate(createNorthDefaultHorizontalRotationStates())
               .coordinate(createValueFencedModelMap(BeehiveBlock.HONEY_LEVEL, 5, identifier2, identifier))
         );
   }
   ...
   public final void registerCrop(Block crop, Property<Integer> ageProperty, int... ageTextureIndices) {
      ...
      BlockStateVariantMap blockStateVariantMap = BlockStateVariantMap.<Integer>create(ageProperty).register(integer -> {
         int i = ageTextureIndices[integer];
         Identifier identifier = (Identifier)int2ObjectMap.computeIfAbsent(i, j -> this.createSubModel(crop, "_stage" + i, Models.CROP, TextureMap::crop));
         return BlockStateVariant.create().put(VariantSettings.MODEL, identifier);
      });
   ...
   private void registerSmoothStone() {
      ...
      this.blockStateCollector
         .accept(createSingletonBlockState(Blocks.SMOOTH_STONE, Models.CUBE_ALL.upload(Blocks.SMOOTH_STONE, textureMap, this.modelCollector)));
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.CAKE)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(Properties.BITES)
   ...
   private void registerSmithingTable() {
      ...
      this.blockStateCollector
         .accept(createSingletonBlockState(Blocks.SMITHING_TABLE, Models.CUBE.upload(Blocks.SMITHING_TABLE, textureMap, this.modelCollector)));
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.WATER_CAULDRON)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(LeveledCauldronBlock.LEVEL)
                     .register(
                        1,
                        BlockStateVariant.create()
                           .put(
                              ...
                              Models.TEMPLATE_CAULDRON_LEVEL1
                                 .upload(
                                    Blocks.WATER_CAULDRON, "_level1", TextureMap.cauldron(TextureMap.getSubId(Blocks.WATER, "_still")), this.modelCollector
                                 )
                           )
                     )
                     .register(
                        ...
                        BlockStateVariant.create()
                           .put(
                              ...
                              Models.TEMPLATE_CAULDRON_LEVEL2
                                 .upload(
                                    Blocks.WATER_CAULDRON, "_level2", TextureMap.cauldron(TextureMap.getSubId(Blocks.WATER, "_still")), this.modelCollector
                                 )
                           )
                     )
                     .register(
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.CRAFTER)
               ...
               .coordinate(
                  BlockStateVariantMap.<Boolean, Boolean>create(Properties.TRIGGERED, CrafterBlock.CRAFTING)
            ...
            VariantsBlockStateSupplier.create(block)
               .coordinate(
                  BlockStateVariantMap.create(Properties.FACING)
                     .register(
                        Direction.DOWN,
                        BlockStateVariant.create().put(VariantSettings.MODEL, identifier2).put(VariantSettings.X, VariantSettings.Rotation.R180)
                     )
                     ...
                     .register(
                        Direction.EAST, BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     )
                     .register(
                        Direction.SOUTH,
                        BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                     ...
                     .register(
                        Direction.WEST, BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R270)
                     )
               )
         );
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.END_PORTAL_FRAME)
               .coordinate(
                  BlockStateVariantMap.<Boolean>create(Properties.EYE)
         ...
         .accept(
            MultipartBlockStateSupplier.create(Blocks.COMPOSTER)
               ...
               .with(
                  ...
                  BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.COMPOSTER, "_contents1"))
               )
               .with(
                  When.create().set(Properties.LEVEL_8, 2),
                  BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.COMPOSTER, "_contents2"))
               )
               .with(
                  When.create().set(Properties.LEVEL_8, 3),
                  BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.COMPOSTER, "_contents3"))
               )
               .with(
                  When.create().set(Properties.LEVEL_8, 4),
                  BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.COMPOSTER, "_contents4"))
               )
               .with(
                  When.create().set(Properties.LEVEL_8, 5),
                  BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.COMPOSTER, "_contents5"))
               )
               .with(
                  When.create().set(Properties.LEVEL_8, 6),
                  BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.COMPOSTER, "_contents6"))
               )
               .with(
                  When.create().set(Properties.LEVEL_8, 7),
                  BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.COMPOSTER, "_contents7"))
               )
               .with(
                  When.create().set(Properties.LEVEL_8, 8),
                  BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.COMPOSTER, "_contents_ready"))
               )
         );
   }
   ...
   public final BlockStateSupplier createCopperBulbBlockState(
      ...
      return VariantsBlockStateSupplier.create(copperBulbBlock)
         .coordinate(
            BlockStateVariantMap.<Boolean, Boolean>create(Properties.LIT, Properties.POWERED)
               .register(
                  (lit, powered) -> lit
   ...
   private void registerPointedDripstone() {
      BlockStateVariantMap.DoubleProperty<Direction, Thickness> doubleProperty = BlockStateVariantMap.create(
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.DAYLIGHT_DETECTOR)
               .coordinate(
                  BlockStateVariantMap.<Boolean>create(Properties.INVERTED)
                     .register(
                        false,
                        BlockStateVariant.create()
                        ...
                        BlockStateVariant.create()
                           .put(
                              ...
                              Models.TEMPLATE_DAYLIGHT_DETECTOR
                                 .upload(ModelIds.getBlockSubModelId(Blocks.DAYLIGHT_DETECTOR, "_inverted"), textureMap2, this.modelCollector)
                           )
                     )
               )
         );
   ...
   public final List<Identifier> getFireFloorModels(Block texture) {
      Identifier identifier = Models.TEMPLATE_FIRE_FLOOR
         .upload(ModelIds.getBlockSubModelId(texture, "_floor0"), TextureMap.fire0(texture), this.modelCollector);
      Identifier identifier2 = Models.TEMPLATE_FIRE_FLOOR
         .upload(ModelIds.getBlockSubModelId(texture, "_floor1"), TextureMap.fire1(texture), this.modelCollector);
      return ImmutableList.of(identifier, identifier2);
   }

   public final List<Identifier> getFireSideModels(Block texture) {
   ...
   public final List<Identifier> getFireUpModels(Block texture) {
      ...
      Identifier identifier3 = Models.TEMPLATE_FIRE_UP_ALT
         .upload(ModelIds.getBlockSubModelId(texture, "_up_alt0"), TextureMap.fire0(texture), this.modelCollector);
      Identifier identifier4 = Models.TEMPLATE_FIRE_UP_ALT
         .upload(ModelIds.getBlockSubModelId(texture, "_up_alt1"), TextureMap.fire1(texture), this.modelCollector);
      return ImmutableList.of(identifier, identifier2, identifier3, identifier4);
   }
   ...
   public final void registerLantern(Block lantern) {
      ...
      this.blockStateCollector
         .accept(VariantsBlockStateSupplier.create(lantern).coordinate(createBooleanModelMap(Properties.HANGING, identifier2, identifier)));
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.FROSTED_ICE)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(Properties.AGE_3)
                     .register(
                        0,
                        BlockStateVariant.create().put(VariantSettings.MODEL, this.createSubModel(Blocks.FROSTED_ICE, "_0", Models.CUBE_ALL, TextureMap::all))
                     )
                     .register(
                        1,
                        BlockStateVariant.create().put(VariantSettings.MODEL, this.createSubModel(Blocks.FROSTED_ICE, "_1", Models.CUBE_ALL, TextureMap::all))
                     )
                     .register(
                        2,
                        BlockStateVariant.create().put(VariantSettings.MODEL, this.createSubModel(Blocks.FROSTED_ICE, "_2", Models.CUBE_ALL, TextureMap::all))
                     )
                     .register(
                        3,
                        BlockStateVariant.create().put(VariantSettings.MODEL, this.createSubModel(Blocks.FROSTED_ICE, "_3", Models.CUBE_ALL, TextureMap::all))
                     )
               )
         );
   }
   ...
   public final void registerTopSoil(Block topSoil, Identifier modelId, BlockStateVariant snowyVariant) {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(topSoil)
               .coordinate(BlockStateVariantMap.<Boolean>create(Properties.SNOWY).register(true, snowyVariant).register(false, list))
         );
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.COCOA)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(Properties.AGE_2)
            ...
            VariantsBlockStateSupplier.create(Blocks.HOPPER)
               .coordinate(
                  BlockStateVariantMap.create(Properties.HOPPER_FACING)
                     ...
                     .register(
                        Direction.EAST, BlockStateVariant.create().put(VariantSettings.MODEL, identifier2).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     )
                     .register(
                        Direction.SOUTH,
                        BlockStateVariant.create().put(VariantSettings.MODEL, identifier2).put(VariantSettings.Y, VariantSettings.Rotation.R180)
   ...
   private void registerPistons() {
      ...
      Identifier identifier4 = Models.CUBE_BOTTOM_TOP
         .upload(Blocks.PISTON, "_inventory", textureMap.copyAndAdd(TextureKey.TOP, identifier2), this.modelCollector);
   ...
   public final void registerPiston(Block piston, Identifier extendedModelId, TextureMap textures) {
               ...
               .coordinate(
                  BlockStateVariantMap.create(Properties.SHORT, Properties.PISTON_TYPE)
                     .register(
                        ...
                        PistonType.DEFAULT,
                        BlockStateVariant.create()
                           .put(VariantSettings.MODEL, Models.TEMPLATE_PISTON_HEAD.upload(Blocks.PISTON, "_head", textureMap3, this.modelCollector))
                     )
                     .register(
                        false,
                        PistonType.STICKY,
                     ...
                     .register(
                        ...
                        BlockStateVariant.create()
                           .put(
                              VariantSettings.MODEL,
                              Models.TEMPLATE_PISTON_HEAD_SHORT.upload(Blocks.PISTON, "_head_short_sticky", textureMap2, this.modelCollector)
                           )
                     )
               )
               .coordinate(createNorthDefaultRotationStates())
   ...
   public final void registerTorch(Block torch, Block wallTorch) {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(
                  wallTorch,
                  BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_TORCH_WALL.upload(wallTorch, textureMap, this.modelCollector))
               )
   ...
   private void registerRedstoneTorch() {
      ...
      Identifier identifier2 = Models.TEMPLATE_TORCH_UNLIT.upload(Blocks.REDSTONE_TORCH, "_off", textureMap2, this.modelCollector);
      this.blockStateCollector
      ...
      Identifier identifier4 = Models.TEMPLATE_TORCH_WALL_UNLIT.upload(Blocks.REDSTONE_WALL_TORCH, "_off", textureMap2, this.modelCollector);
      this.blockStateCollector
         .accept(
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.REPEATER)
               .coordinate(
                  BlockStateVariantMap.<Integer, Boolean, Boolean>create(Properties.DELAY, Properties.LOCKED, Properties.POWERED)
                     .register((tick, locked, on) -> {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.SEA_PICKLE)
               .coordinate(
                  BlockStateVariantMap.<Integer, Boolean>create(Properties.PICKLES, Properties.WATERLOGGED)
                     .register(
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.SNOW)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(Properties.LAYERS)
                     .register(
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.TRIPWIRE)
               .coordinate(
                  BlockStateVariantMap.<Boolean, Boolean, Boolean, Boolean, Boolean>create(
                        Properties.ATTACHED, Properties.EAST, Properties.NORTH, Properties.SOUTH, Properties.WEST
                     )
                     .register(
                        false,
                        false,
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.TRIPWIRE_HOOK)
               .coordinate(
                  BlockStateVariantMap.<Boolean, Boolean>create(Properties.ATTACHED, Properties.POWERED)
                     .register(
   ...
   public final Identifier getTurtleEggModel(int eggs, String prefix, TextureMap textures) {
      switch (eggs) {
         case 1:
         ...
         case 3:
            return Models.TEMPLATE_THREE_TURTLE_EGGS
               .upload(ModelIds.getMinecraftNamespacedBlock("three_" + prefix + "turtle_eggs"), textures, this.modelCollector);
         case 4:
            return Models.TEMPLATE_FOUR_TURTLE_EGGS
               .upload(ModelIds.getMinecraftNamespacedBlock("four_" + prefix + "turtle_eggs"), textures, this.modelCollector);
         default:
            throw new UnsupportedOperationException();
      }
   }

   public final Identifier getTurtleEggModel(Integer eggs, Integer hatch) {
      switch (hatch) {
         case 0:
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.TURTLE_EGG)
               .coordinate(
                  BlockStateVariantMap.<Integer, Integer>create(Properties.EGGS, Properties.HATCH)
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.SNIFFER_EGG)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(SnifferEggBlock.HATCH)
                     .register(hatch -> BlockStateVariant.create().put(VariantSettings.MODEL, function.apply(hatch)))
               )
         );
   }
   ...
   public final void registerMultifaceBlockModel(Block block) {
      ...
      When.PropertyCondition propertyCondition = (When.PropertyCondition)Util.make(
         When.create(), propertyConditionx -> CONNECTION_VARIANT_FUNCTIONS.stream().map(Pair::getFirst).map(MultifaceBlock::getProperty).forEach(property -> {
      ...
      for (Pair<Direction, Function<Identifier, BlockStateVariant>> pair : CONNECTION_VARIANT_FUNCTIONS) {
         BooleanProperty booleanProperty = MultifaceBlock.getProperty((Direction)pair.getFirst());
   ...
   public final void registerPaleMossCarpet(Block block) {
      Identifier identifier = TexturedModel.CARPET.upload(block, this.modelCollector);
      Identifier identifier2 = TexturedModel.MOSSY_CARPET_SIDE
         .get(block)
      ...
      Identifier identifier3 = TexturedModel.MOSSY_CARPET_SIDE
         .get(block)
      ...
      MultipartBlockStateSupplier multipartBlockStateSupplier = MultipartBlockStateSupplier.create(block);
      When.PropertyCondition propertyCondition = When.create().set(PaleMossCarpetBlock.BOTTOM, false);
      multipartBlockStateSupplier.with(When.create().set(PaleMossCarpetBlock.BOTTOM, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier));
      multipartBlockStateSupplier.with(propertyCondition, BlockStateVariant.create().put(VariantSettings.MODEL, identifier));
      CONNECTION_VARIANT_FUNCTIONS.stream().<Direction>map(Pair::getFirst).forEach(directionx -> {
         EnumProperty<WallShape> enumPropertyx = PaleMossCarpetBlock.getWallShape(directionx);
         if (enumPropertyx != null && block.getDefaultState().contains(enumPropertyx)) {
            propertyCondition.set(enumPropertyx, WallShape.NONE);
         }
      });
      ...
      for (Pair<Direction, Function<Identifier, BlockStateVariant>> pair : CONNECTION_VARIANT_FUNCTIONS) {
         ...
         if (enumProperty != null) {
            Function<Identifier, BlockStateVariant> function = (Function<Identifier, BlockStateVariant>)pair.getSecond();
            multipartBlockStateSupplier.with(When.create().set(enumProperty, WallShape.TALL), function.apply(identifier2));
            multipartBlockStateSupplier.with(When.create().set(enumProperty, WallShape.LOW), function.apply(identifier3));
            multipartBlockStateSupplier.with(propertyCondition, function.apply(identifier2));
         }
      }
   ...
   public final void registerHangingMoss(Block block) {
      BlockStateVariantMap blockStateVariantMap = BlockStateVariantMap.<Boolean>create(HangingMossBlock.TIP).register(tip -> {
         String string = tip ? "_tip" : "";
         TextureMap textureMap = TextureMap.cross(TextureMap.getSubId(block, string));
         Identifier identifier = BlockStateModelGenerator.CrossType.NOT_TINTED.getCrossModel().upload(block, string, textureMap, this.modelCollector);
         return BlockStateVariant.create().put(VariantSettings.MODEL, identifier);
      });
      this.registerItemModel(block);
      this.blockStateCollector.accept(VariantsBlockStateSupplier.create(block).coordinate(blockStateVariantMap));
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.SCULK_CATALYST)
               .coordinate(
                  BlockStateVariantMap.<Boolean>create(Properties.BLOOM)
                     .register(bloom -> BlockStateVariant.create().put(VariantSettings.MODEL, bloom ? identifier3 : identifier2))
               )
         );
         ...
         .forEach(
            pair -> {
               ...
               multipartBlockStateSupplier.with(
                  propertyCondition,
                  BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, rotation).put(VariantSettings.UVLOCK, true)
               );
   ...
   public final void supplyChiseledBookshelfModel(
      ...
      Identifier identifier = CHISELED_BOOKSHELF_MODEL_CACHE.computeIfAbsent(
   ...
   public final void registerShulkerBox(Block shulkerBox, @Nullable DyeColor dyeColor) {
      ...
      ItemModel.Unbaked unbaked = dyeColor != null
         ? ItemModels.special(identifier, new ShulkerBoxModelRenderer.Unbaked(dyeColor))
   ...
   public final void registerRoots(Block root, Block pottedRoot) {
      ...
      Identifier identifier = BlockStateModelGenerator.CrossType.NOT_TINTED.getFlowerPotCrossModel().upload(pottedRoot, textureMap, this.modelCollector);
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(Blocks.RESPAWN_ANCHOR)
               .coordinate(
                  BlockStateVariantMap.<Integer>create(Properties.CHARGES)
                     .register(charges -> BlockStateVariant.create().put(VariantSettings.MODEL, identifiers[charges]))
               )
         );
      this.registerParentedItemModel(Blocks.RESPAWN_ANCHOR, identifiers[0]);
   }

   public final BlockStateVariant addJigsawOrientationToVariant(Orientation orientation, BlockStateVariant variant) {
      switch (orientation) {
         case DOWN_NORTH:
   ...
   public final void registerSkull(Block block, Block wallBlock, SkullType type, Identifier baseModelId) {
      Identifier identifier = ModelIds.getMinecraftNamespacedBlock("skull");
      this.blockStateCollector.accept(createSingletonBlockState(block, identifier));
      this.blockStateCollector.accept(createSingletonBlockState(wallBlock, identifier));
   ...
   private void registerSkulls() {
      ...
      this.registerSkull(Blocks.CREEPER_HEAD, Blocks.CREEPER_WALL_HEAD, Type.CREEPER, identifier);
      this.registerSkull(Blocks.PLAYER_HEAD, Blocks.PLAYER_WALL_HEAD, Type.PLAYER, identifier);
      this.registerSkull(Blocks.ZOMBIE_HEAD, Blocks.ZOMBIE_WALL_HEAD, Type.ZOMBIE, identifier);
      this.registerSkull(Blocks.SKELETON_SKULL, Blocks.SKELETON_WALL_SKULL, Type.SKELETON, identifier);
      this.registerSkull(Blocks.WITHER_SKELETON_SKULL, Blocks.WITHER_SKELETON_WALL_SKULL, Type.WITHER_SKELETON, identifier);
      this.registerSkull(Blocks.PIGLIN_HEAD, Blocks.PIGLIN_WALL_HEAD, Type.PIGLIN, identifier);
   ...
   public final void registerBanner(Block block, Block wallBlock, DyeColor color) {
      Identifier identifier = ModelIds.getMinecraftNamespacedBlock("banner");
      Identifier identifier2 = ModelIds.getMinecraftNamespacedItem("template_banner");
      this.blockStateCollector.accept(createSingletonBlockState(block, identifier));
      this.blockStateCollector.accept(createSingletonBlockState(wallBlock, identifier));
      Item item = block.asItem();
      this.itemModelOutput.accept(item, ItemModels.special(identifier2, new BannerModelRenderer.Unbaked(color)));
   }
   ...
   public final void registerBed(Block block, Block particleSource, DyeColor color) {
      Identifier identifier = ModelIds.getMinecraftNamespacedBlock("bed");
      this.blockStateCollector.accept(createSingletonBlockState(block, identifier));
      Item item = block.asItem();
      Identifier identifier2 = Models.TEMPLATE_BED.upload(ModelIds.getItemModelId(item), TextureMap.particle(particleSource), this.modelCollector);
      this.itemModelOutput.accept(item, ItemModels.special(identifier2, new BedModelRenderer.Unbaked(color)));
   }
   ...
   public void register() {
      ...
      this.registerTintableCross(
         Blocks.BAMBOO_SAPLING, BlockStateModelGenerator.CrossType.TINTED, TextureMap.cross(TextureMap.getSubId(Blocks.BAMBOO, "_stage0"))
      );
      this.registerBamboo();
   ...
   private void registerLightBlock() {
      ...
      for (int i = 0; i <= 15; i++) {
         ...
         singleProperty.register(
            i,
            BlockStateVariant.create()
               .put(VariantSettings.MODEL, Models.PARTICLE.upload(Blocks.LIGHT, string, TextureMap.particle(identifier), this.modelCollector))
         );
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(candle)
               .coordinate(
                  BlockStateVariantMap.<Integer, Boolean>create(Properties.CANDLES, Properties.LIT)
   ...
   public class BlockTexturePool {
      ...
      public BlockStateModelGenerator.BlockTexturePool base(Block block, Model model) {
         ...
         if (BlockStateModelGenerator.this.stoneStateFactories.containsKey(block)) {
            BlockStateModelGenerator.this.blockStateCollector
               .accept(
                  BlockStateModelGenerator.this.stoneStateFactories
                     .get(block)
      ...
      public BlockStateModelGenerator.BlockTexturePool wall(Block wallBlock) {
         ...
         BlockStateModelGenerator.this.blockStateCollector
            .accept(BlockStateModelGenerator.createWallBlockState(wallBlock, identifier, identifier2, identifier3));
      ...
      public BlockStateModelGenerator.BlockTexturePool customFenceGate(Block customFenceGateBlock) {
         ...
         Identifier identifier3 = Models.TEMPLATE_CUSTOM_FENCE_GATE_WALL_OPEN
            .upload(customFenceGateBlock, textureMap, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.BlockTexturePool sign(Block signBlock) {
         ...
         Block block = (Block)this.family.getVariants().get(Variant.WALL_SIGN);
      ...
      public BlockStateModelGenerator.BlockTexturePool slab(Block block) {
         ...
         BlockStateModelGenerator.this.blockStateCollector
            .accept(BlockStateModelGenerator.createSlabBlockState(block, identifier, identifier2, this.baseModelId));
      ...
      private BlockStateModelGenerator.BlockTexturePool block(Block block) {
         TexturedModel texturedModel = BlockStateModelGenerator.this.texturedModels.getOrDefault(block, TexturedModel.CUBE_ALL.get(block));
      ...
      public BlockStateModelGenerator.BlockTexturePool family(BlockFamily family) {
         ...
         family.getVariants().forEach((variant, block) -> {
            if (!this.children.contains(block)) {
               BiConsumer<BlockStateModelGenerator.BlockTexturePool, Block> biConsumer = BlockStateModelGenerator.VARIANT_POOL_FUNCTIONS.get(variant);
               if (biConsumer != null) {
