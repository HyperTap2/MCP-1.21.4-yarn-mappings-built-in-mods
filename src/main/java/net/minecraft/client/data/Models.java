...
public class Models {
   ...
   public static final Model TEMPLATE_CHISELED_BOOKSHELF_SLOT_TOP_LEFT = block(
      "template_chiseled_bookshelf_slot_top_left", "_slot_top_left", TextureKey.TEXTURE
   );
   ...
   public static final Model[] STEM_GROWTH_STAGES = IntStream.range(0, 8)
