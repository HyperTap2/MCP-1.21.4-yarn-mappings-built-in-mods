...
public abstract class BlockStateVariantMap {
   ...
   private void checkAllPropertyDefinitions() {
      ...
      List<PropertiesMap> list2 = stream.filter(propertiesMap -> !this.variants.containsKey(propertiesMap)).collect(Collectors.toList());
      if (!list2.isEmpty()) {
         ...
         this.first
            ...
            .forEach(
               firstValue -> this.second
                  .getValues()
                  .forEach(secondValue -> this.register((T1)firstValue, (T2)secondValue, variantFactory.apply((T1)firstValue, (T2)secondValue)))
            );
         return this;
      }
      ...
      public BlockStateVariantMap registerVariants(BiFunction<T1, T2, List<BlockStateVariant>> variantsFactory) {
         this.first
            ...
            .forEach(
               firstValue -> this.second
                  .getValues()
                  .forEach(secondValue -> this.register((T1)firstValue, (T2)secondValue, variantsFactory.apply((T1)firstValue, (T2)secondValue)))
            );
         return this;
      }
   }
                     ...
                     secondValue -> this.third
                        ...
                        .forEach(
                           thirdValue -> this.register(
                              (T1)firstValue, (T2)secondValue, (T3)thirdValue, variantFactory.apply((T1)firstValue, (T2)secondValue, (T3)thirdValue)
                           )
                        )
                  )
            );
