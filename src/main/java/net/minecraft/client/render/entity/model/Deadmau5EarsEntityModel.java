...
public class Deadmau5EarsEntityModel extends BipedEntityModel<PlayerEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData2.addChild("left_ear", modelPartBuilder, ModelTransform.pivot(-6.0F, -6.0F, 0.0F));
      modelPartData2.addChild("right_ear", modelPartBuilder, ModelTransform.pivot(6.0F, -6.0F, 0.0F));
