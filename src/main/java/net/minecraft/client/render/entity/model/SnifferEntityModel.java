...
public class SnifferEntityModel extends EntityModel<SnifferEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      ModelPartData modelPartData2 = modelPartData.addChild("bone", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 5.0F, 0.0F));
   ...
   public void setAngles(SnifferEntityRenderState snifferEntityRenderState) {
      ...
      if (snifferEntityRenderState.searching) {
         this.animateWalking(
            SnifferAnimations.SEARCHING, snifferEntityRenderState.limbFrequency, snifferEntityRenderState.limbAmplitudeMultiplier, 9.0F, 100.0F
         );
      } else {
