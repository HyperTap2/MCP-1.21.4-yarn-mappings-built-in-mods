...
public class ParrotEntityModel extends EntityModel<ParrotEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild(
         "body", ModelPartBuilder.create().uv(2, 8).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F), ModelTransform.of(0.0F, 16.5F, -3.0F, 0.4937F, 0.0F, 0.0F)
      );
      modelPartData.addChild(
         "tail", ModelPartBuilder.create().uv(22, 1).cuboid(-1.5F, -1.0F, -1.0F, 3.0F, 4.0F, 1.0F), ModelTransform.of(0.0F, 21.07F, 1.16F, 1.015F, 0.0F, 0.0F)
      );
      modelPartData.addChild(
         "left_wing",
