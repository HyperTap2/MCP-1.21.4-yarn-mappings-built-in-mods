...
public class EntityModels {
   ...
   public static Map<EntityModelLayer, TexturedModelData> getModels() {
      ...
      TexturedModelData texturedModelData15 = TexturedModelData.of(FelineEntityModel.getModelData(Dilation.NONE), 64, 32);
      TexturedModelData texturedModelData16 = texturedModelData15.transform(FelineEntityModel.BABY_TRANSFORMER);
      TexturedModelData texturedModelData17 = TexturedModelData.of(FelineEntityModel.getModelData(new Dilation(0.01F)), 64, 32);
      ...
      builder.put(EntityModelLayers.CAT, texturedModelData15.transform(CatEntityModel.CAT_TRANSFORMER));
      builder.put(EntityModelLayers.CAT_BABY, texturedModelData16.transform(CatEntityModel.CAT_TRANSFORMER));
      builder.put(EntityModelLayers.CAT_COLLAR, texturedModelData17.transform(CatEntityModel.CAT_TRANSFORMER));
      builder.put(
         EntityModelLayers.CAT_BABY_COLLAR, texturedModelData17.transform(FelineEntityModel.BABY_TRANSFORMER).transform(CatEntityModel.CAT_TRANSFORMER)
      );
      ...
      builder.put(EntityModelLayers.OCELOT_BABY, texturedModelData16);
      ...
      builder.put(EntityModelLayers.STRIDER_BABY, texturedModelData23.transform(StriderEntityModel.BABY_TRANSFORMER));
      builder.put(EntityModelLayers.STRIDER_BABY_SADDLE, texturedModelData23.transform(StriderEntityModel.BABY_TRANSFORMER));
      ...
      builder.put(EntityModelLayers.VILLAGER_BABY, texturedModelData27.transform(VillagerResemblingModel.BABY_TRANSFORMER));
      ...
      builder.put(EntityModelLayers.WITHER_SKELETON, texturedModelData26.transform(modelTransformer5));
