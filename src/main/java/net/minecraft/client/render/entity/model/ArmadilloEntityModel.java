...
public class ArmadilloEntityModel extends EntityModel<ArmadilloEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      ModelPartData modelPartData3 = modelPartData2.addChild("head", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -2.0F, -11.0F));
      ...
      ModelPartData modelPartData4 = modelPartData3.addChild("right_ear", ModelPartBuilder.create(), ModelTransform.pivot(-1.0F, -1.0F, 0.0F));
      ...
      ModelPartData modelPartData5 = modelPartData3.addChild("left_ear", ModelPartBuilder.create(), ModelTransform.pivot(1.0F, -2.0F, 0.0F));
