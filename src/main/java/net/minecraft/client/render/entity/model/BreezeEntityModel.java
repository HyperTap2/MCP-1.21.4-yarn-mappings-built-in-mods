...
public class BreezeEntityModel extends EntityModel<BreezeEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData(int textureWidth, int textureHeight) {
      ...
      ModelPartData modelPartData2 = modelPartData.addChild("body", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
      ModelPartData modelPartData3 = modelPartData2.addChild("rods", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 8.0F, 0.0F));
      ...
      ModelPartData modelPartData5 = modelPartData.addChild("wind_body", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
