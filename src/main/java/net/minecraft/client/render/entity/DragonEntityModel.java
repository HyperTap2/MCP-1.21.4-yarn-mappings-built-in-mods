...
public class DragonEntityModel extends EntityModel<EnderDragonEntityRenderState> {
   ...
   public static TexturedModelData createTexturedModelData() {
      ...
      for (int i = 0; i < 5; i++) {
         modelPartData.addChild(neck(i), modelPartBuilder, ModelTransform.pivot(0.0F, 20.0F, -12.0F - i * 10.0F));
      }

      for (int i = 0; i < 12; i++) {
         modelPartData.addChild(tail(i), modelPartBuilder, ModelTransform.pivot(0.0F, 10.0F, 60.0F + i * 10.0F));
      }
   ...
   public void setAngles(EnderDragonEntityRenderState enderDragonEntityRenderState) {
      ...
      float k = 1.5F;
      Frame frame = enderDragonEntityRenderState.getLerpedFrame(6);
      ...
      for (int n = 0; n < 5; n++) {
         ...
         Frame frame2 = enderDragonEntityRenderState.getLerpedFrame(5 - n);
      ...
      this.head.pivotZ = j;
      this.head.pivotX = h;
      Frame frame3 = enderDragonEntityRenderState.getLerpedFrame(0);
      ...
      for (int q = 0; q < 12; q++) {
         Frame frame4 = enderDragonEntityRenderState.getLerpedFrame(12 + q);
