...
public class VillagerResemblingModel extends EntityModel<VillagerEntityRenderState> implements ModelWithHead, ModelWithHat {
   ...
   public static ModelData getModelData() {
      ...
      ModelPartData modelPartData3 = modelPartData2.addChild(
         "hat", ModelPartBuilder.create().uv(32, 0).cuboid(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new Dilation(0.51F)), ModelTransform.NONE
      );
      ...
      modelPartData4.addChild(
         "jacket", ModelPartBuilder.create().uv(0, 38).cuboid(-4.0F, 0.0F, -3.0F, 8.0F, 20.0F, 6.0F, new Dilation(0.5F)), ModelTransform.NONE
      );
   ...
   public void rotateArms(MatrixStack stack) {
      this.root.rotate(stack);
      this.arms.rotate(stack);
   }
}
