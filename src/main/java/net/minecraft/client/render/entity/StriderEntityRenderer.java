...
public class StriderEntityRenderer extends AgeableMobEntityRenderer<StriderEntity, StriderEntityRenderState, StriderEntityModel> {
   ...
   public StriderEntityRenderer(EntityRendererFactory.Context context) {
      super(
         context,
         new StriderEntityModel(context.getPart(EntityModelLayers.STRIDER)),
         new StriderEntityModel(context.getPart(EntityModelLayers.STRIDER_BABY)),
         0.5F
      );
      this.addFeature(
         new SaddleFeatureRenderer<>(
            ...
            Identifier.ofVanilla("textures/entity/strider/strider_saddle.png")
         )
      );
   }
