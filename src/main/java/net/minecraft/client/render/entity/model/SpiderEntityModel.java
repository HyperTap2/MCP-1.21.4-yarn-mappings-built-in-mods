...
public class SpiderEntityModel extends EntityModel<LivingEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild(
         "head", ModelPartBuilder.create().uv(32, 4).cuboid(-4.0F, -4.0F, -8.0F, 8.0F, 8.0F, 8.0F), ModelTransform.pivot(0.0F, 15.0F, -3.0F)
      );
      ...
      modelPartData.addChild(
         "body1", ModelPartBuilder.create().uv(0, 12).cuboid(-5.0F, -4.0F, -6.0F, 10.0F, 8.0F, 12.0F), ModelTransform.pivot(0.0F, 15.0F, 9.0F)
      );
