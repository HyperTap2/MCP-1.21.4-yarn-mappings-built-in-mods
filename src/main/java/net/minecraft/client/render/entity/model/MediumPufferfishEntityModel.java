...
public class MediumPufferfishEntityModel extends EntityModel<EntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild(
         "body", ModelPartBuilder.create().uv(12, 22).cuboid(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F), ModelTransform.pivot(0.0F, 22.0F, 0.0F)
      );
      modelPartData.addChild(
         "right_blue_fin", ModelPartBuilder.create().uv(24, 0).cuboid(-2.0F, 0.0F, 0.0F, 2.0F, 0.0F, 2.0F), ModelTransform.pivot(-2.5F, 18.0F, -1.5F)
      );
      modelPartData.addChild(
         "left_blue_fin", ModelPartBuilder.create().uv(24, 3).cuboid(0.0F, 0.0F, 0.0F, 2.0F, 0.0F, 2.0F), ModelTransform.pivot(2.5F, 18.0F, -1.5F)
      );
      modelPartData.addChild(
         "top_front_fin",
