...
public class BatEntityModel extends EntityModel<BatEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      ModelPartData modelPartData2 = modelPartData.addChild(
         "body", ModelPartBuilder.create().uv(0, 0).cuboid(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F), ModelTransform.pivot(0.0F, 17.0F, 0.0F)
      );
      ModelPartData modelPartData3 = modelPartData.addChild(
         "head", ModelPartBuilder.create().uv(0, 7).cuboid(-2.0F, -3.0F, -1.0F, 4.0F, 3.0F, 2.0F), ModelTransform.pivot(0.0F, 17.0F, 0.0F)
      );
      modelPartData3.addChild(
         "right_ear", ModelPartBuilder.create().uv(1, 15).cuboid(-2.5F, -4.0F, 0.0F, 3.0F, 5.0F, 0.0F), ModelTransform.pivot(-1.5F, -2.0F, 0.0F)
      );
      modelPartData3.addChild(
         "left_ear", ModelPartBuilder.create().uv(8, 15).cuboid(-0.1F, -3.0F, 0.0F, 3.0F, 5.0F, 0.0F), ModelTransform.pivot(1.1F, -3.0F, 0.0F)
      );
      ModelPartData modelPartData4 = modelPartData2.addChild(
         "right_wing", ModelPartBuilder.create().uv(12, 0).cuboid(-2.0F, -2.0F, 0.0F, 2.0F, 7.0F, 0.0F), ModelTransform.pivot(-1.5F, 0.0F, 0.0F)
      );
      modelPartData4.addChild(
         "right_wing_tip", ModelPartBuilder.create().uv(16, 0).cuboid(-6.0F, -2.0F, 0.0F, 6.0F, 8.0F, 0.0F), ModelTransform.pivot(-2.0F, 0.0F, 0.0F)
      );
      ModelPartData modelPartData5 = modelPartData2.addChild(
         "left_wing", ModelPartBuilder.create().uv(12, 7).cuboid(0.0F, -2.0F, 0.0F, 2.0F, 7.0F, 0.0F), ModelTransform.pivot(1.5F, 0.0F, 0.0F)
      );
      modelPartData5.addChild(
         "left_wing_tip", ModelPartBuilder.create().uv(16, 8).cuboid(0.0F, -2.0F, 0.0F, 6.0F, 8.0F, 0.0F), ModelTransform.pivot(2.0F, 0.0F, 0.0F)
      );
