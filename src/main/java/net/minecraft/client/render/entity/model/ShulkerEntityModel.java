...
public class ShulkerEntityModel extends EntityModel<ShulkerEntityRenderState> {
   ...
   private static ModelData getModelData() {
      ...
      modelPartData.addChild(
         "lid", ModelPartBuilder.create().uv(0, 0).cuboid(-8.0F, -16.0F, -8.0F, 16.0F, 12.0F, 16.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F)
      );
      modelPartData.addChild(
         "base", ModelPartBuilder.create().uv(0, 28).cuboid(-8.0F, -8.0F, -8.0F, 16.0F, 8.0F, 16.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F)
      );
      return modelData;
   }
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelData.getRoot()
         .addChild("head", ModelPartBuilder.create().uv(0, 52).cuboid(-3.0F, 0.0F, -3.0F, 6.0F, 6.0F, 6.0F), ModelTransform.pivot(0.0F, 12.0F, 0.0F));
