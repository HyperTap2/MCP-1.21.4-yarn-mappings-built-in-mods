...
public class RavagerEntityModel extends EntityModel<RavagerEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData3.addChild(
         "mouth", ModelPartBuilder.create().uv(0, 36).cuboid(-8.0F, 0.0F, -16.0F, 16.0F, 3.0F, 16.0F), ModelTransform.pivot(0.0F, -2.0F, 2.0F)
      );
   ...
   public void setAngles(RavagerEntityRenderState ravagerEntityRenderState) {
      ...
      if (g > 0.0F) {
         ...
         } else if (ravagerEntityRenderState.roarTick > 0.0) {
      ...
      float h = ravagerEntityRenderState.limbFrequency;
      float j = 0.4F * ravagerEntityRenderState.limbAmplitudeMultiplier;
