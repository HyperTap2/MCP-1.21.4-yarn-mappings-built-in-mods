...
public class DonkeyEntityModel extends AbstractHorseEntityModel<DonkeyEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData(float scale) {
      ...
      return TexturedModelData.of(modelData, 64, 64).transform(ModelTransformer.scaling(scale));
   }
   ...
   public static TexturedModelData getBabyTexturedModelData(float scale) {
      ...
      addDonkeyParts(modelData.getRoot());
      return TexturedModelData.of(AbstractHorseEntityModel.BABY_TRANSFORMER.apply(modelData), 64, 64).transform(ModelTransformer.scaling(scale));
   }
   ...
   private static void addDonkeyParts(ModelPartData root) {
      ...
      modelPartData.addChild("left_chest", modelPartBuilder, ModelTransform.of(6.0F, -8.0F, 0.0F, 0.0F, (float) (-Math.PI / 2), 0.0F));
      modelPartData.addChild("right_chest", modelPartBuilder, ModelTransform.of(-6.0F, -8.0F, 0.0F, 0.0F, (float) (Math.PI / 2), 0.0F));
      ...
      modelPartData2.addChild("left_ear", modelPartBuilder2, ModelTransform.of(1.25F, -10.0F, 4.0F, (float) (Math.PI / 12), 0.0F, (float) (Math.PI / 12)));
      modelPartData2.addChild("right_ear", modelPartBuilder2, ModelTransform.of(-1.25F, -10.0F, 4.0F, (float) (Math.PI / 12), 0.0F, (float) (-Math.PI / 12)));
   }
