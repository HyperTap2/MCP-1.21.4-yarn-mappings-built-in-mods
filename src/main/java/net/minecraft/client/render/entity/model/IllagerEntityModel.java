...
public class IllagerEntityModel<S extends IllagerEntityRenderState> extends EntityModel<S> implements ModelWithArms, ModelWithHead {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData2.addChild(
         "hat", ModelPartBuilder.create().uv(32, 0).cuboid(-4.0F, -10.0F, -4.0F, 8.0F, 12.0F, 8.0F, new Dilation(0.45F)), ModelTransform.NONE
      );
      modelPartData2.addChild(
         "nose", ModelPartBuilder.create().uv(24, 0).cuboid(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F, 2.0F), ModelTransform.pivot(0.0F, -2.0F, 0.0F)
      );
      ...
      modelPartData3.addChild(
         "left_shoulder", ModelPartBuilder.create().uv(44, 22).mirrored().cuboid(4.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F), ModelTransform.NONE
      );
      modelPartData.addChild(
   ...
   public void setAngles(S illagerEntityRenderState) {
      ...
      State state = illagerEntityRenderState.illagerState;
      if (state == State.ATTACKING) {
      ...
      } else if (state == State.SPELLCASTING) {
         ...
         this.rightArm.yaw = 0.0F;
         this.leftArm.yaw = 0.0F;
      } else if (state == State.BOW_AND_ARROW) {
      ...
      } else if (state == State.CROSSBOW_HOLD) {
         CrossbowPosing.hold(this.rightArm, this.leftArm, this.head, true);
      } else if (state == State.CROSSBOW_CHARGE) {
         CrossbowPosing.charge(this.rightArm, this.leftArm, illagerEntityRenderState.crossbowPullTime, illagerEntityRenderState.itemUseTime, true);
      ...
      boolean bl = state == State.CROSSED;
