...
public class AllayEntityModel extends EntityModel<AllayEntityRenderState> implements ModelWithArms {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData2.addChild(
         "head", ModelPartBuilder.create().uv(0, 0).cuboid(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -3.99F, 0.0F)
      );
   ...
   public void setAngles(AllayEntityRenderState allayEntityRenderState) {
      ...
      this.root.pivotY = this.root.pivotY + (float)Math.cos(j) * 0.25F * l;
