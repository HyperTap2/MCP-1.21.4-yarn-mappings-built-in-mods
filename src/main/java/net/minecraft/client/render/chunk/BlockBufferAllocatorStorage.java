...
public class BlockBufferAllocatorStorage implements AutoCloseable {
   ...
   private final Map<RenderLayer, BufferAllocator> allocators = (Map<RenderLayer, BufferAllocator>)Util.make(
      new Reference2ObjectArrayMap(BLOCK_LAYERS.size()), map -> {
   ...
   public Map<RenderLayer, BufferAllocator> iris$getAllocators() {
