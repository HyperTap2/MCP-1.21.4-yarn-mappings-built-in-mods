...
public class SpecialModelTypes {
   public static final IdMapper<Identifier, MapCodec<? extends SpecialModelRenderer.Unbaked>> ID_MAPPER = new IdMapper();
   ...
   private static final Map<Block, SpecialModelRenderer.Unbaked> BLOCK_TO_MODEL_TYPE = ImmutableMap.<Block, SpecialModelRenderer.Unbaked>builder()
      .put(Blocks.SKELETON_SKULL, new HeadModelRenderer.Unbaked(Type.SKELETON))
      .put(Blocks.ZOMBIE_HEAD, new HeadModelRenderer.Unbaked(Type.ZOMBIE))
      .put(Blocks.CREEPER_HEAD, new HeadModelRenderer.Unbaked(Type.CREEPER))
      .put(Blocks.DRAGON_HEAD, new HeadModelRenderer.Unbaked(Type.DRAGON))
      .put(Blocks.PIGLIN_HEAD, new HeadModelRenderer.Unbaked(Type.PIGLIN))
      .put(Blocks.PLAYER_HEAD, new HeadModelRenderer.Unbaked(Type.PLAYER))
      .put(Blocks.WITHER_SKELETON_SKULL, new HeadModelRenderer.Unbaked(Type.WITHER_SKELETON))
      .put(Blocks.SKELETON_WALL_SKULL, new HeadModelRenderer.Unbaked(Type.SKELETON))
      .put(Blocks.ZOMBIE_WALL_HEAD, new HeadModelRenderer.Unbaked(Type.ZOMBIE))
      .put(Blocks.CREEPER_WALL_HEAD, new HeadModelRenderer.Unbaked(Type.CREEPER))
      .put(Blocks.DRAGON_WALL_HEAD, new HeadModelRenderer.Unbaked(Type.DRAGON))
      .put(Blocks.PIGLIN_WALL_HEAD, new HeadModelRenderer.Unbaked(Type.PIGLIN))
      .put(Blocks.PLAYER_WALL_HEAD, new HeadModelRenderer.Unbaked(Type.PLAYER))
      .put(Blocks.WITHER_SKELETON_WALL_SKULL, new HeadModelRenderer.Unbaked(Type.WITHER_SKELETON))
