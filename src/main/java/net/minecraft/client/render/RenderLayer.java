...
public abstract class RenderLayer extends RenderPhase implements BlendingStateHolder {
   ...
   private static final Function<Identifier, RenderLayer> ARMOR_CUTOUT_NO_CULL = Util.memoize(
      texture -> createArmorCutoutNoCull("armor_cutout_no_cull", texture, false)
   );
   private static final Function<Identifier, RenderLayer> ARMOR_TRANSLUCENT = Util.memoize(
      texture -> {
         RenderLayer.MultiPhaseParameters multiPhaseParameters = RenderLayer.MultiPhaseParameters.builder()
            .program(RenderPhase.ShaderProgram.ARMOR_TRANSLUCENT)
   ...
   private static final Function<Identifier, RenderLayer> ENTITY_SOLID = Util.memoize(
      texture -> {
         RenderLayer.MultiPhaseParameters multiPhaseParameters = RenderLayer.MultiPhaseParameters.builder()
            ...
            .build(true);
         return of(
            "entity_solid", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, 1536, true, false, multiPhaseParameters
         );
      }
   );
   ...
   private static final Function<Identifier, RenderLayer> ENTITY_CUTOUT = Util.memoize(
      texture -> {
         RenderLayer.MultiPhaseParameters multiPhaseParameters = RenderLayer.MultiPhaseParameters.builder()
            ...
            .build(true);
         return of(
            "entity_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, 1536, true, false, multiPhaseParameters
         );
      }
   );
   ...
   private static final Function<Identifier, RenderLayer> ENTITY_SHADOW = Util.memoize(
      texture -> {
         RenderLayer.MultiPhaseParameters multiPhaseParameters = RenderLayer.MultiPhaseParameters.builder()
            ...
            .build(false);
         return of(
            "entity_shadow", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, 1536, false, false, multiPhaseParameters
         );
      }
   );
   ...
   private static final RenderLayer DRAGON_RAYS_DEPTH = of(
      ...
      false,
      false,
      RenderLayer.MultiPhaseParameters.builder().program(POSITION_PROGRAM).writeMaskState(DEPTH_MASK).build(false)
   );
   ...
   private static final RenderLayer.MultiPhase DEBUG_QUADS = of(
      ...
      false,
      true,
      RenderLayer.MultiPhaseParameters.builder().program(POSITION_COLOR_PROGRAM).transparency(TRANSLUCENT_TRANSPARENCY).cull(DISABLE_CULLING).build(false)
   );
   ...
   private static final RenderLayer WORLD_BORDER_COLOR_MASK = createWorldBorder(false);
   private static final RenderLayer WORLD_BORDER_ALL_MASK = createWorldBorder(true);
   ...
   private static final RenderPhase.ShaderProgram TRANSLUCENT_PARTICLE_SHADER = new RenderPhase.ShaderProgram(ShaderAccess.TRANSLUCENT_PARTICLE_SHADER);
   private static final RenderPhase.ShaderProgram WEATHER_SHADER = new RenderPhase.ShaderProgram(ShaderAccess.WEATHER_SHADER);
   private static final Function<Identifier, RenderLayer> TRANSLUCENT_PARTICLE = Util.memoize(
      texture -> of(
         ...
         false,
         RenderLayer.MultiPhaseParameters.builder()
            .program(TRANSLUCENT_PARTICLE_SHADER)
            .texture(new RenderPhase.Texture(texture, TriState.FALSE, false))
            .transparency(TRANSLUCENT_TRANSPARENCY)
   ...
   private static final Function<Identifier, RenderLayer> WEATHER_ALL_MASK = createWeather(true);
   private static final Function<Identifier, RenderLayer> WEATHER_COLOR_MASK = createWeather(false);
   private static final RenderLayer SKY = of(
      "sky",
      VertexFormats.POSITION,
      VertexFormat.DrawMode.QUADS,
      1536,
      false,
      false,
      RenderLayer.MultiPhaseParameters.builder().program(POSITION_PROGRAM).writeMaskState(COLOR_MASK).build(false)
   );
   private static final RenderLayer END_SKY = of(
      "end_sky",
      ...
      RenderLayer.MultiPhaseParameters.builder()
         ...
         .texture(new RenderPhase.Texture(SkyRendering.END_SKY_TEXTURE, TriState.FALSE, false))
         .transparency(TRANSLUCENT_TRANSPARENCY)
         .writeMaskState(COLOR_MASK)
         .build(false)
   );
   private static final RenderLayer SUNRISE_SUNSET = of(
      ...
      false,
      false,
      RenderLayer.MultiPhaseParameters.builder().program(POSITION_COLOR_PROGRAM).transparency(TRANSLUCENT_TRANSPARENCY).writeMaskState(COLOR_MASK).build(false)
   );
   private static final RenderLayer STARS = of(
      "stars",
      VertexFormats.POSITION,
      VertexFormat.DrawMode.QUADS,
      1536,
      false,
      false,
      RenderLayer.MultiPhaseParameters.builder().program(POSITION_PROGRAM).transparency(OVERLAY_TRANSPARENCY).writeMaskState(COLOR_MASK).build(false)
   );
   ...
   private static final RenderLayer.MultiPhase GUI_NAUSEA_OVERLAY = of(
      ...
      1536,
      RenderLayer.MultiPhaseParameters.builder()
         .texture(new RenderPhase.Texture(InGameHud.NAUSEA_TEXTURE, TriState.DEFAULT, false))
         .program(POSITION_TEXTURE_COLOR_PROGRAM)
         .transparency(NAUSEA_OVERLAY_TRANSPARENCY)
         .depthTest(ALWAYS_DEPTH_TEST)
         .writeMaskState(COLOR_MASK)
         .build(false)
   );
   ...
   private static final Function<Identifier, RenderLayer> VIGNETTE = Util.memoize(
      texture -> of(
         ...
         RenderLayer.MultiPhaseParameters.builder()
            .texture(new RenderPhase.Texture(texture, TriState.DEFAULT, false))
            .program(POSITION_TEXTURE_COLOR_PROGRAM)
            .transparency(VIGNETTE_TRANSPARENCY)
            .depthTest(ALWAYS_DEPTH_TEST)
            .writeMaskState(COLOR_MASK)
            .build(false)
      )
   ...
   private static final Function<Identifier, RenderLayer> CROSSHAIR = Util.memoize(
      texture -> of(
         ...
         RenderLayer.MultiPhaseParameters.builder()
            .texture(new RenderPhase.Texture(texture, TriState.FALSE, false))
            .program(POSITION_TEXTURE_COLOR_PROGRAM)
            .transparency(CROSSHAIR_TRANSPARENCY)
            .build(false)
      )
   );
   ...
   public static RenderLayer getEyes(Identifier texture) {
      return EYES.apply(texture, TRANSLUCENT_TRANSPARENCY);
   }
   ...
   private static RenderLayer.MultiPhase getClouds(boolean fancy, boolean culling) {
      return of(
         "clouds",
         VertexFormats.POSITION_COLOR,
         VertexFormat.DrawMode.QUADS,
   ...
   private static RenderLayer createWorldBorder(boolean allMask) {
      return of(
         "world_border",
         VertexFormats.POSITION_TEXTURE,
         VertexFormat.DrawMode.QUADS,
         ...
         RenderLayer.MultiPhaseParameters.builder()
            ...
            .lightmap(ENABLE_LIGHTMAP)
            .target(WEATHER_TARGET)
            .writeMaskState(allMask ? ALL_MASK : COLOR_MASK)
   ...
   public static RenderLayer getWorldBorder(boolean allMask) {
      return allMask ? WORLD_BORDER_ALL_MASK : WORLD_BORDER_COLOR_MASK;
   }
   ...
   private static Function<Identifier, RenderLayer> createWeather(boolean allMask) {
      return Util.memoize(
         texture -> of(
            "weather",
            VertexFormats.POSITION_TEXTURE_COLOR_LIGHT,
   ...
   public static RenderLayer getEndSky() {
      return END_SKY;
   }
   ...
   public static RenderLayer getStars() {
      return STARS;
   }
   ...
   public static RenderLayer getGuiOpaqueTexturedBackground(Identifier texture) {
      return GUI_OPAQUE_TEXTURED_BACKGROUND.apply(texture);
   }
   ...
   public static RenderLayer getVignette(Identifier texture) {
      return VIGNETTE.apply(texture);
   }

   public static RenderLayer getCrosshair(Identifier texture) {
      return CROSSHAIR.apply(texture);
   }
   ...
   public static final class MultiPhase extends RenderLayer {
      ...
      MultiPhase(
         ...
         if ("water_mask".equals(name) || phases.depthTest == RenderPhase.ALWAYS_DEPTH_TEST) {
            this.setTransparencyType(TransparencyType.WATER_MASK);
         } else if ("lines".equals(name)) {
            this.setTransparencyType(TransparencyType.LINES);
         } else if (phases.transparency == RenderPhase.NO_TRANSPARENCY || "sunrise_sunset".equals(name)) {
            this.setTransparencyType(TransparencyType.OPAQUE);
         } else if (phases.transparency == RenderPhase.GLINT_TRANSPARENCY || phases.transparency == RenderPhase.CRUMBLING_TRANSPARENCY) {
            this.setTransparencyType(TransparencyType.DECAL);
         } else {
            this.setTransparencyType(TransparencyType.GENERAL_TRANSPARENT);
         }
      }
      ...
      public Optional<Identifier> acceleratedRendering$getTexture() {
         return this.phases.texture.getId();
      }

      public boolean acceleratedRendering$isCullEnabled() {
         return this.phases.cull == RenderPhase.ENABLE_CULLING;
      }
   ...
   public static final class MultiPhaseParameters {
      ...
      MultiPhaseParameters(
         ...
         this.phases = ImmutableList.of(
            ...
            this.writeMaskState,
            this.colorLogic,
            new RenderPhase[]{this.lineWidth}
         );
      }
      ...
      public RenderPhase.DepthTest getDepth() {
