...
public enum ModelRotation implements ModelBakeSettings {
   ...
   private static final Map<Integer, ModelRotation> BY_INDEX = Arrays.stream(values())
      .collect(Collectors.toMap(rotation -> rotation.index, rotation -> (ModelRotation)rotation));
   ...
   ModelRotation(final int x, final int y) {
