...
public class ModelTextures {
   ...
   public static ModelTextures.Textures fromJson(JsonObject json, Identifier atlasTexture) {
      ...
      for (Map.Entry<String, JsonElement> entry : json.entrySet()) {
         add(atlasTexture, entry.getKey(), entry.getValue().getAsString(), builder);
      }
   ...
   public static class Builder {
      ...
      public ModelTextures build(ModelNameSupplier modelNameSupplier) {
         ...
         while (bl) {
            bl = false;
            ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<String, ModelTextures.TextureReferenceEntry>> objectIterator = Object2ObjectMaps.fastIterator(
               object2ObjectMap2
            );

            while (objectIterator.hasNext()) {
               it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<String, ModelTextures.TextureReferenceEntry> entry = (it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<String, ModelTextures.TextureReferenceEntry>)objectIterator.next();
               SpriteIdentifier spriteIdentifier = (SpriteIdentifier)object2ObjectMap.get(((ModelTextures.TextureReferenceEntry)entry.getValue()).target);
