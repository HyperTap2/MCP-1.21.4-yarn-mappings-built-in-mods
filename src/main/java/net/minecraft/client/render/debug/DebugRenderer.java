...
public class DebugRenderer {
   ...
   public static void drawString(
      MatrixStack matrices, VertexConsumerProvider vertexConsumers, String string, double x, double y, double z, int color, float size
   ) {
   ...
   public static void drawVoxelShapeOutlines(
      ...
      if (!list.isEmpty()) {
         ...
         VertexRendering.drawOutline(
            matrices, vertexConsumer, VoxelShapes.cuboid(list.get(0)), offsetX, offsetY, offsetZ, ColorHelper.fromFloats(alpha, red, green, blue)
         );
