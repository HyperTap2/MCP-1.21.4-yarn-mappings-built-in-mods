...
import net.minecraft.entity.ai.pathing.Path.DebugNodeInfo;
...
public class PathfindingDebugRenderer implements DebugRenderer.Renderer {
   ...
   public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
      if (!this.paths.isEmpty()) {
         ...
         for (Integer integer : this.paths.keySet()) {
            ...
            float f = this.nodeSizes.get(integer);
   ...
   public static void drawPath(
      ...
      DebugNodeInfo debugNodeInfo = path.getDebugNodeInfos();
      ...
      for (int i = 0; i < path.getLength(); i++) {
         ...
         if (!(getManhattanDistance(pathNode.getBlockPos(), cameraX, cameraY, cameraZ) > 80.0F)) {
            ...
            vertexConsumers.vertex(
                  matrices.peek(), (float)(pathNode.x - cameraX + 0.5), (float)(pathNode.y - cameraY + 0.5), (float)(pathNode.z - cameraZ + 0.5)
               )
               .color(k, l, m, 255);
         }
      }
