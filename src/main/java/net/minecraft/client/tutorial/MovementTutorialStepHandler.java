...
public class MovementTutorialStepHandler implements TutorialStepHandler {
   ...
   private static final Text MOVE_TITLE = Text.translatable(
      "tutorial.move.title",
      new Object[]{
         TutorialManager.keyToText("forward"), TutorialManager.keyToText("left"), TutorialManager.keyToText("back"), TutorialManager.keyToText("right")
      }
   );
   private static final Text MOVE_DESCRIPTION = Text.translatable("tutorial.move.description", new Object[]{TutorialManager.keyToText("jump")});
