...
public class BiomeEffectSoundPlayer implements ClientPlayerTickable, BiomeAmbienceInterface {
   ...
   public void tick() {
      ...
      Biome biome = (Biome)this.biomeAccess.getBiomeForNoiseGen(this.player.getX(), this.player.getY(), this.player.getZ()).value();
            ...
            sound -> {
               ...
               if (this.moodPercentage >= 1.0F) {
                  ...
                  PositionedSoundInstance positionedSoundInstance = PositionedSoundInstance.ambient(
                     (SoundEvent)sound.getSound().value(),
                     this.random,
