...
public class ShaderProgramKeys {
   ...
   public static final ShaderProgramKey RENDERTYPE_ENTITY_CUTOUT = register(
      "rendertype_entity_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL
   );
   ...
   public static final ShaderProgramKey RENDERTYPE_ENTITY_SHADOW = register(
      "rendertype_entity_shadow", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL
   );
