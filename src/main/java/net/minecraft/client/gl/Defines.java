...
public record Defines(Map<String, String> values, Set<String> flags) {
   ...
   public static final Codec<Defines> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            ...
            Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(Defines::flags)
         )
   ...
   public Defines withMerged(Defines other) {
      ...
      com.google.common.collect.ImmutableMap.Builder<String, String> builder = ImmutableMap.builderWithExpectedSize(this.values.size() + other.values.size());
      builder.putAll(this.values);
      builder.putAll(other.values);
      com.google.common.collect.ImmutableSet.Builder<String> builder2 = ImmutableSet.builderWithExpectedSize(this.flags.size() + other.flags.size());
