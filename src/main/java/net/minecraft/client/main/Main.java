...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      OptionSpec<File> optionSpec8 = optionParser.accepts("gameDir").withRequiredArg().ofType(File.class).defaultsTo(new File("."), new File[0]);
      ...
      OptionSpec<Integer> optionSpec12 = optionParser.accepts("proxyPort").withRequiredArg().defaultsTo("8080", new String[0]).ofType(Integer.class);
      ...
      OptionSpec<String> optionSpec15 = optionParser.accepts("username")
         .withRequiredArg()
         .defaultsTo("Player" + System.currentTimeMillis() % 1000L, new String[0]);
      OptionSpec<String> optionSpec16 = optionParser.accepts("uuid").withRequiredArg();
      OptionSpec<String> optionSpec17 = optionParser.accepts("xuid").withOptionalArg().defaultsTo("", new String[0]);
      OptionSpec<String> optionSpec18 = optionParser.accepts("clientId").withOptionalArg().defaultsTo("", new String[0]);
      ...
      OptionSpec<Integer> optionSpec21 = optionParser.accepts("width").withRequiredArg().ofType(Integer.class).defaultsTo(854, new Integer[0]);
      OptionSpec<Integer> optionSpec22 = optionParser.accepts("height").withRequiredArg().ofType(Integer.class).defaultsTo(480, new Integer[0]);
      ...
      OptionSpec<String> optionSpec25 = optionParser.accepts("userProperties").withRequiredArg().defaultsTo("{}", new String[0]);
      OptionSpec<String> optionSpec26 = optionParser.accepts("profileProperties").withRequiredArg().defaultsTo("{}", new String[0]);
      OptionSpec<String> optionSpec27 = optionParser.accepts("assetIndex").withRequiredArg();
      OptionSpec<String> optionSpec28 = optionParser.accepts("userType").withRequiredArg().defaultsTo("legacy", new String[0]);
      OptionSpec<String> optionSpec29 = optionParser.accepts("versionType").withRequiredArg().defaultsTo("release", new String[0]);
      ...
      try {
         ...
         String string3 = (String)optionSpec28.value(optionSet);
         ...
         PropertyMap propertyMap = (PropertyMap)JsonHelper.deserialize(gson, getOption(optionSet, optionSpec25), PropertyMap.class);
         PropertyMap propertyMap2 = (PropertyMap)JsonHelper.deserialize(gson, getOption(optionSet, optionSpec26), PropertyMap.class);
         ...
         UUID uUID = isUuidSetAndValid(optionSpec16, optionSet, logger)
            ? UndashedUuid.fromStringLenient((String)optionSpec16.value(optionSet))
            : Uuids.getOfflinePlayerUuid((String)optionSpec15.value(optionSet));
         String string8 = optionSet.has(optionSpec27) ? (String)optionSpec27.value(optionSet) : null;
         String string9 = (String)optionSet.valueOf(optionSpec17);
         String string10 = (String)optionSet.valueOf(optionSpec18);
         ...
         Session session = new Session(
            (String)optionSpec15.value(optionSet), uUID, (String)optionSpec19.value(optionSet), toOptional(string9), toOptional(string10), accountType
         );
         runArgs = new RunArgs(
