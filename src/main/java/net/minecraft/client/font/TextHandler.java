...
public class TextHandler {
   ...
   public StringVisitable trimToWidth(StringVisitable text, int width, Style style) {
      ...
      return text.visit(new StyledVisitor<StringVisitable>() {
   ...
   public List<StringVisitable> wrapLines(StringVisitable text, int maxWidth, Style style, StringVisitable wrappedLinePrefix) {
      ...
      this.wrapLines(
         ...
         maxWidth,
         style,
         (textx, lastLineWrapped) -> list.add(lastLineWrapped ? StringVisitable.concat(new StringVisitable[]{wrappedLinePrefix, textx}) : textx)
      );
      return list;
   }
