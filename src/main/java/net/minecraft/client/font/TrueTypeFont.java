...
public class TrueTypeFont implements Font {
   ...
   private Glyph loadGlyph(int codePoint, FT_Face face, int index) {
      ...
      return l > 0 && m > 0 ? new TrueTypeFont.TtfGlyph(j, k, l, m, f, index) : (Glyph.EmptyGlyph)() -> f / this.oversample;
   }
         ...
         return function.apply(new RenderableGlyph() {
            ...
            public void upload(int x, int y) {
               ...
               if (nativeImage.makeGlyphBitmapSubpixel(fT_Face, TtfGlyph.this.glyphIndex)) {
                  nativeImage.upload(0, x, y, 0, 0, TtfGlyph.this.width, TtfGlyph.this.height, true);
               } else {
                  nativeImage.close();
               }
            }
