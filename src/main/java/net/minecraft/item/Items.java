...
public class Items {
   ...
   public static final Item LIGHT = register(
      Blocks.LIGHT,
      settings -> settings.rarity(Rarity.EPIC).component(DataComponentTypes.BLOCK_STATE, BlockStateComponent.DEFAULT.with(LightBlock.LEVEL_15, 15))
   );
   ...
   public static final Item GOLDEN_CHESTPLATE = register(
      "golden_chestplate", settings -> new ArmorItem(ArmorMaterials.GOLD, EquipmentType.CHESTPLATE, settings)
   );
   ...
   public static final Item DARK_OAK_HANGING_SIGN = register(
      ...
      (block, settings) -> new HangingSignItem(block, Blocks.DARK_OAK_WALL_HANGING_SIGN, settings),
      new Item.Settings().maxCount(16)
   );
   public static final Item PALE_OAK_HANGING_SIGN = register(
      Blocks.PALE_OAK_HANGING_SIGN,
      (block, settings) -> new HangingSignItem(block, Blocks.PALE_OAK_WALL_HANGING_SIGN, settings),
      new Item.Settings().maxCount(16)
   );
   public static final Item MANGROVE_HANGING_SIGN = register(
      Blocks.MANGROVE_HANGING_SIGN,
      (block, settings) -> new HangingSignItem(block, Blocks.MANGROVE_WALL_HANGING_SIGN, settings),
      new Item.Settings().maxCount(16)
   );
   ...
   public static final Item CRIMSON_HANGING_SIGN = register(
      ...
      (block, settings) -> new HangingSignItem(block, Blocks.CRIMSON_WALL_HANGING_SIGN, settings),
      new Item.Settings().maxCount(16)
   );
   ...
   public static final Item WITHER_SKELETON_SPAWN_EGG = register(
      "wither_skeleton_spawn_egg", settings -> new SpawnEggItem(EntityType.WITHER_SKELETON, settings)
   );
   ...
   public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = register(
      "zombie_villager_spawn_egg", settings -> new SpawnEggItem(EntityType.ZOMBIE_VILLAGER, settings)
   );
   ...
   public static final Item IRON_HORSE_ARMOR = register(
      "iron_horse_armor",
      settings -> new AnimalArmorItem(ArmorMaterials.IRON, AnimalArmorItem.Type.EQUESTRIAN, SoundEvents.ENTITY_HORSE_ARMOR, false, settings),
      new Item.Settings().maxCount(1)
   );
   public static final Item GOLDEN_HORSE_ARMOR = register(
      "golden_horse_armor",
      settings -> new AnimalArmorItem(ArmorMaterials.GOLD, AnimalArmorItem.Type.EQUESTRIAN, SoundEvents.ENTITY_HORSE_ARMOR, false, settings),
      new Item.Settings().maxCount(1)
   );
   public static final Item DIAMOND_HORSE_ARMOR = register(
      "diamond_horse_armor",
      settings -> new AnimalArmorItem(ArmorMaterials.DIAMOND, AnimalArmorItem.Type.EQUESTRIAN, SoundEvents.ENTITY_HORSE_ARMOR, false, settings),
      new Item.Settings().maxCount(1)
   );
   public static final Item LEATHER_HORSE_ARMOR = register(
      "leather_horse_armor",
      settings -> new AnimalArmorItem(ArmorMaterials.LEATHER, AnimalArmorItem.Type.EQUESTRIAN, SoundEvents.ENTITY_HORSE_ARMOR, false, settings),
      new Item.Settings().maxCount(1)
   );
   ...
   public static final Item LINGERING_POTION = register(
      ...
      new Item.Settings().maxCount(1).component(DataComponentTypes.POTION_CONTENTS, PotionContentsComponent.DEFAULT)
   );
   ...
   public static final Item MUSIC_DISC_CAT = register(
      "music_disc_cat", new Item.Settings().maxCount(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.CAT)
   );
   ...
   public static final Item MUSIC_DISC_FAR = register(
      "music_disc_far", new Item.Settings().maxCount(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.FAR)
   );
   ...
   public static final Item FLOW_BANNER_PATTERN = register(
      "flow_banner_pattern",
      settings -> new BannerPatternItem(BannerPatternTags.FLOW_PATTERN_ITEM, settings),
      new Item.Settings().maxCount(1).rarity(Rarity.RARE)
   );
   ...
   public static final Item FIELD_MASONED_BANNER_PATTERN = register(
      ...
      settings -> new BannerPatternItem(BannerPatternTags.FIELD_MASONED_PATTERN_ITEM, settings),
      new Item.Settings().maxCount(1)
   );
