   ...
   public ActionResult useOnBlock(ItemUsageContext context) {
      ...
      if (blockState.isIn(BlockTags.FENCES)) {
         ...
         if (!world.isClient && playerEntity != null) {
            ActionResult actionResult = attachHeldMobsToBlock(playerEntity, world, blockPos);
            return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_21) ? ActionResult.SUCCESS : actionResult;
         }
