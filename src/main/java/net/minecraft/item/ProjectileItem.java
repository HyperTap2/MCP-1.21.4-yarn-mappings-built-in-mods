...
public interface ProjectileItem {
   ...
   record Settings(ProjectileItem.PositionFunction positionFunction, float uncertainty, float power, OptionalInt overrideDispenseEvent) {
      ...
      public static class Builder {
         private ProjectileItem.PositionFunction positionFunction = (pointer, direction) -> DispenserBlock.getOutputLocation(
            pointer, 0.7, new Vec3d(0.0, 0.1, 0.0)
         );
