...
public class AxeItem extends MiningToolItem {
   ...
   public ActionResult useOnBlock(ItemUsageContext context) {
      ...
      if (ProtocolTranslator.getTargetVersion().newerThan(ProtocolVersion.v1_20_5) && shouldCancelStripAttempt(context)) {
         return ActionResult.PASS;
      }
   ...
   private Optional<BlockState> tryStrip(World world, BlockPos pos, @Nullable PlayerEntity player, BlockState state) {
      ...
      if (optional.isPresent()) {
         ...
         if (optional2.isPresent()) {
            ...
            Optional<BlockState> optional3 = Optional.ofNullable((Block)HoneycombItem.WAXED_TO_UNWAXED_BLOCKS.get().get(state.getBlock()))
