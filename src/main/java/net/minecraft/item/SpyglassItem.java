...
public class SpyglassItem extends Item {
   ...
   public ActionResult use(World world, PlayerEntity user, Hand hand) {
      if (Zoomify.shouldPlaySpyglassSound()) user.playSound(SoundEvents.ITEM_SPYGLASS_USE, 1.0F, 1.0F);
   ...
   private void playStopUsingSound(LivingEntity user) {
      if (Zoomify.shouldPlaySpyglassSound()) user.playSound(SoundEvents.ITEM_SPYGLASS_STOP_USING, 1.0F, 1.0F);
   }
}
