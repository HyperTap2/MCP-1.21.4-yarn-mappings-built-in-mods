...
public class PlayerInteractEntityC2SPacket implements Packet<ServerPlayPacketListener> {
   ...
   public final PlayerInteractEntityC2SPacket.InteractTypeHandler type;
   private final boolean playerSneaking;
   public static final PlayerInteractEntityC2SPacket.InteractTypeHandler ATTACK = new PlayerInteractEntityC2SPacket.InteractTypeHandler() {
      @Override
   ...
   enum InteractType {
      ...
      InteractType(final Function<PacketByteBuf, PlayerInteractEntityC2SPacket.InteractTypeHandler> handlerGetter) {
