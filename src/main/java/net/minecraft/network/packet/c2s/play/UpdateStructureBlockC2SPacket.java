...
public class UpdateStructureBlockC2SPacket implements Packet<ServerPlayPacketListener> {
   public static final PacketCodec<PacketByteBuf, UpdateStructureBlockC2SPacket> CODEC = Packet.createCodec(
      UpdateStructureBlockC2SPacket::write, UpdateStructureBlockC2SPacket::new
   );
   ...
   private UpdateStructureBlockC2SPacket(PacketByteBuf buf) {
      ...
      this.offset = new BlockPos(
         MathHelper.clamp(buf.readByte(), -48, 48), MathHelper.clamp(buf.readByte(), -48, 48), MathHelper.clamp(buf.readByte(), -48, 48)
      );
      int j = 48;
