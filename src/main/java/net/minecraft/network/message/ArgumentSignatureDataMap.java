...
public record ArgumentSignatureDataMap(List<ArgumentSignatureDataMap.Entry> entries) {
   ...
   public ArgumentSignatureDataMap(PacketByteBuf buf) {
      this(buf.<ArgumentSignatureDataMap.Entry, List<ArgumentSignatureDataMap.Entry>>readCollection(PacketByteBuf.getMaxValidator(ArrayList::new, 8), ArgumentSignatureDataMap.Entry::new));
   }
