...
public abstract class AbstractTeam {
   ...
   public enum CollisionRule {
      ...
      private static final Map<String, AbstractTeam.CollisionRule> COLLISION_RULES = Arrays.stream(values())
         .collect(Collectors.toMap(collisionRule -> collisionRule.name, collisionRule -> (AbstractTeam.CollisionRule)collisionRule));
      ...
      CollisionRule(final String name, final int value) {
         this.name = name;
         this.value = value;
      }
   ...
   public enum VisibilityRule {
      ...
      private static final Map<String, AbstractTeam.VisibilityRule> VISIBILITY_RULES = Arrays.stream(values())
         .collect(Collectors.toMap(visibilityRule -> visibilityRule.name, visibilityRule -> (AbstractTeam.VisibilityRule)visibilityRule));
      public final String name;
      public final int value;
      ...
      VisibilityRule(final String name, final int value) {
         this.name = name;
         this.value = value;
      }
