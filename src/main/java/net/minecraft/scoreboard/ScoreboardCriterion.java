...
public class ScoreboardCriterion {
   ...
   public static ScoreboardCriterion create(String name, boolean readOnly, ScoreboardCriterion.RenderType defaultRenderType) {
   ...
   public static Optional<ScoreboardCriterion> getOrCreateStatCriterion(String name) {
      ...
      return i < 0
         ...
         : Registries.STAT_TYPE
            ...
            .flatMap(type -> getOrCreateStatCriterion((StatType<?>)type, Identifier.splitOn(name.substring(i + 1), '.')));
   }
