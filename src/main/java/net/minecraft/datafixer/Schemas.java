...
public class Schemas {
   ...
   private static void build(DataFixerBuilder builder) {
      ...
      builder.addFixer(new WriteAndReadFix(schema121, "add types to WorldGenData", TypeReferences.WORLD_GEN_SETTINGS));
      Schema schema122 = builder.addSchema(2552, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         new GameEventRenamesFix(schema122, "Nether biome rename", TypeReferences.BIOME, replacing("minecraft:nether", "minecraft:nether_wastes"))
      );
      Schema schema123 = builder.addSchema(2553, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GameEventRenamesFix(schema123, "Biomes fix", TypeReferences.BIOME, replacing(FlatteningBiomeMapping.RENAMED_BIOMES)));
      ...
      builder.addFixer(new AddFlagIfNotPresentFix(schema140, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
      ...
      builder.addFixer(new AddFlagIfNotPresentFix(schema143, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      ...
      builder.addFixer(new GameEventRenamesFix(schema147, "Caves and Cliffs biome renames", TypeReferences.BIOME, replacing(LegacyBiomeMapping.MAP)));
      ...
      builder.addFixer(new TicksInWrongChunkFix(schema150));
      builder.addFixer(
         new GameEventRenamesFix(schema150, "Remove Deep Warm Ocean", TypeReferences.BIOME, replacing("minecraft:deep_warm_ocean", "minecraft:warm_ocean"))
      );
      ...
      Schema schema153 = builder.addSchema(2967, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StructureSettingsFlattenFix(schema153));
      Schema schema154 = builder.addSchema(2970, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StructuresToConfiguredStructuresFix(schema154));
      Schema schema155 = builder.addSchema(3076, Schema3076::new);
      builder.addFixer(new ChoiceTypesFix(schema155, "Added Sculk Catalyst", TypeReferences.BLOCK_ENTITY));
      Schema schema156 = builder.addSchema(3077, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ChunkDeleteIgnoredLightDataFix(schema156));
      Schema schema157 = builder.addSchema(3078, Schema3078::new);
      builder.addFixer(new ChoiceTypesFix(schema157, "Added Frog", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema157, "Added Tadpole", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema157, "Added Sculk Shrieker", TypeReferences.BLOCK_ENTITY));
      Schema schema158 = builder.addSchema(3081, Schema3081::new);
      builder.addFixer(new ChoiceTypesFix(schema158, "Added Warden", TypeReferences.ENTITY));
      Schema schema159 = builder.addSchema(3082, Schema3082::new);
      builder.addFixer(new ChoiceTypesFix(schema159, "Added Chest Boat", TypeReferences.ENTITY));
      Schema schema160 = builder.addSchema(3083, Schema3083::new);
      builder.addFixer(new ChoiceTypesFix(schema160, "Added Allay", TypeReferences.ENTITY));
      Schema schema161 = builder.addSchema(3084, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
      ...
      Schema schema162 = builder.addSchema(3086, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         new EntityVariantTypeFix(
            schema162, "Change cat variant type", TypeReferences.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap<String>(), catVariants -> {
      ...
      builder.addFixer(
         new AdvancementCriteriaRenameFix(
            ...
            string -> (String)immutableMap4.getOrDefault(string, string)
         )
      );
      Schema schema163 = builder.addSchema(3087, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         new EntityVariantTypeFix(
            schema163, "Change frog variant type", TypeReferences.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), frogVariants -> {
      ...
      builder.addFixer(
         new RenameEntityNbtKeyFix(schema164, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing"))
      );
      ...
      builder.addFixer(
         new AdvancementCriteriaRenameFix(
            ...
            "minecraft:husbandry/complete_catalogue",
            string -> map.getOrDefault(string, string)
         )
      );
      builder.addFixer(
      ...
      Schema schema181 = builder.addSchema(3438, Schema3438::new);
      builder.addFixer(
         RenameBlockEntityFix.create(
            schema181, "Rename Suspicious Sand to Brushable Block", replacing("minecraft:suspicious_sand", "minecraft:brushable_block")
         )
      );
      ...
      builder.addFixer(new ChoiceTypesFix(schema181, "Added calibrated sculk sensor", TypeReferences.BLOCK_ENTITY));
      Schema schema182 = builder.addSchema(3439, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new UpdateSignTextFormatFix(schema182, "Updated sign text format for Signs", "minecraft:sign"));
      builder.addFixer(new UpdateSignTextFormatFix(schema182, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema schema183 = builder.addSchema(3440, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         new GameEventRenamesFix(
            schema183,
      ...
      builder.addFixer(new RemoveFeatureTogglesFix(schema183, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      ...
      Schema schema193 = builder.addSchema(3682, Schema3682::new);
      builder.addFixer(new ChoiceTypesFix(schema193, "Added Crafter", TypeReferences.BLOCK_ENTITY));
      Schema schema194 = builder.addSchema(3683, Schema3683::new);
      builder.addFixer(new PrimedTntBlockStateFix(schema194));
      Schema schema195 = builder.addSchema(3685, Schema3685::new);
      builder.addFixer(new ProjectileItemTypeFix(schema195));
      Schema schema196 = builder.addSchema(3689, Schema3689::new);
      builder.addFixer(new ChoiceTypesFix(schema196, "Added Breeze", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema196, "Added Trial Spawner", TypeReferences.BLOCK_ENTITY));
      Schema schema197 = builder.addSchema(3692, EMPTY_IDENTIFIER_NORMALIZE);
      UnaryOperator<String> unaryOperator2 = replacing(Map.of("minecraft:grass", "minecraft:short_grass"));
      builder.addFixer(BlockNameFix.create(schema197, "Rename grass block to short_grass", unaryOperator2));
      builder.addFixer(ItemNameFix.create(schema197, "Rename grass item to short_grass", unaryOperator2));
      Schema schema198 = builder.addSchema(3799, Schema3799::new);
      builder.addFixer(new ChoiceTypesFix(schema198, "Added Armadillo", TypeReferences.ENTITY));
      Schema schema199 = builder.addSchema(3800, EMPTY_IDENTIFIER_NORMALIZE);
      UnaryOperator<String> unaryOperator3 = replacing(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      builder.addFixer(ItemNameFix.create(schema199, "Rename scute item to turtle_scute", unaryOperator3));
      Schema schema200 = builder.addSchema(3803, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameEnchantmentFix(schema200, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
      Schema schema201 = builder.addSchema(3807, Schema3807::new);
      builder.addFixer(new ChoiceTypesFix(schema201, "Added Vault", TypeReferences.BLOCK_ENTITY));
      Schema schema202 = builder.addSchema(3807, 1, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new MapBannerBlockPosFormatFix(schema202));
      Schema schema203 = builder.addSchema(3808, Schema3808::new);
      builder.addFixer(new HorseArmorFix(schema203, "minecraft:horse", "ArmorItem", true));
      Schema schema204 = builder.addSchema(3808, 1, Schema3808_1::new);
      builder.addFixer(new HorseArmorFix(schema204, "minecraft:llama", "DecorItem", false));
      Schema schema205 = builder.addSchema(3808, 2, Schema3808_2::new);
      builder.addFixer(new HorseArmorFix(schema205, "minecraft:trader_llama", "DecorItem", false));
      ...
      Schema schema214 = builder.addSchema(3818, 3, Schema3818_3::new);
      builder.addFixer(new WriteAndReadFix(schema214, "Inject data component types", TypeReferences.DATA_COMPONENTS));
      Schema schema215 = builder.addSchema(3818, 4, Schema3818_4::new);
      builder.addFixer(new ParticleUnflatteningFix(schema215));
      Schema schema216 = builder.addSchema(3818, 5, Schema3818_5::new);
      builder.addFixer(new ItemStackComponentizationFix(schema216));
      Schema schema217 = builder.addSchema(3818, 6, EMPTY_IDENTIFIER_NORMALIZE);
      ...
      Schema schema219 = builder.addSchema(3825, Schema3825::new);
      builder.addFixer(new ItemStackCustomNameToItemNameFix(schema219));
      builder.addFixer(new BannerCustomNameToItemNameFix(schema219));
      builder.addFixer(new TrialSpawnerConfigTagFix(schema219));
      ...
      Schema schema222 = builder.addSchema(3938, Schema3938::new);
      builder.addFixer(new ArrowStoredWeaponFix(schema222));
      Schema schema223 = builder.addSchema(3939, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFeatureTogglesFix(schema223, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
      Schema schema224 = builder.addSchema(3943, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OptionsMenuBlurrinessFix(schema224));
      Schema schema225 = builder.addSchema(3945, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AttributeIdFix(schema225));
      builder.addFixer(new JukeboxTicksSinceSongStartedFix(schema225));
      Schema schema226 = builder.addSchema(4054, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OminousBannerRarityFix(schema226));
      Schema schema227 = builder.addSchema(4055, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AttributeIdPrefixFix(schema227));
      Schema schema228 = builder.addSchema(4057, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new CarvingStepRemoveFix(schema228));
      Schema schema229 = builder.addSchema(4059, Schema4059::new);
      builder.addFixer(new FoodToConsumableFix(schema229));
      Schema schema230 = builder.addSchema(4061, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new TrialSpawnerConfigInRegistryFix(schema230));
      Schema schema231 = builder.addSchema(4064, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new FireResistantToDamageResistantComponentFix(schema231));
      Schema schema232 = builder.addSchema(4067, Schema4067::new);
      builder.addFixer(new BoatSplitFix(schema232));
      builder.addFixer(new RemoveFeatureTogglesFix(schema232, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
      Schema schema233 = builder.addSchema(4068, EMPTY_IDENTIFIER_NORMALIZE);
      ...
      Schema schema234 = builder.addSchema(4070, Schema4070::new);
      builder.addFixer(new ChoiceTypesFix(schema234, "Added Pale Oak Boat and Pale Oak Chest Boat", TypeReferences.ENTITY));
      Schema schema235 = builder.addSchema(4071, Schema4071::new);
      builder.addFixer(new ChoiceTypesFix(schema235, "Added Creaking", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema235, "Added Creaking Heart", TypeReferences.BLOCK_ENTITY));
      Schema schema236 = builder.addSchema(4081, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EntitySalmonSizeFix(schema236));
      Schema schema237 = builder.addSchema(4173, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameEntityNbtKeyFix(schema237, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
      Schema schema238 = builder.addSchema(4175, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EquippableAssetRenameFix(schema238));
      builder.addFixer(new CustomModelDataExpansionFix(schema238));
      Schema schema239 = builder.addSchema(4176, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BlockEntityLockToComponentFix(schema239));
      builder.addFixer(new InvalidLockComponentPredicateFix(schema239));
      Schema schema240 = builder.addSchema(4180, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFeatureTogglesFix(schema240, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
      Schema schema241 = builder.addSchema(4181, EMPTY_IDENTIFIER_NORMALIZE);
      ...
      Schema schema242 = builder.addSchema(4185, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BlendingDataFix(schema242));
      Schema schema243 = builder.addSchema(4187, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         new EntityAttributeBaseFix(
            schema243,
            "Villager follow range fix undo",
            "minecraft:villager",
            "minecraft:follow_range",
            followRange -> followRange == 48.0 ? 16.0 : followRange
         )
      );
      builder.addFixer(
         new EntityAttributeBaseFix(
      ...
      builder.addFixer(
         new EntityAttributeBaseFix(
            ...
            "minecraft:follow_range",
            followRange -> followRange == 16.0 ? 12.0 : followRange
         )
      );
      builder.addFixer(
         new EntityAttributeBaseFix(
