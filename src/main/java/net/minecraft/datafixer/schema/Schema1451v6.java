               ...
               dynamic2 -> {
                  ...
                  if (optionalx.isPresent() && optional2.isPresent()) {
                     ...
                     return string.equals("_special")
                        ...
                        : Optional.of(dynamic2.createString(Schema1451v6.toDotSeparated(string) + ":" + Schema1451v6.toDotSeparated(optional2.get())));
                  } else {
                     return Optional.empty();
                  }
               }
            );
         return (T)((Dynamic)DataFixUtils.orElse(optional.map(criteriaName -> dynamic.set("CriteriaName", criteriaName).remove("CriteriaType")), dynamic))
            .getValue();
      }
   };
