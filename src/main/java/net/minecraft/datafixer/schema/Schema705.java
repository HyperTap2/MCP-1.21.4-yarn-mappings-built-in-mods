...
public class Schema705 extends IdentifierNormalizingSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
      ...
      schema.register(map, "minecraft:arrow", name -> DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(schema)));
      ...
      schema.register(
         ...
         name -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema), "Items", DSL.list(TypeReferences.ITEM_STACK.in(schema)))
      );
      targetEntityItems(schema, map, "minecraft:chicken");
      schema.register(map, "minecraft:commandblock_minecart", name -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema)));
      ...
      schema.register(map, "minecraft:enderman", name -> DSL.optionalFields("carried", TypeReferences.BLOCK_NAME.in(schema), Schema100.targetItems(schema)));
      ...
      schema.register(
         ...
         name -> DSL.optionalFields("Block", TypeReferences.BLOCK_NAME.in(schema), "TileEntityData", TypeReferences.BLOCK_ENTITY.in(schema))
      );
      ...
      schema.register(map, "minecraft:furnace_minecart", name -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema)));
      ...
      schema.register(map, "minecraft:minecart", name -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema)));
      ...
      schema.register(
         map, "minecraft:potion", name -> DSL.optionalFields("Potion", TypeReferences.ITEM_STACK.in(schema), "inTile", TypeReferences.BLOCK_NAME.in(schema))
      );
      ...
      schema.register(
         ...
         name -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema), TypeReferences.UNTAGGED_SPAWNER.in(schema))
      );
      schema.register(map, "minecraft:spectral_arrow", name -> DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(schema)));
      ...
      schema.register(map, "minecraft:tnt_minecart", name -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema)));
      schema.register(
         map,
         "minecraft:villager",
         name -> DSL.optionalFields(
