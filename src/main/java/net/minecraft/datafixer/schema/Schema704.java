...
public class Schema704 extends Schema {
   protected static final Map<String, String> BLOCK_RENAMES = (Map<String, String>)DataFixUtils.make(() -> {
   ...
   protected static final HookFunction field_5745 = new HookFunction() {
      public <T> T apply(DynamicOps<T> ops, T value) {
         return Schema99.updateBlockEntityTags(new Dynamic<>(ops, value), Schema704.BLOCK_RENAMES, Schema99.field_49718);
      }
   };
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
      ...
      schema.register(
         map, "minecraft:flower_pot", name -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), TypeReferences.ITEM_NAME.in(schema)))
      );
