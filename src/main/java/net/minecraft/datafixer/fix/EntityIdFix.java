...
public class EntityIdFix extends DataFix {
   private static final Map<String, String> RENAMED_ENTITIES = DataFixUtils.make(Maps.newHashMap(), map -> {
...
@SuppressWarnings("unchecked")
      ...
      return TypeRewriteRule.seq(
         ...
         this.fixTypeEverywhere(
            "EntityIdFix", taggedChoiceType, taggedChoiceType2, dynamicOps -> pair -> pair.mapFirst(string -> RENAMED_ENTITIES.getOrDefault(string, string))
         )
      );
   }
}
