...
public class ItemRemoveBlockEntityTagFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemRemoveBlockEntityTagFix", type, typed -> {
         ...
         if (optional.isPresent() && this.itemIds.contains(optional.get().getSecond())) {
            ...
            if (optional2.isPresent()) {
               ...
               if (optional3.isPresent()) {
                  ...
                  Dynamic<?> dynamic = (Dynamic<?>)(optional4.isPresent() ? optional4.get() : (Dynamic)typed2.get(DSL.remainderFinder()));
                  ...
                  return typed.set(opticFinder2, (Typed)optional5.get().getFirst());
               }
            }
         }
