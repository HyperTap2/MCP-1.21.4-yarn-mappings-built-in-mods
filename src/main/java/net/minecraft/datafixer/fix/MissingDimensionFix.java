...
public class MissingDimensionFix extends DataFix {
      ...
      Type<?> type = DSL.taggedChoiceType(
         ...
         ImmutableMap.of(
            ...
            extract2Opt(
               ...
               DSL.or(
                  DSL.string(),
                  extract2Opt("default_block", schema.getType(TypeReferences.BLOCK_NAME), "default_fluid", schema.getType(TypeReferences.BLOCK_NAME))
               )
            )
         )
      );
   ...
   protected static Type<? extends Pair<? extends Either<? extends Pair<? extends Either<?, Unit>, ? extends Pair<? extends Either<? extends List<? extends Pair<? extends Either<?, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>> flatGeneratorType(
      ...
      return extract1Opt(
         "settings",
         extract2Opt("biome", schema.getType(TypeReferences.BIOME), "layers", DSL.list(extract1Opt("block", schema.getType(TypeReferences.BLOCK_NAME))))
      );
   }
