...
public class ItemSpawnEggFix extends DataFix {
   private static final String[] DAMAGE_TO_ENTITY_IDS = (String[])DataFixUtils.make(new String[256], ids -> {
      ids[1] = "Item";
      ids[2] = "XPOrb";
      ids[7] = "ThrownEgg";
      ids[8] = "LeashKnot";
      ...
      return this.fixTypeEverywhereTyped("ItemSpawnEggFix", type, itemStack -> {
         ...
         if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:spawn_egg")) {
            ...
            if (string != null && (optional5.isEmpty() || !Objects.equals(optional5.get(), string))) {
               ...
               Typed<?> typed5 = Util.apply(typed4, type2, dynamic2x -> dynamic2x.set("id", dynamic2.createString(string)));
               typed = typed.set(opticFinder3, typed2.set(opticFinder4, typed3.set(opticFinder5, typed5)));
            }
