...
public class ItemInstanceTheFlatteningFix extends DataFix {
   private static final Map<String, String> FLATTENING_MAP = DataFixUtils.make(Maps.newHashMap(), map -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, itemStackTyped -> {
         ...
         if (string != null) {
            typed = typed.set(opticFinder, Pair.of(TypeReferences.ITEM_NAME.typeName(), string));
         }
