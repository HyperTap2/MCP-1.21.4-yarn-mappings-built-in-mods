...
public class EntityTheRenameningBlockFix extends EntityRenameFix {
   public static final Map<String, String> ENTITIES = ImmutableMap.<String, String>builder()
      ...
      .build();
   public static final Map<String, String> BLOCKS = ImmutableMap.<String, String>builder()
   ...
   public static final Map<String, String> ITEMS = ImmutableMap.<String, String>builder()
      ...
      .build();
   private static final String BRED_PREFIX = "minecraft:bred_";

   public EntityTheRenameningBlockFix(Schema outputSchema, boolean changesType) {
