...
public class BlockEntityIdFix extends DataFix {
   private static final Map<String, String> RENAMED_BLOCK_ENTITIES = DataFixUtils.make(Maps.newHashMap(), map -> {
...
@SuppressWarnings("unchecked")
      ...
      return TypeRewriteRule.seq(
         ...
         this.fixTypeEverywhere(
            ...
            taggedChoiceType,
            taggedChoiceType2,
            dynamicOps -> pair -> pair.mapFirst(oldName -> RENAMED_BLOCK_ENTITIES.getOrDefault(oldName, oldName))
         )
      );
   }
}
