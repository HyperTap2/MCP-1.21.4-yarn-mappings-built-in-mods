...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap<String> NUMERICAL_ID_TO_STRING_ID_MAP = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), map -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         itemStackTyped -> itemStackTyped.update(
            opticFinder, type2, id -> (Pair)id.map(ordinal -> Pair.of(TypeReferences.ITEM_NAME.typeName(), fromId(ordinal)), named -> named)
         )
      );
   }
}
