      ...
      return this.fixTypeEverywhereTyped(
         ...
         objectiveTyped -> objectiveTyped.updateTyped(
            ...
            criteriaTypeTyped -> criteriaTypeTyped.updateTyped(
               opticFinder2, customCriteriaTypeTyped -> customCriteriaTypeTyped.update(opticFinder3, old -> this.replacements.getOrDefault(old, old))
            )
         )
      );
   }
      ...
      return this.fixTypeEverywhereTyped(
         ...
         statsTyped -> statsTyped.updateTyped(
            ...
            statsInnerTyped -> statsInnerTyped.updateTyped(
               opticFinder2, customStatTyped -> customStatTyped.update(opticFinder3, old -> this.replacements.getOrDefault(old, old))
            )
         )
      );
   }
