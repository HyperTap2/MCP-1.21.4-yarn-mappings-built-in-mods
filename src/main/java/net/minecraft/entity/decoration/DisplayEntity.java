...
public abstract class DisplayEntity extends Entity {
   ...
   public void updateTrackedPositionAndAngles(double x, double y, double z, float yaw, float pitch, int interpolationSteps) {
      ...
      this.interpolationTarget = new DisplayEntity.InterpolationTarget(i, x, y, z, yaw, pitch);
   }
   ...
   public float getLerpProgress(float delta) {
      ...
      float g = f + delta;
      float h = MathHelper.clamp(MathHelper.getLerpProgress(g, 0.0F, i), 0.0F, 1.0F);
      this.lerpProgress = h;
      return h;
   }
   ...
   public static class ItemDisplayEntity extends DisplayEntity {
      ...
      public final void setTransformationMode(ModelTransformationMode transformationMode) {
         this.dataTracker.set(ITEM_DISPLAY, transformationMode.getIndex());
      }

      public final ModelTransformationMode getTransformationMode() {
         return ModelTransformationMode.FROM_INDEX.apply(this.dataTracker.get(ITEM_DISPLAY));
      }
   ...
   public static class TextDisplayEntity extends DisplayEntity {
      ...
      protected void readCustomDataFromNbt(NbtCompound nbt) {
         ...
         if (nbt.contains("text", 8)) {
            ...
            try {
               ...
               DisplayEntity.LOGGER.warn("Failed to parse display entity text {}", string, exception);
            }
         }
      }
      ...
      protected void writeCustomDataToNbt(NbtCompound nbt) {
         ...
         DisplayEntity.TextDisplayEntity.TextAlignment.CODEC
            ...
            .ifSuccess(nbtElement -> nbt.put("alignment", nbtElement));
      }
      ...
      public void languageReload$invalidateTextLines() {
         this.textLines = null;
      }
