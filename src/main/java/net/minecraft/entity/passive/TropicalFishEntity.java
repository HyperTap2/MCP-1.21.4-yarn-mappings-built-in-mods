...
public class TropicalFishEntity extends SchoolingFishEntity implements VariantHolder<TropicalFishEntity.Variety> {
   ...
   public record Variant(TropicalFishEntity.Variety variety, DyeColor baseColor, DyeColor patternColor) {
   ...
   public enum Variety implements StringIdentifiable {
      ...
      Variety(final String name, final TropicalFishEntity.Size size, final int id) {
         this.name = name;
         this.size = size;
