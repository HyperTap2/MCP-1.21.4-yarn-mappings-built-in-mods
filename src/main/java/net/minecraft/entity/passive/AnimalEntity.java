...
public abstract class AnimalEntity extends PassiveEntity {
   ...
   public ActionResult interactMob(PlayerEntity player, Hand hand) {
      ...
      boolean isClientForInteraction = this.getWorld().isClient && targetVersion.newerThanOrEqualTo(ProtocolVersion.v1_15);
      if (this.isBreedingItem(itemStack)) {
         int i = this.getBreedingAge();
         if (!isClientForInteraction && i == 0 && this.canEat()) {
            this.eat(player, hand, itemStack);
            this.lovePlayer(player);
            this.playEatSound();
            return targetVersion.olderThanOrEqualTo(ProtocolVersion.v1_21) ? ActionResult.SUCCESS : ActionResult.SUCCESS_SERVER;
         }
