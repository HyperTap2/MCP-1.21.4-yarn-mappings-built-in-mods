...
public class TurtleEntity extends AnimalEntity {
      ...
      public void tick() {
         ...
         if (!this.turtle.isTouchingWater() && this.hasReached()) {
            if (this.turtle.sandDiggingCounter < 1) {
               ...
               world.playSound(
                  (PlayerEntity)null, blockPos, SoundEvents.ENTITY_TURTLE_LAY_EGG, SoundCategory.BLOCKS, 0.3F, 0.9F + world.random.nextFloat() * 0.2F
               );
   ...
   static class TravelGoal extends Goal {
      ...
      public void start() {
         ...
         BlockPos blockPos = BlockPos.ofFloored(k + this.turtle.getX(), l + this.turtle.getY(), m + this.turtle.getZ());
   ...
   static class TurtleSwimNavigation extends AmphibiousSwimNavigation {
      ...
      public boolean isValidPosition(BlockPos pos) {
         return this.entity instanceof TurtleEntity turtleEntity && turtleEntity.isActivelyTraveling()
