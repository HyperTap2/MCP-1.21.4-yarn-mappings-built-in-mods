      ...
      brain.setTaskList(
         ...
         ImmutableList.of(
            ...
            Pair.of(
               3,
               new RandomTask(
                  ImmutableList.of(Pair.of(StrollTask.create(1.0F), 2), Pair.of(GoToLookTargetTask.create(1.0F, 3), 2), Pair.of(new WaitTask(30, 60), 1))
               )
            )
         ),
         ImmutableSet.of(
         ...
         ImmutableList.of(
            ...
            Pair.of(
               ...
               new LongJumpTask<>(
                  ...
                  5,
                  3.5714288F,
                  goat -> goat.isScreaming() ? SoundEvents.ENTITY_GOAT_SCREAMING_LONG_JUMP : SoundEvents.ENTITY_GOAT_LONG_JUMP
               )
            )
         ),
         ImmutableSet.of(
