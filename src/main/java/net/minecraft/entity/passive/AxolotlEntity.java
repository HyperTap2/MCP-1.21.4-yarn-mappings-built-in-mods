...
public class AxolotlEntity extends AnimalEntity implements VariantHolder<AxolotlEntity.Variant>, Bucketable {
   ...
   public enum Variant implements StringIdentifiable {
      ...
      Variant(final int id, final String name, final boolean natural) {
         this.id = id;
         this.name = name;
      ...
      private static AxolotlEntity.Variant getRandom(Random random, boolean natural) {
         AxolotlEntity.Variant[] variants = Arrays.stream(values()).filter(variant -> variant.natural == natural).toArray(AxolotlEntity.Variant[]::new);
