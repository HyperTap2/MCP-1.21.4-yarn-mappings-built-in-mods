...
public class ArmadilloBrain {
   ...
   private static void addCoreActivities(Brain<ArmadilloEntity> brain) {
      brain.setTaskList(
         Activity.CORE,
         0,
         (ImmutableList)ImmutableList.of(new StayAboveWaterTask(0.8F), new ArmadilloBrain.UnrollAndFleeTask(2.0F), new UpdateLookControlTask(45, 90), new MoveToTargetTask() {
            @Override
