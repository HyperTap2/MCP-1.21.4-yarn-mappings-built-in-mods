...
public class BeeEntity extends AnimalEntity implements Angerable, Flutterer {
   ...
   protected void initGoals() {
      ...
      this.targetSelector.add(1, new BeeEntity.BeeRevengeGoal(this).setGroupRevenge());
   ...
   BeehiveBlockEntity getHive() {
      if (this.hivePos == null) {
         ...
         return this.isTooFar(this.hivePos) ? null : this.getWorld().getBlockEntity(this.hivePos, BlockEntityType.BEEHIVE).orElse(null);
      }
   }
