...
public class SheepEntity extends AnimalEntity implements Shearable {
   ...
   private static final Map<DyeColor, Integer> COLORS = Arrays.stream(DyeColor.values())
      .collect(Collectors.toMap(color -> color, SheepEntity::getDyedColor, (a, b) -> a, () -> new java.util.EnumMap<>(DyeColor.class)));
   ...
   private static int getDyedColor(DyeColor color) {
      ...
      return ColorHelper.getArgb(
         255,
         MathHelper.floor(ColorHelper.getRed(i) * 0.75F),
         MathHelper.floor(ColorHelper.getGreen(i) * 0.75F),
         MathHelper.floor(ColorHelper.getBlue(i) * 0.75F)
      );
   }
