...
public class PigEntity extends AnimalEntity implements ItemSteerable, Saddleable {
   ...
   public LivingEntity getControllingPassenger() {
      return this.isSaddled() && this.getFirstPassenger() instanceof PlayerEntity playerEntity && playerEntity.isHolding(Items.CARROT_ON_A_STICK)
         ? playerEntity
   ...
   public PigEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
      return EntityType.PIG.create(serverWorld, SpawnReason.BREEDING);
   }
