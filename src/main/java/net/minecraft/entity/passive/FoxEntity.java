...
public class FoxEntity extends AnimalEntity implements VariantHolder<FoxEntity.Type> {
      ...
      this.goalSelector
         .add(
            ...
            new FleeEntityGoal<>(
               ...
               1.6,
               1.4,
               entity -> NOTICEABLE_PLAYER_FILTER.test(entity) && !this.canTrust(entity.getUuid()) && !this.isAggressive()
            )
         );
   ...
   public class EatBerriesGoal extends MoveToTargetPosGoal {
      ...
      private void pickSweetBerries(BlockState state) {
         ...
         FoxEntity.this.getWorld().setBlockState(this.targetPos, state.with(SweetBerryBushBlock.AGE, 1), 2);
   ...
   public enum Type implements StringIdentifiable {
      ...
      Type(final int id, final String key) {
         this.id = id;
         this.key = key;
      }
