...
public class GoatEntity extends AnimalEntity {
   ...
   public ItemStack getGoatHornStack() {
      ...
      return this.getWorld()
         ...
         .map(registryEntry -> GoatHornItem.getStackForInstrument(Items.GOAT_HORN, (RegistryEntry<Instrument>)registryEntry))
   ...
   public GoatEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
      ...
      if (goatEntity != null) {
         ...
         boolean bl = (serverWorld.getRandom().nextBoolean() ? this : passiveEntity) instanceof GoatEntity goatEntity2 && goatEntity2.isScreaming()
   ...
   public void setHeadYaw(float headYaw) {
      ...
      float g = MathHelper.clamp(f, -i, i);
