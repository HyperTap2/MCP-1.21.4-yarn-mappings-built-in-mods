...
public enum EquipmentSlot implements StringIdentifiable {
   ...
   public static final IntFunction<EquipmentSlot> FROM_INDEX = ValueLists.<EquipmentSlot>createIdToValueFunction(
   ...
   EquipmentSlot(final EquipmentSlot.Type type, final int entityId, final int maxCount, final int index, final String name) {
      this.type = type;
   ...
   EquipmentSlot(final EquipmentSlot.Type type, final int entityId, final int index, final String name) {
