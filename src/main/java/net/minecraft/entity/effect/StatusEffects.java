...
public class StatusEffects {
   ...
   public static final RegistryEntry<StatusEffect> SPEED = register(
      ...
      new StatusEffect(StatusEffectCategory.BENEFICIAL, 3402751)
         .addAttributeModifier(
            EntityAttributes.MOVEMENT_SPEED, Identifier.ofVanilla("effect.speed"), 0.2F, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL
         )
   );
   ...
   public static final RegistryEntry<StatusEffect> HASTE = register(
      ...
      new StatusEffect(StatusEffectCategory.BENEFICIAL, 14270531)
         .addAttributeModifier(
            EntityAttributes.ATTACK_SPEED, Identifier.ofVanilla("effect.haste"), 0.1F, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL
         )
   );
