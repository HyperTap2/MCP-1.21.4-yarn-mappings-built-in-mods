            ...
            .apply(
               ...
               queryResult -> (world, entity, time) -> {
                  ...
                  Predicate<BlockPos> predicate2 = pos -> {
                     FindPointOfInterestTask.RetryMarker retryMarker = (FindPointOfInterestTask.RetryMarker)long2ObjectMap.get(pos.asLong());
                     if (retryMarker == null) {
                        return true;
                     }
                  ...
                  Set<Pair<RegistryEntry<PointOfInterestType>, BlockPos>> set = pointOfInterestStorage.getSortedTypesAndPositions(
                  ...
                  if (path != null && path.reachesTarget()) {
                     ...
                     for (Pair<RegistryEntry<PointOfInterestType>, BlockPos> pair : set) {
                        long2ObjectMap.computeIfAbsent(((BlockPos)pair.getSecond()).asLong(), m -> new FindPointOfInterestTask.RetryMarker(world.random, time));
                     }
                  }
