...
public abstract class Sensor<E extends LivingEntity> {
   ...
   public final long lithium$getLastSenseTime() {
      return this.lastSenseTime;
   }

   public final int lithium$getSenseInterval() {
      return this.senseInterval;
   }

   public final void lithium$setLastSenseTime(long lastSenseTime) {
      this.lastSenseTime = lastSenseTime;
   }
