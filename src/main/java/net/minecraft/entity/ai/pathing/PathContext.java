...
public class PathContext {
   ...
   public PathContext(CollisionView world, MobEntity entity) {
      this.world = world;
      if (entity != null && entity.getWorld() instanceof ServerWorld serverWorld) {
         this.nodeTypeCache = serverWorld.getPathNodeTypeCache();
      } else {
         this.nodeTypeCache = null;
      }

      this.entityPos = entity == null ? null : entity.getBlockPos();
   }
   ...
   public BlockPos.Mutable lithium$getLastNodePos() {
