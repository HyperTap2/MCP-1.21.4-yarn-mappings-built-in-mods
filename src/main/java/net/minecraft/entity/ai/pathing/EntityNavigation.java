...
public abstract class EntityNavigation {
   ...
   public void recalculatePath() {
      ...
      this.lithium$updateRegistration();
   }
   ...
   protected Path findPathToAny(Set<BlockPos> positions, int range, boolean useHeadPos, int distance, float followRange) {
      ...
      if (this.entity.getY() < this.world.getBottomY()) {
         return null;
      }
   ...
   private void lithium$updateRegistration() {
      NavigatingEntity navigating = (NavigatingEntity)this.entity;
      if (this.world instanceof ServerWorldExtended world && navigating.lithium$isRegisteredToWorld()) {
         if (this.currentPath == null) {
            world.lithium$setNavigationInactive(this.entity);
         } else {
            world.lithium$setNavigationActive(this.entity);
         }
      }
   }
