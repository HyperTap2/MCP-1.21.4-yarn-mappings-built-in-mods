...
public class AttributeContainer {
   ...
   private final Set<EntityAttributeInstance> tracked = new ReferenceOpenHashSet<>();
   private final Set<EntityAttributeInstance> pendingUpdate = new ReferenceOpenHashSet<>();
