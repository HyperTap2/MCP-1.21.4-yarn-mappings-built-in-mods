...
public class EntityType<T extends Entity> implements ToggleableFeature, TypeFilter<Entity, T> {
   ...
   public static final EntityType<HoglinEntity> HOGLIN = register(
      "hoglin",
      EntityType.Builder.create(HoglinEntity::new, SpawnGroup.MONSTER).dimensions(1.3964844F, 1.4F).passengerAttachments(1.49375F).maxTrackingRange(8)
   );
   ...
   public static final EntityType<OminousItemSpawnerEntity> OMINOUS_ITEM_SPAWNER = register(
      ...
      EntityType.Builder.create(OminousItemSpawnerEntity::new, SpawnGroup.MISC).dropsNothing().dimensions(0.25F, 0.25F).maxTrackingRange(8)
   );
   ...
   public static final EntityType<SlimeEntity> SLIME = register(
      "slime",
      EntityType.Builder.create(SlimeEntity::new, SpawnGroup.MONSTER).dimensions(0.52F, 0.52F).eyeHeight(0.325F).spawnBoxScale(4.0F).maxTrackingRange(10)
   );
   ...
   public static final EntityType<WanderingTraderEntity> WANDERING_TRADER = register(
      "wandering_trader",
      EntityType.Builder.create(WanderingTraderEntity::new, SpawnGroup.CREATURE).dimensions(0.6F, 1.95F).eyeHeight(1.62F).maxTrackingRange(10)
   );
   ...
   public static <T extends Entity> Consumer<T> copier(World world, ItemStack stack, @Nullable PlayerEntity player) {
      return copier(entity -> {}, world, stack, player);
   }
   ...
   public static Optional<EntityType<?>> fromNbt(NbtCompound nbt) {
      return Registries.ENTITY_TYPE.getOptionalValue(Identifier.of(nbt.getString("id")));
   }
   ...
   public static Entity loadEntityWithPassengers(NbtCompound nbt, World world, SpawnReason reason, Function<Entity, Entity> entityProcessor) {
      return loadEntityFromNbt(nbt, world, reason).map(entityProcessor).map(entity -> {
   ...
   public static class Builder<T extends Entity> {
      ...
      private RegistryKeyedValue<EntityType<?>, String> translationKey = registryKey -> Util.createTranslationKey("entity", registryKey.getValue());
