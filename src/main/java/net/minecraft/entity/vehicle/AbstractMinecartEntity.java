...
public abstract class AbstractMinecartEntity extends VehicleEntity {
   ...
   public Vec3d updatePassengerForDismount(LivingEntity passenger) {
         ...
         while (g.hasNext()) {
            ...
            for (int[] js : is) {
               ...
               double d = this.getWorld()
                  .getDismountHeight(
                     Dismounting.getCollisionShape(this.getWorld(), mutable), () -> Dismounting.getCollisionShape(this.getWorld(), mutable.down())
                  );
      ...
      mutable.set(blockPos.getX(), ex, blockPos.getZ());
