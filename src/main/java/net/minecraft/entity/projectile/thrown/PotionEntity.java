         ...
         if (potionContentsComponent.matches(Potions.WATER)) {
            ...
            if (this.isLingering()) {
               ...
               this.applySplashPotion(
                  serverWorld,
                  potionContentsComponent.getEffects(),
                  hitResult.getType() == HitResult.Type.ENTITY ? ((EntityHitResult)hitResult).getEntity() : null
               );
            }
         }
               ...
               if (d < 16.0) {
                  ...
                  for (StatusEffectInstance statusEffectInstance : effects) {
                     ...
                     if (registryEntry.value().isInstant()) {
                        ...
                        int i = statusEffectInstance.mapDuration(duration -> (int)(e * duration + 0.5));
