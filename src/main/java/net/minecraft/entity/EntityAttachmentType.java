...
public enum EntityAttachmentType {
   ...
   EntityAttachmentType(final EntityAttachmentType.Point point) {
      this.point = point;
   }
   ...
   public interface Point {
      ...
      EntityAttachmentType.Point AT_HEIGHT = (width, height) -> List.of(new Vec3d(0.0, height, 0.0));
      EntityAttachmentType.Point WARDEN_CHEST = (width, height) -> List.of(new Vec3d(0.0, height / 2.0, 0.0));
