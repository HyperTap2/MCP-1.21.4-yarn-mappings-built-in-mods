   ...
   public NbtList writeNbt(NbtList nbtList) {
      ...
      for (int i = 0; i < this.armor.size(); i++) {
         if (!this.armor.get(i).isEmpty()) {
            ...
            nbtList.add(this.armor.get(i).toNbt(this.player.getRegistryManager(), nbtCompound));
         }
      }
      ...
      for (int i = 0; i < this.offHand.size(); i++) {
         if (!this.offHand.get(i).isEmpty()) {
            ...
            nbtList.add(this.offHand.get(i).toNbt(this.player.getRegistryManager(), nbtCompound));
         }
      }
