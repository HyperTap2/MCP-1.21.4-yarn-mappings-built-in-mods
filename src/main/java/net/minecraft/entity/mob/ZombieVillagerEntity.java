...
public class ZombieVillagerEntity extends ZombieEntity implements VillagerDataContainer {
   ...
   public ZombieVillagerEntity(EntityType<? extends ZombieVillagerEntity> entityType, World world) {
      ...
      Registries.VILLAGER_PROFESSION
         ...
         .ifPresent(profession -> this.setVillagerData(this.getVillagerData().withProfession(profession.value())));
   }
   ...
   public void writeCustomDataToNbt(NbtCompound nbt) {
      ...
      if (this.offerData != null) {
         nbt.put("Offers", (NbtElement)TradeOfferList.CODEC.encodeStart(this.getRegistryManager().getOps(NbtOps.INSTANCE), this.offerData).getOrThrow());
      }
