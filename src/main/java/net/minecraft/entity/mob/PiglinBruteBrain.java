...
public class PiglinBruteBrain {
   ...
   private static void addCoreActivities(PiglinBruteEntity piglinBrute, Brain<PiglinBruteEntity> brain) {
      brain.setTaskList(
         Activity.CORE,
         0,
         ImmutableList.of(new UpdateLookControlTask(45, 90), new MoveToTargetTask(), OpenDoorsTask.create(), ForgetAngryAtTargetTask.create())
      );
   }
   ...
   private static void addIdleActivities(PiglinBruteEntity piglinBrute, Brain<PiglinBruteEntity> brain) {
      brain.setTaskList(
         ...
         10,
         ImmutableList.of(
            UpdateAttackTargetTask.create(PiglinBruteBrain::getTarget),
            getFollowTasks(),
            getIdleTasks(),
