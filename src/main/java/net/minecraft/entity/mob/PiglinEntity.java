...
public class PiglinEntity extends AbstractPiglinEntity implements CrossbowUser, InventoryOwner {
   ...
   private Entity getTopMostPassenger(Entity entity, int maxLevel) {
      ...
      return maxLevel != 1 && !list.isEmpty() ? this.getTopMostPassenger(list.get(0), maxLevel - 1) : entity;
   }

   @Override
   protected SoundEvent getAmbientSound() {
      return this.getWorld().isClient ? null : PiglinBrain.getCurrentActivitySound(this).orElse(null);
   }
