...
public class VindicatorEntity extends IllagerEntity {
   ...
   static final Predicate<Difficulty> DIFFICULTY_ALLOWS_DOOR_BREAKING_PREDICATE = difficulty -> difficulty == Difficulty.NORMAL
   ...
   public void addBonusForWave(ServerWorld world, int wave, boolean unused) {
      ...
      if (bl) {
         ...
         EnchantmentHelper.applyEnchantmentProvider(
            itemStack, world.getRegistryManager(), registryKey, world.getLocalDifficulty(this.getBlockPos()), this.random
         );
      }
