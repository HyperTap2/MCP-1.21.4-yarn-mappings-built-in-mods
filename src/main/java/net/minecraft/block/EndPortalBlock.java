...
public class EndPortalBlock extends BlockWithEntity implements Portal {
   ...
   private static final VoxelShape VIA_SHAPE_1_8 = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 1.0, 16.0);
   private static final VoxelShape VIA_SHAPE_1_16_4 = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 12.0, 16.0);
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      ...
      if (targetVersion.olderThanOrEqualTo(ProtocolVersion.v1_8)) {
         return VIA_SHAPE_1_8;
      } else {
         return targetVersion.olderThanOrEqualTo(ProtocolVersion.v1_16_4) ? VIA_SHAPE_1_16_4 : SHAPE;
      }
   }
   ...
   protected void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
      if (entity.canUsePortals(false)) {
         if (!world.isClient
            ...
            && !serverPlayerEntity.seenCredits) {
