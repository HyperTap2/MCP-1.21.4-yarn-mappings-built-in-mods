...
public class HopperBlock extends BlockWithEntity {
   ...
   private static final VoxelShape VIA_INSIDE_SHAPE_1_12_2 = Block.createCuboidShape(2.0, 10.0, 2.0, 14.0, 16.0, 14.0);
   private static final VoxelShape VIA_HOPPER_SHAPE_1_12_2 = VoxelShapes.combineAndSimplify(
      VoxelShapes.fullCube(), VIA_INSIDE_SHAPE_1_12_2, BooleanBiFunction.ONLY_FIRST
   );
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      if (ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_12_2)) {
         return VIA_HOPPER_SHAPE_1_12_2;
      }
   ...
   protected VoxelShape getRaycastShape(BlockState state, BlockView world, BlockPos pos) {
      if (ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_12_2)) {
         return VIA_INSIDE_SHAPE_1_12_2;
      }
   ...
   protected void neighborUpdate(BlockState state, World world, BlockPos pos, Block sourceBlock, @Nullable WireOrientation wireOrientation, boolean notify) {
      if (!world.isClient && world.getBlockEntity(pos) instanceof UpdateReceiver receiver) {
         receiver.lithium$invalidateCacheOnUndirectedNeighborUpdate();
      }
      this.updateEnabled(world, pos, state);
   }
