...
public class TrialSpawnerConfigs {
   ...
   private static final TrialSpawnerConfigs.ConfigKeyPair SMALL_MELEE_BABY_ZOMBIE = TrialSpawnerConfigs.ConfigKeyPair.of(
      "trial_chamber/small_melee/baby_zombie"
   );
   private static final TrialSpawnerConfigs.ConfigKeyPair SMALL_MELEE_CAVE_SPIDER = TrialSpawnerConfigs.ConfigKeyPair.of(
   ...
   private static void register(
      Registerable<TrialSpawnerConfig> registry,
      TrialSpawnerConfigs.ConfigKeyPair configPair,
