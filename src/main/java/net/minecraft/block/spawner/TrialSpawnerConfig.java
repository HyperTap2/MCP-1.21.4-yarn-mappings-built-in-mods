...
public record TrialSpawnerConfig(
   ...
   public static final Codec<TrialSpawnerConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            ...
            MobSpawnerEntry.DATA_POOL_CODEC.optionalFieldOf("spawn_potentials", DataPool.emptyDataPool()).forGetter(TrialSpawnerConfig::spawnPotentials),
