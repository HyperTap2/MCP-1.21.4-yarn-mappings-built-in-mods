...
public class PistonHeadBlock extends FacingBlock {
   ...
   private static final VoxelShape VIA_UP_ARM_SHAPE_1_8 = Block.createCuboidShape(6.0, 0.0, 6.0, 10.0, 12.0, 10.0);
   private static final VoxelShape VIA_DOWN_ARM_SHAPE_1_8 = Block.createCuboidShape(6.0, 4.0, 6.0, 10.0, 16.0, 10.0);
   private static final VoxelShape VIA_SOUTH_ARM_SHAPE_1_8 = Block.createCuboidShape(4.0, 6.0, 0.0, 12.0, 10.0, 12.0);
   private static final VoxelShape VIA_NORTH_ARM_SHAPE_1_8 = Block.createCuboidShape(4.0, 6.0, 4.0, 12.0, 10.0, 16.0);
   private static final VoxelShape VIA_EAST_ARM_SHAPE_1_8 = Block.createCuboidShape(0.0, 6.0, 4.0, 12.0, 10.0, 12.0);
   private static final VoxelShape VIA_WEST_ARM_SHAPE_1_8 = Block.createCuboidShape(6.0, 4.0, 4.0, 10.0, 12.0, 16.0);
   ...
   private static VoxelShape getViaHeadShape(Direction direction) {
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_12_2)
         ? getViaHeadShape(state.get(FACING))
         : (state.get(SHORT) ? SHORT_HEAD_SHAPES : HEAD_SHAPES)[state.get(FACING).ordinal()];
   }
   ...
   protected VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      ...
      if (targetVersion.olderThanOrEqualTo(ProtocolVersion.v1_8)) {
         VoxelShape armShape = switch (direction) {
            case DOWN -> VIA_DOWN_ARM_SHAPE_1_8;
            case UP -> VIA_UP_ARM_SHAPE_1_8;
            case NORTH -> VIA_NORTH_ARM_SHAPE_1_8;
            case SOUTH -> VIA_SOUTH_ARM_SHAPE_1_8;
            case WEST -> VIA_WEST_ARM_SHAPE_1_8;
            case EAST -> VIA_EAST_ARM_SHAPE_1_8;
         };
         return VoxelShapes.union(getViaHeadShape(direction), armShape);
      } else if (targetVersion.olderThanOrEqualTo(ProtocolVersion.v1_12_2)) {
         return getViaHeadShape(direction);
      } else {
