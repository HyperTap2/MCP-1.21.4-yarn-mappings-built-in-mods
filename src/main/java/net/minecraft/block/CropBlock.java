...
public class CropBlock extends PlantBlock implements Fertilizable {
   ...
   private static final VoxelShape VIA_SHAPE_1_8 = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 4.0, 16.0);
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_8) ? VIA_SHAPE_1_8 : AGE_TO_SHAPE[this.getAge(state)];
   }
