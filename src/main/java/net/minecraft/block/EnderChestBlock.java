...
public class EnderChestBlock extends AbstractChestBlock<EnderChestBlockEntity> implements Waterloggable {
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(LegacyProtocolVersion.r1_4_2) ? VoxelShapes.fullCube() : SHAPE;
   }

   @Override
   protected VoxelShape getCullingShape(BlockState state) {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(LegacyProtocolVersion.r1_4_2) ? SHAPE : super.getCullingShape(state);
   }
