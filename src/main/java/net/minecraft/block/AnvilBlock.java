...
public class AnvilBlock extends FallingBlock {
   ...
   private static final VoxelShape VIA_X_AXIS_SHAPE_1_12_2 = Block.createCuboidShape(0.0, 0.0, 2.0, 16.0, 16.0, 14.0);
   private static final VoxelShape VIA_Z_AXIS_SHAPE_1_12_2 = Block.createCuboidShape(2.0, 0.0, 0.0, 14.0, 16.0, 16.0);
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      ...
      if (ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_12_2)) {
         return direction.getAxis() == Direction.Axis.X ? VIA_X_AXIS_SHAPE_1_12_2 : VIA_Z_AXIS_SHAPE_1_12_2;
      }
