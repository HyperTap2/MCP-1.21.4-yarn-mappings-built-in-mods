...
public class LadderBlock extends Block implements Waterloggable {
   ...
   private static final VoxelShape VIA_EAST_SHAPE_1_8 = Block.createCuboidShape(0.0, 0.0, 0.0, 2.0, 16.0, 16.0);
   private static final VoxelShape VIA_WEST_SHAPE_1_8 = Block.createCuboidShape(14.0, 0.0, 0.0, 16.0, 16.0, 16.0);
   private static final VoxelShape VIA_SOUTH_SHAPE_1_8 = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 16.0, 2.0);
   private static final VoxelShape VIA_NORTH_SHAPE_1_8 = Block.createCuboidShape(0.0, 0.0, 14.0, 16.0, 16.0, 16.0);
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      if (ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_8)) {
         return switch (state.get(FACING)) {
            case NORTH -> VIA_NORTH_SHAPE_1_8;
            case SOUTH -> VIA_SOUTH_SHAPE_1_8;
            case WEST -> VIA_WEST_SHAPE_1_8;
            default -> VIA_EAST_SHAPE_1_8;
         };
      }
