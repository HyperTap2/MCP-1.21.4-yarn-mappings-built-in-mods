...
public class Blocks {
   private static final AbstractBlock.ContextPredicate SHULKER_BOX_SUFFOCATES_PREDICATE = (state, world, pos) -> world.getBlockEntity(pos) instanceof ShulkerBoxBlockEntity shulkerBoxBlockEntity
      ...
      : true;
   private static final AbstractBlock.ContextPredicate PISTON_SUFFOCATES_PREDICATE = (state, world, pos) -> !state.get(PistonBlock.EXTENDED);
   ...
   public static final Block POLISHED_DIORITE = register(
      "polished_diorite",
      AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F)
   );
   ...
   public static final Block GRASS_BLOCK = register(
      "grass_block",
      GrassBlock::new,
      AbstractBlock.Settings.create().mapColor(MapColor.PALE_GREEN).ticksRandomly().strength(0.6F).sounds(BlockSoundGroup.GRASS)
   );
   public static final Block DIRT = register(
      "dirt", AbstractBlock.Settings.create().mapColor(MapColor.DIRT_BROWN).strength(0.5F).sounds(BlockSoundGroup.GRAVEL)
   );
   ...
   public static final Block SPRUCE_LOG = register(
      "spruce_log", PillarBlock::new, createLogSettings(MapColor.SPRUCE_BROWN, MapColor.BROWN, BlockSoundGroup.WOOD)
   );
   ...
   public static final Block ACACIA_LOG = register(
      "acacia_log", PillarBlock::new, createLogSettings(MapColor.ORANGE, MapColor.STONE_GRAY, BlockSoundGroup.WOOD)
   );
   ...
   public static final Block CHERRY_LEAVES = register(
      "cherry_leaves",
      settings -> new ParticleLeavesBlock(10, ParticleTypes.CHERRY_LEAVES, settings),
      AbstractBlock.Settings.create()
         .mapColor(MapColor.PINK)
         .strength(0.2F)
         .ticksRandomly()
   ...
   public static final Block PALE_OAK_LEAVES = register(
      "pale_oak_leaves",
      settings -> new ParticleLeavesBlock(50, ParticleTypes.PALE_OAK_LEAVES, settings),
      AbstractBlock.Settings.create()
   ...
   public static final Block FLOWERING_AZALEA_LEAVES = register(
      "flowering_azalea_leaves", LeavesBlock::new, createLeavesSettings(BlockSoundGroup.AZALEA_LEAVES)
   );
   ...
   public static final Block CHISELED_SANDSTONE = register(
      "chiseled_sandstone",
      AbstractBlock.Settings.create().mapColor(MapColor.PALE_YELLOW).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.8F)
   );
   ...
   public static final Block BIRCH_WALL_HANGING_SIGN = register(
      ...
      copyLootTable(BIRCH_HANGING_SIGN, true)
         .mapColor(MapColor.PALE_YELLOW)
         .solid()
         .instrument(NoteBlockInstrument.BASS)
         .noCollision()
   ...
   public static final Block LEVER = register(
      "lever",
      LeverBlock::new,
      AbstractBlock.Settings.create().noCollision().strength(0.5F).sounds(BlockSoundGroup.STONE).pistonBehavior(PistonBehavior.DESTROY)
   );
   ...
   public static final Block PACKED_MUD = register(
      "packed_mud", AbstractBlock.Settings.copyShallow(DIRT).strength(1.0F, 3.0F).sounds(BlockSoundGroup.PACKED_MUD)
   );
   ...
   public static final Block RESIN_BLOCK = register(
      "resin_block",
      AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(NoteBlockInstrument.BASEDRUM).sounds(BlockSoundGroup.RESIN)
   );
   ...
   public static final Block TRIPWIRE_HOOK = register(
      ...
      AbstractBlock.Settings.create().noCollision().sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY)
   );
   ...
   public static final Block MOSSY_COBBLESTONE_WALL = register(
      "mossy_cobblestone_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(COBBLESTONE).solid()
   );
   ...
   public static final Block POTTED_TORCHFLOWER = register(
      "potted_torchflower", settings -> new FlowerPotBlock(TORCHFLOWER, settings), createFlowerPotSettings()
   );
   public static final Block POTTED_OAK_SAPLING = register(
      "potted_oak_sapling", settings -> new FlowerPotBlock(OAK_SAPLING, settings), createFlowerPotSettings()
   );
   ...
   public static final Block POTTED_BLUE_ORCHID = register(
      "potted_blue_orchid", settings -> new FlowerPotBlock(BLUE_ORCHID, settings), createFlowerPotSettings()
   );
   ...
   public static final Block POTTED_AZURE_BLUET = register(
      "potted_azure_bluet", settings -> new FlowerPotBlock(AZURE_BLUET, settings), createFlowerPotSettings()
   );
   ...
   public static final Block POTTED_WHITE_TULIP = register(
      "potted_white_tulip", settings -> new FlowerPotBlock(WHITE_TULIP, settings), createFlowerPotSettings()
   );
   ...
   public static final Block POTTED_OXEYE_DAISY = register(
      "potted_oxeye_daisy", settings -> new FlowerPotBlock(OXEYE_DAISY, settings), createFlowerPotSettings()
   );
   ...
   public static final Block POTTED_WITHER_ROSE = register(
      "potted_wither_rose", settings -> new FlowerPotBlock(WITHER_ROSE, settings), createFlowerPotSettings()
   );
   ...
   public static final Block SLIME_BLOCK = register(
      "slime_block",
      SlimeBlock::new,
      AbstractBlock.Settings.create().mapColor(MapColor.PALE_GREEN).slipperiness(0.8F).sounds(BlockSoundGroup.SLIME).nonOpaque()
   );
   ...
   public static final Block CHISELED_RED_SANDSTONE = register(
      ...
      AbstractBlock.Settings.create().mapColor(MapColor.ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.8F)
   );
   ...
   public static final Block LIGHT_BLUE_CONCRETE = register(
      "light_blue_concrete",
      AbstractBlock.Settings.create().mapColor(DyeColor.LIGHT_BLUE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.8F)
   );
   ...
   public static final Block LIGHT_GRAY_CONCRETE = register(
      "light_gray_concrete",
      AbstractBlock.Settings.create().mapColor(DyeColor.LIGHT_GRAY).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.8F)
   );
   ...
   public static final Block END_STONE_BRICK_WALL = register(
      "end_stone_brick_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(END_STONE_BRICKS).solid()
   );
   ...
   public static final Block CRIMSON_BUTTON = register(
      "crimson_button", settings -> new ButtonBlock(BlockSetType.CRIMSON, 30, settings), createButtonSettings()
   );
   ...
   public static final Block CANDLE_CAKE = register(
      "candle_cake",
      settings -> new CandleCakeBlock(CANDLE, settings),
   ...
   public static final Block WAXED_WEATHERED_CHISELED_COPPER = register(
      "waxed_weathered_chiseled_copper", AbstractBlock.Settings.copy(WEATHERED_CHISELED_COPPER)
   );
   ...
   public static final Block EXPOSED_CUT_COPPER_SLAB = register(
      ...
      settings -> new OxidizableSlabBlock(Oxidizable.OxidationLevel.EXPOSED, settings),
   ...
   public static final Block POLISHED_DEEPSLATE_SLAB = register(
      "polished_deepslate_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(POLISHED_DEEPSLATE)
   );
   ...
   public static final Block DEEPSLATE_BRICK_WALL = register(
      "deepslate_brick_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(DEEPSLATE_BRICKS).solid()
   );
   ...
   public static final Block RAW_COPPER_BLOCK = register(
      "raw_copper_block",
      AbstractBlock.Settings.create().mapColor(MapColor.ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(5.0F, 6.0F)
   );
   ...
   public static final Block CRAFTER = register(
      "crafter", CrafterBlock::new, AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).strength(1.5F, 3.5F)
   );
