...
public class LilyPadBlock extends PlantBlock {
   ...
   private static final VoxelShape VIA_SHAPE_1_8 = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 0.25, 16.0);
   ...
   protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_8) ? VIA_SHAPE_1_8 : SHAPE;
   }
