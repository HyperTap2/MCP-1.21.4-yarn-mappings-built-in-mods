...
public class SnowBlock extends Block {
   ...
   private static final VoxelShape[] VIA_COLLISION_SHAPES_1_12_2 = new VoxelShape[]{
      Block.createCuboidShape(0.0, -1.0E-5, 0.0, 16.0, 0.0, 16.0),
      Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 2.0, 16.0),
      Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 4.0, 16.0),
      Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 6.0, 16.0),
      Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 8.0, 16.0),
   ...
   protected VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_12_2)
         ? VIA_COLLISION_SHAPES_1_12_2[state.get(LAYERS) - 1]
         : LAYERS_TO_SHAPE[state.get(LAYERS) - 1];
   }
