...
public class SoulSandBlock extends Block {
   ...
   protected VoxelShape getSidesShape(BlockState state, BlockView world, BlockPos pos) {
      return ProtocolTranslator.getTargetVersion().betweenInclusive(ProtocolVersion.v1_13, ProtocolVersion.v1_15_2)
         ? VoxelShapes.empty()
   ...
   public float getVelocityMultiplier() {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_14_4) ? 1.0F : super.getVelocityMultiplier();
   }
