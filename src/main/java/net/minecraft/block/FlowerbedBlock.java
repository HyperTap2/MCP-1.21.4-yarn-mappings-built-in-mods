...
public class FlowerbedBlock extends PlantBlock implements Fertilizable {
   ...
   private static final VoxelShape VIA_SHAPE_1_20 = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 3.0, 16.0);
   ...
   public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      return ProtocolTranslator.getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_20)
         ? VIA_SHAPE_1_20
         : FACING_AND_AMOUNT_TO_SHAPE.apply(state.get(FACING), state.get(FLOWER_AMOUNT));
   }
