...
public class CrafterBlockEntity extends LootableContainerBlockEntity implements RecipeInputInventory, SleepingBlockEntity, SetChangedHandlingBlockEntity {
   ...
   protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
      ...
      if (this.lithium$isSleeping() && this.world != null && !this.world.isClient) this.lithium$wakeUpNow();
   }
