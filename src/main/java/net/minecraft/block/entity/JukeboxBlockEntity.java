...
public class JukeboxBlockEntity extends BlockEntity implements SingleStackInventory.SingleStackBlockEntityInventory {
   ...
   protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
      ...
      if (nbt.contains("ticks_since_song_started", 4)) {
         JukeboxSong.getSongEntryFromStack(registries, this.recordStack)
            .ifPresent(song -> this.manager.setValues((RegistryEntry<JukeboxSong>)song, nbt.getLong("ticks_since_song_started")));
      }
   }
