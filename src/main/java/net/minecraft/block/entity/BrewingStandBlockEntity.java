...
public class BrewingStandBlockEntity extends LockableContainerBlockEntity implements SidedInventory, SleepingBlockEntity, SetChangedHandlingBlockEntity {
   ...
   public static void tick(World world, BlockPos pos, BlockState state, BrewingStandBlockEntity blockEntity) {
      if (blockEntity.brewTime == 0 && state.isOf(Blocks.BREWING_STAND) && blockEntity.world != null) {
