...
public abstract class ScreenHandler implements IScreenHandler {
   ...
   private short viaFabricPlus$actionId;
   ...
   public static int calculateComparatorOutput(@Nullable Inventory inventory) {
      ...
      if (inventory instanceof LithiumInventory lithiumInventory) {
         return InventoryHelper.getLithiumStackList(lithiumInventory).getSignalStrength(inventory);
      }
