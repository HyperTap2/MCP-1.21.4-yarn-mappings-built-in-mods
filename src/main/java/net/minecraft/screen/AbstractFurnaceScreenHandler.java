   ...
   public ItemStack quickMove(PlayerEntity player, int slot) {
      ...
      if (slot2 != null && slot2.hasStack()) {
         ...
         if (slot == 2) {
            ...
            if (ProtocolTranslator.getTargetVersion().newerThan(LegacyProtocolVersion.r1_2_1tor1_2_3) && this.isSmeltable(itemStack2)) {
               if (!this.insertItem(itemStack2, 0, 1, false)) {
                  return ItemStack.EMPTY;
               }
            } else if (ProtocolTranslator.getTargetVersion().newerThan(LegacyProtocolVersion.r1_2_1tor1_2_3) && this.isFuel(itemStack2)) {
