...
public class JfrProfiler implements FlightProfiler {
   ...
   public boolean start(InstanceType instanceType) {
      ...
      try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(uRL.openStream()))) {
         return this.start(bufferedReader, instanceType);
   ...
   private boolean start(Reader reader, InstanceType instanceType) {
      ...
      LOGGER.info(
         ...
         new Object[]{this.currentRecording.getId(), this.currentRecording.getName(), this.currentRecording.getDestination()}
      );
      return true;
   }
