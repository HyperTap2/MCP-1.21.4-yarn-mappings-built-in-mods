...
public class DataPool<E> extends Pool<Weighted.Present<E>> {
   ...
   public static <E> Codec<DataPool<E>> createCodecDataPool(Codec<E> dataCodec) {
   ...
   public static <E> DataPool<E> emptyDataPool() {
   ...
   public static class Builder<E> {
      private final com.google.common.collect.ImmutableList.Builder<Weighted.Present<E>> entries = ImmutableList.builder();
