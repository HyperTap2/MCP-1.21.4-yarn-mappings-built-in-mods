...
public class BlockPos extends Vec3i {
   ...
   public Vec3d clampToWithin(Vec3d pos) {
      return new Vec3d(
         MathHelper.clamp(pos.x, this.getX() + 1.0E-5F, this.getX() + 1.0 - 1.0E-5F),
         MathHelper.clamp(pos.y, this.getY() + 1.0E-5F, this.getY() + 1.0 - 1.0E-5F),
         MathHelper.clamp(pos.z, this.getZ() + 1.0E-5F, this.getZ() + 1.0 - 1.0E-5F)
      );
   }
