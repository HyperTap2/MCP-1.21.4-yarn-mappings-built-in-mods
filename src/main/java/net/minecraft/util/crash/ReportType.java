...
public record ReportType(String header, List<String> nuggets) {
   public static final ReportType MINECRAFT_CRASH_REPORT = new ReportType(
   ...
   public static final ReportType MINECRAFT_PROFILER_RESULTS = new ReportType(
   ...
   public static final ReportType MINECRAFT_TEST_REPORT = new ReportType(
   ...
   public void addHeaderAndNugget(StringBuilder reportBuilder, List<String> extraInfo) {
      ...
      reportBuilder.append(" ----\n");
      reportBuilder.append("// ");
      reportBuilder.append(this.chooseNugget());
      reportBuilder.append('\n');
