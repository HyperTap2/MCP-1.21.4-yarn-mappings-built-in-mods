...
public enum Rarity implements StringIdentifiable {
   ...
   public static final IntFunction<Rarity> ID_TO_VALUE = ValueLists.<Rarity>createIdToValueFunction(value -> value.index, values(), ValueLists.OutOfBoundsHandling.ZERO);
   ...
   Rarity(final int index, final String name, final Formatting formatting) {
      this.index = index;
      this.name = name;
