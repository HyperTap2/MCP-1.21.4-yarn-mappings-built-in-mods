...
public record ModStatus(ModStatus.Confidence confidence, String description) {
   ...
   public ModStatus combine(ModStatus brand) {
      return new ModStatus(
         (ModStatus.Confidence)ObjectUtils.max(new ModStatus.Confidence[]{this.confidence, brand.confidence}), this.description + "; " + brand.description
      );
   }
   ...
   public enum Confidence {
      ...
      Confidence(final String description, final boolean modded) {
