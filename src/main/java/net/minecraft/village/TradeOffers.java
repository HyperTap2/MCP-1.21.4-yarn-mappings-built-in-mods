...
public class TradeOffers {
         ...
         map.put(
            ...
            copyToFastUtilMap(
               ImmutableMap.of(
                  ...
                  3,
                  new TradeOffers.Factory[]{
                     new TradeOffers.BuyItemFactory(Items.STRING, 14, 16, 20), new TradeOffers.SellItemFactory(Items.CROSSBOW, 3, 1, 10)
                  },
                  4,
                  new TradeOffers.Factory[]{
                     new TradeOffers.BuyItemFactory(Items.FEATHER, 24, 16, 30), new TradeOffers.SellEnchantedToolFactory(Items.BOW, 2, 3, 15)
                  },
                  5,
                  new TradeOffers.Factory[]{
         ...
         map.put(
            ...
            copyToFastUtilMap(
               ImmutableMap.of(
                  1,
                  new TradeOffers.Factory[]{
                     new TradeOffers.BuyItemFactory(Items.ROTTEN_FLESH, 32, 16, 2), new TradeOffers.SellItemFactory(Items.REDSTONE, 1, 2, 1)
                  },
                  2,
                  new TradeOffers.Factory[]{
                     new TradeOffers.BuyItemFactory(Items.GOLD_INGOT, 3, 12, 10), new TradeOffers.SellItemFactory(Items.LAPIS_LAZULI, 1, 1, 5)
                  },
                  3,
                  new TradeOffers.Factory[]{
                     new TradeOffers.BuyItemFactory(Items.RABBIT_FOOT, 2, 12, 20), new TradeOffers.SellItemFactory(Blocks.GLOWSTONE, 4, 1, 12, 10)
                  },
                  4,
                  new TradeOffers.Factory[]{
         ...
         map.put(
            ...
            copyToFastUtilMap(
               ImmutableMap.of(
                  1,
                  new TradeOffers.Factory[]{
                     new TradeOffers.BuyItemFactory(Items.CLAY_BALL, 10, 16, 2), new TradeOffers.SellItemFactory(Items.BRICK, 1, 10, 16, 1)
                  },
                  2,
                  new TradeOffers.Factory[]{
   ...
   public static final Int2ObjectMap<TradeOffers.Factory[]> WANDERING_TRADER_TRADES = copyToFastUtilMap(
      ImmutableMap.of(
         ...
         new TradeOffers.Factory[]{
            ...
            new TradeOffers.SellItemFactory(Items.PALE_HANGING_MOSS, 1, 1, 12, 1),
   ...
   public static final Map<VillagerProfession, Int2ObjectMap<TradeOffers.Factory[]>> REBALANCED_PROFESSION_TO_LEVELED_TRADE = Map.of(
      ...
      copyToFastUtilMap(
         ImmutableMap.<Integer, Factory[]>builder()
            ...
            .put(
               ...
               new TradeOffers.Factory[]{
                  new TradeOffers.BuyItemFactory(Items.INK_SAC, 5, 12, 20),
                  createLibrarianTradeFactory(10),
                  new TradeOffers.SellItemFactory(Items.GLASS, 1, 4, 10)
               }
            )
            .put(
      ...
      copyToFastUtilMap(
         ImmutableMap.<Integer, Factory[]>builder()
            .put(
               1, new TradeOffers.Factory[]{new TradeOffers.BuyItemFactory(Items.COAL, 15, 12, 2), new TradeOffers.BuyItemFactory(Items.IRON_INGOT, 5, 12, 2)}
            )
            .put(
               2,
               new TradeOffers.Factory[]{
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.CHAINMAIL_BOOTS, 4, 1, 12, 5, 0.05F), VillagerType.JUNGLE, VillagerType.SWAMP
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.CHAINMAIL_HELMET, 5, 1, 12, 5, 0.05F), VillagerType.JUNGLE, VillagerType.SWAMP
                  ),
                  TradeOffers.TypedWrapperFactory.of(
            ...
            .put(
               ...
               new TradeOffers.Factory[]{
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.IRON_BOOTS, 8, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.DESERT_ARMORER_BOOTS_4),
                     VillagerType.DESERT
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.IRON_HELMET, 9, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.DESERT_ARMORER_HELMET_4),
                     VillagerType.DESERT
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.IRON_BOOTS, 8, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_BOOTS_4),
                     VillagerType.PLAINS
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.IRON_HELMET, 9, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_HELMET_4),
                     VillagerType.PLAINS
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.IRON_BOOTS, 2, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_BOOTS_4),
                     VillagerType.SAVANNA
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.IRON_BOOTS, 8, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SNOW_ARMORER_BOOTS_4),
                     VillagerType.SNOW
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.IRON_HELMET, 9, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SNOW_ARMORER_HELMET_4),
                     VillagerType.SNOW
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(
                        Items.CHAINMAIL_LEGGINGS, 11, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_LEGGINGS_4
                     ),
                     VillagerType.JUNGLE
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(
                        Items.CHAINMAIL_CHESTPLATE, 13, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_CHESTPLATE_4
                     ),
                     VillagerType.JUNGLE
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.CHAINMAIL_BOOTS, 8, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_BOOTS_4),
                     VillagerType.SWAMP
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(
                        Items.CHAINMAIL_CHESTPLATE, 13, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_CHESTPLATE_4
                     ),
                     VillagerType.SWAMP
                  ),
                  TradeOffers.TypedWrapperFactory.of(
            ...
            .put(
               ...
               new TradeOffers.Factory[]{
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.ProcessItemFactory(
                        Items.DIAMOND, 2, 12, Items.DIAMOND_BOOTS, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_BOOTS_5
                     ),
                     VillagerType.PLAINS
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.ProcessItemFactory(
                        Items.DIAMOND, 2, 12, Items.DIAMOND_BOOTS, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.SNOW_ARMORER_BOOTS_5
                     ),
                     VillagerType.SNOW
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.ProcessItemFactory(
                        Items.DIAMOND, 3, 12, Items.DIAMOND_HELMET, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.SNOW_ARMORER_HELMET_5
                     ),
                     VillagerType.SNOW
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                  ...
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.SellItemFactory(Items.CHAINMAIL_BOOTS, 8, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_BOOTS_5),
                     VillagerType.SWAMP
                  ),
                  TradeOffers.TypedWrapperFactory.of(
                     new TradeOffers.ProcessItemFactory(
         ...
         ImmutableMap.of(
            ...
            new TradeOffers.Factory[]{
               ...
               new TradeOffers.TypedWrapperFactory(
                  ImmutableMap.<VillagerType, Factory>builder()
   ...
   public static class ProcessItemFactory implements TradeOffers.Factory {
      ...
      ProcessItemFactory(
         ...
         this(
            new TradedItem(item, count), price, new ItemStack(processed, processedCount), maxUses, experience, multiplier, Optional.of(enchantmentProviderKey)
         );
      }
         ...
         this.enchantmentProviderKey
            .ifPresent(
               key -> EnchantmentHelper.applyEnchantmentProvider(
                  itemStack, world.getRegistryManager(), (RegistryKey<EnchantmentProvider>)key, world.getLocalDifficulty(entity.getBlockPos()), random
               )
            );
   ...
   public static class TypeAwareBuyForOneEmeraldFactory implements TradeOffers.Factory {
      ...
      public TradeOffer create(Entity entity, Random random) {
         if (entity instanceof VillagerDataContainer villagerDataContainer) {
            TradedItem tradedItem = new TradedItem(this.map.get(villagerDataContainer.getVillagerData().getType()), this.count);
   ...
   public record TypedWrapperFactory(Map<VillagerType, TradeOffers.Factory> typeToFactory) implements TradeOffers.Factory {
      public static TradeOffers.TypedWrapperFactory of(TradeOffers.Factory factory, VillagerType... types) {
         return new TradeOffers.TypedWrapperFactory(Arrays.stream(types).collect(Collectors.toMap(type -> (VillagerType)type, type -> factory)));
      }
      ...
      public TradeOffer create(Entity entity, Random random) {
         if (entity instanceof VillagerDataContainer villagerDataContainer) {
            ...
            TradeOffers.Factory factory = this.typeToFactory.get(villagerType);
