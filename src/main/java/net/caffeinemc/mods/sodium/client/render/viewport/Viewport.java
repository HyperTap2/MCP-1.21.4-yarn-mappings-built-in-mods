...
public final class Viewport {
   ...
   public Viewport(Frustum frustum, Vector3d position) {
      ...
      this.sectionCoords = ChunkSectionPos.from(
         ChunkSectionPos.getSectionCoord(position.x), ChunkSectionPos.getSectionCoord(position.y), ChunkSectionPos.getSectionCoord(position.z)
      );
